		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getWallRuleAccess().getGroup_2(), "rule__WallRule__Group_2__0");
					put(grammarAccess.getWallRuleAccess().getGroup_3(), "rule__WallRule__Group_3__0");
					...
					put(grammarAccess.getOpeningAccess().getGroup_6(), "rule__Opening__Group_6__0");
					put(grammarAccess.getOpeningAccess().getGroup_6_2(), "rule__Opening__Group_6_2__0");
					...
					put(grammarAccess.getWallRuleAccess().getElementNameAssignment_2_1(), "rule__WallRule__ElementNameAssignment_2_1");
					put(grammarAccess.getWallRuleAccess().getDescriptionAssignment_3_1(), "rule__WallRule__DescriptionAssignment_3_1");
					put(grammarAccess.getWallRuleAccess().getPlacementAssignment_5(), "rule__WallRule__PlacementAssignment_5");
					...
					put(grammarAccess.getOpeningAccess().getWallsAssignment_6_1(), "rule__Opening__WallsAssignment_6_1");
					put(grammarAccess.getOpeningAccess().getWallsAssignment_6_2_1(), "rule__Opening__WallsAssignment_6_2_1");
					...
					put(grammarAccess.getLocalPlacementAccess().getAxis2placement3dAssignment_4(), "rule__LocalPlacement__Axis2placement3dAssignment_4");
