...
\author{Nicolai Dahl Blicher-Petersen\inst{1} \and Christian Harrington\inst{1} \and
Thomas Hallier Didriksen\inst{1} \and Sune Alkærsig\inst{1} \and Anders Høst Kjærgaard\inst{1}\\\email{\{ndbl, cnha, thdi, sual, ahkj\}@itu.dk}}
