...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Related Priorities Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedPrioritiesTypeImpl#getLongWrapper <em>Long Wrapper</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedPrioritiesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedPrioritiesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedPrioritiesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RelatedPrioritiesTypeImpl extends EObjectImpl implements RelatedPrioritiesType {
	/**
	 ...
	 * @generated
	 */
	protected RelatedPrioritiesTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRelatedPrioritiesType();
	}
	...
	public EList<LongWrapperType> getLongWrapper() {
		if (longWrapper == null) {
			longWrapper = new EObjectContainmentEList<LongWrapperType>(LongWrapperType.class, this, FinalPackage.RELATED_PRIORITIES_TYPE__LONG_WRAPPER);
		}
		return longWrapper;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_PRIORITIES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_PRIORITIES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_PRIORITIES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.RELATED_PRIORITIES_TYPE__LONG_WRAPPER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.RELATED_PRIORITIES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.RELATED_PRIORITIES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.RELATED_PRIORITIES_TYPE__ITEM_TYPE:
				return getItemType();
		}
