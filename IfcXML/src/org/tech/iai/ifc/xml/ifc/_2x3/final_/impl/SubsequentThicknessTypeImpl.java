...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Subsequent Thickness Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentThicknessTypeImpl#getIfcPositiveLengthMeasure <em>Ifc Positive Length Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentThicknessTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentThicknessTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentThicknessTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubsequentThicknessTypeImpl extends EObjectImpl implements SubsequentThicknessType {
	/**
	 * The cached value of the '{@link #getIfcPositiveLengthMeasure() <em>Ifc Positive Length Measure</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcPositiveLengthMeasureType> ifcPositiveLengthMeasure;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcPositiveLengthMeasure");
	 ...
	 * @generated
	 */
	protected SubsequentThicknessTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getSubsequentThicknessType();
	}
	...
	public EList<IfcPositiveLengthMeasureType> getIfcPositiveLengthMeasure() {
		if (ifcPositiveLengthMeasure == null) {
			ifcPositiveLengthMeasure = new EObjectContainmentEList<IfcPositiveLengthMeasureType>(IfcPositiveLengthMeasureType.class, this, FinalPackage.SUBSEQUENT_THICKNESS_TYPE__IFC_POSITIVE_LENGTH_MEASURE);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_THICKNESS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_THICKNESS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_THICKNESS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.SUBSEQUENT_THICKNESS_TYPE__IFC_POSITIVE_LENGTH_MEASURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.SUBSEQUENT_THICKNESS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.SUBSEQUENT_THICKNESS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.SUBSEQUENT_THICKNESS_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.SUBSEQUENT_THICKNESS_TYPE__IFC_POSITIVE_LENGTH_MEASURE:
				return ifcPositiveLengthMeasure != null && !ifcPositiveLengthMeasure.isEmpty();
			case FinalPackage.SUBSEQUENT_THICKNESS_TYPE__ARRAY_SIZE:
