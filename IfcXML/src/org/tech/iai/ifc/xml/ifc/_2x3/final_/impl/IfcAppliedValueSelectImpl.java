...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcAppliedValueSelect;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcAppliedValueSelectImpl#getIfcRatioMeasure <em>Ifc Ratio Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcAppliedValueSelectImpl#getIfcMeasureWithUnit <em>Ifc Measure With Unit</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcAppliedValueSelectImpl#getIfcMonetaryMeasure <em>Ifc Monetary Measure</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcAppliedValueSelectImpl extends EObjectImpl implements IfcAppliedValueSelect {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcAppliedValueSelect();
	}
	...
	public NotificationChain basicSetIfcRatioMeasure(IfcRatioMeasureType newIfcRatioMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_RATIO_MEASURE, oldIfcRatioMeasure, newIfcRatioMeasure);
	...
	public void setIfcRatioMeasure(IfcRatioMeasureType newIfcRatioMeasure) {
		if (newIfcRatioMeasure != ifcRatioMeasure) {
			...
			if (ifcRatioMeasure != null)
				msgs = ((InternalEObject)ifcRatioMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_RATIO_MEASURE, null, msgs);
			if (newIfcRatioMeasure != null)
				msgs = ((InternalEObject)newIfcRatioMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_RATIO_MEASURE, null, msgs);
			msgs = basicSetIfcRatioMeasure(newIfcRatioMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_RATIO_MEASURE, newIfcRatioMeasure, newIfcRatioMeasure));
	}
	...
	public NotificationChain basicSetIfcMeasureWithUnit(IfcMeasureWithUnit newIfcMeasureWithUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MEASURE_WITH_UNIT, oldIfcMeasureWithUnit, newIfcMeasureWithUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMeasureWithUnit(IfcMeasureWithUnit newIfcMeasureWithUnit) {
		if (newIfcMeasureWithUnit != ifcMeasureWithUnit) {
			...
			if (ifcMeasureWithUnit != null)
				msgs = ((InternalEObject)ifcMeasureWithUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MEASURE_WITH_UNIT, null, msgs);
			if (newIfcMeasureWithUnit != null)
				msgs = ((InternalEObject)newIfcMeasureWithUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MEASURE_WITH_UNIT, null, msgs);
			msgs = basicSetIfcMeasureWithUnit(newIfcMeasureWithUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MEASURE_WITH_UNIT, newIfcMeasureWithUnit, newIfcMeasureWithUnit));
	}
	...
	public NotificationChain basicSetIfcMonetaryMeasure(IfcMonetaryMeasureType newIfcMonetaryMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MONETARY_MEASURE, oldIfcMonetaryMeasure, newIfcMonetaryMeasure);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMonetaryMeasure(IfcMonetaryMeasureType newIfcMonetaryMeasure) {
		if (newIfcMonetaryMeasure != ifcMonetaryMeasure) {
			...
			if (ifcMonetaryMeasure != null)
				msgs = ((InternalEObject)ifcMonetaryMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MONETARY_MEASURE, null, msgs);
			if (newIfcMonetaryMeasure != null)
				msgs = ((InternalEObject)newIfcMonetaryMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MONETARY_MEASURE, null, msgs);
			msgs = basicSetIfcMonetaryMeasure(newIfcMonetaryMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MONETARY_MEASURE, newIfcMonetaryMeasure, newIfcMonetaryMeasure));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_RATIO_MEASURE:
				return basicSetIfcRatioMeasure(null, msgs);
			case FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MEASURE_WITH_UNIT:
				return basicSetIfcMeasureWithUnit(null, msgs);
			case FinalPackage.IFC_APPLIED_VALUE_SELECT__IFC_MONETARY_MEASURE:
