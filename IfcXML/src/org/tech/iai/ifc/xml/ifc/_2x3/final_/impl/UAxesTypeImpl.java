...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>UAxes Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UAxesTypeImpl#getIfcGridAxis <em>Ifc Grid Axis</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UAxesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UAxesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UAxesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UAxesTypeImpl extends EObjectImpl implements UAxesType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getUAxesType();
	}
	...
	public EList<IfcGridAxis> getIfcGridAxis() {
		if (ifcGridAxis == null) {
			ifcGridAxis = new EObjectContainmentEList<IfcGridAxis>(IfcGridAxis.class, this, FinalPackage.UAXES_TYPE__IFC_GRID_AXIS);
		}
		return ifcGridAxis;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.UAXES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.UAXES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.UAXES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.UAXES_TYPE__IFC_GRID_AXIS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.UAXES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.UAXES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.UAXES_TYPE__ITEM_TYPE:
				return getItemType();
		}
