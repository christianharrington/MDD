...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Second Operand Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SecondOperandTypeImpl#getIfcSolidModelGroup <em>Ifc Solid Model Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SecondOperandTypeImpl#getIfcSolidModel <em>Ifc Solid Model</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SecondOperandTypeImpl#getIfcHalfSpaceSolidGroup <em>Ifc Half Space Solid Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SecondOperandTypeImpl#getIfcHalfSpaceSolid <em>Ifc Half Space Solid</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SecondOperandTypeImpl#getIfcBooleanResultGroup <em>Ifc Boolean Result Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SecondOperandTypeImpl#getIfcBooleanResult <em>Ifc Boolean Result</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SecondOperandTypeImpl#getIfcCsgPrimitive3DGroup <em>Ifc Csg Primitive3 DGroup</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SecondOperandTypeImpl#getIfcCsgPrimitive3D <em>Ifc Csg Primitive3 D</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SecondOperandTypeImpl extends EObjectImpl implements SecondOperandType {
	/**
	 ...
	 * @generated
	 */
	protected SecondOperandTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getSecondOperandType();
	}
	...
	public FeatureMap getIfcSolidModelGroup() {
		if (ifcSolidModelGroup == null) {
			ifcSolidModelGroup = new BasicFeatureMap(this, FinalPackage.SECOND_OPERAND_TYPE__IFC_SOLID_MODEL_GROUP);
		}
	...
	public IfcSolidModel getIfcSolidModel() {
		return (IfcSolidModel)getIfcSolidModelGroup().get(FinalPackage.eINSTANCE.getSecondOperandType_IfcSolidModel(), true);
	}
	...
	public NotificationChain basicSetIfcSolidModel(IfcSolidModel newIfcSolidModel, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcSolidModelGroup()).basicAdd(FinalPackage.eINSTANCE.getSecondOperandType_IfcSolidModel(), newIfcSolidModel, msgs);
	}
	...
	public FeatureMap getIfcHalfSpaceSolidGroup() {
		if (ifcHalfSpaceSolidGroup == null) {
			ifcHalfSpaceSolidGroup = new BasicFeatureMap(this, FinalPackage.SECOND_OPERAND_TYPE__IFC_HALF_SPACE_SOLID_GROUP);
		}
	...
	public IfcHalfSpaceSolid getIfcHalfSpaceSolid() {
		return (IfcHalfSpaceSolid)getIfcHalfSpaceSolidGroup().get(FinalPackage.eINSTANCE.getSecondOperandType_IfcHalfSpaceSolid(), true);
	}
	...
	public NotificationChain basicSetIfcHalfSpaceSolid(IfcHalfSpaceSolid newIfcHalfSpaceSolid, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcHalfSpaceSolidGroup()).basicAdd(FinalPackage.eINSTANCE.getSecondOperandType_IfcHalfSpaceSolid(), newIfcHalfSpaceSolid, msgs);
	}
	...
	public void setIfcHalfSpaceSolid(IfcHalfSpaceSolid newIfcHalfSpaceSolid) {
		((FeatureMap.Internal)getIfcHalfSpaceSolidGroup()).set(FinalPackage.eINSTANCE.getSecondOperandType_IfcHalfSpaceSolid(), newIfcHalfSpaceSolid);
	}
	...
	public FeatureMap getIfcBooleanResultGroup() {
		if (ifcBooleanResultGroup == null) {
			ifcBooleanResultGroup = new BasicFeatureMap(this, FinalPackage.SECOND_OPERAND_TYPE__IFC_BOOLEAN_RESULT_GROUP);
		}
	...
	public IfcBooleanResult getIfcBooleanResult() {
		return (IfcBooleanResult)getIfcBooleanResultGroup().get(FinalPackage.eINSTANCE.getSecondOperandType_IfcBooleanResult(), true);
	}
	...
	public NotificationChain basicSetIfcBooleanResult(IfcBooleanResult newIfcBooleanResult, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcBooleanResultGroup()).basicAdd(FinalPackage.eINSTANCE.getSecondOperandType_IfcBooleanResult(), newIfcBooleanResult, msgs);
	}
	...
	public void setIfcBooleanResult(IfcBooleanResult newIfcBooleanResult) {
		((FeatureMap.Internal)getIfcBooleanResultGroup()).set(FinalPackage.eINSTANCE.getSecondOperandType_IfcBooleanResult(), newIfcBooleanResult);
	}
	...
	public FeatureMap getIfcCsgPrimitive3DGroup() {
		if (ifcCsgPrimitive3DGroup == null) {
			ifcCsgPrimitive3DGroup = new BasicFeatureMap(this, FinalPackage.SECOND_OPERAND_TYPE__IFC_CSG_PRIMITIVE3_DGROUP);
		}
	...
	public IfcCsgPrimitive3D getIfcCsgPrimitive3D() {
		return (IfcCsgPrimitive3D)getIfcCsgPrimitive3DGroup().get(FinalPackage.eINSTANCE.getSecondOperandType_IfcCsgPrimitive3D(), true);
	}
	...
	public NotificationChain basicSetIfcCsgPrimitive3D(IfcCsgPrimitive3D newIfcCsgPrimitive3D, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcCsgPrimitive3DGroup()).basicAdd(FinalPackage.eINSTANCE.getSecondOperandType_IfcCsgPrimitive3D(), newIfcCsgPrimitive3D, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.SECOND_OPERAND_TYPE__IFC_SOLID_MODEL_GROUP:
				return ((InternalEList<?>)getIfcSolidModelGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.SECOND_OPERAND_TYPE__IFC_SOLID_MODEL:
				return basicSetIfcSolidModel(null, msgs);
			case FinalPackage.SECOND_OPERAND_TYPE__IFC_HALF_SPACE_SOLID_GROUP:
				return ((InternalEList<?>)getIfcHalfSpaceSolidGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.SECOND_OPERAND_TYPE__IFC_HALF_SPACE_SOLID:
				return basicSetIfcHalfSpaceSolid(null, msgs);
			case FinalPackage.SECOND_OPERAND_TYPE__IFC_BOOLEAN_RESULT_GROUP:
				return ((InternalEList<?>)getIfcBooleanResultGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.SECOND_OPERAND_TYPE__IFC_BOOLEAN_RESULT:
				return basicSetIfcBooleanResult(null, msgs);
			case FinalPackage.SECOND_OPERAND_TYPE__IFC_CSG_PRIMITIVE3_DGROUP:
				return ((InternalEList<?>)getIfcCsgPrimitive3DGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.SECOND_OPERAND_TYPE__IFC_CSG_PRIMITIVE3_D:
