 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetTypeImpl#getIfcCartesianTransformationOperator2DGroup <em>Ifc Cartesian Transformation Operator2 DGroup</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetTypeImpl#getIfcCartesianTransformationOperator2D <em>Ifc Cartesian Transformation Operator2 D</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TargetTypeImpl extends EObjectImpl implements TargetType {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getTargetType();
	}
	...
	public FeatureMap getIfcCartesianTransformationOperator2DGroup() {
		if (ifcCartesianTransformationOperator2DGroup == null) {
			ifcCartesianTransformationOperator2DGroup = new BasicFeatureMap(this, FinalPackage.TARGET_TYPE__IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DGROUP);
		}
	...
	public IfcCartesianTransformationOperator2D getIfcCartesianTransformationOperator2D() {
		return (IfcCartesianTransformationOperator2D)getIfcCartesianTransformationOperator2DGroup().get(FinalPackage.eINSTANCE.getTargetType_IfcCartesianTransformationOperator2D(), true);
	}
	...
	public NotificationChain basicSetIfcCartesianTransformationOperator2D(IfcCartesianTransformationOperator2D newIfcCartesianTransformationOperator2D, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcCartesianTransformationOperator2DGroup()).basicAdd(FinalPackage.eINSTANCE.getTargetType_IfcCartesianTransformationOperator2D(), newIfcCartesianTransformationOperator2D, msgs);
	}
	...
	public void setIfcCartesianTransformationOperator2D(IfcCartesianTransformationOperator2D newIfcCartesianTransformationOperator2D) {
		((FeatureMap.Internal)getIfcCartesianTransformationOperator2DGroup()).set(FinalPackage.eINSTANCE.getTargetType_IfcCartesianTransformationOperator2D(), newIfcCartesianTransformationOperator2D);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.TARGET_TYPE__IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DGROUP:
				return ((InternalEList<?>)getIfcCartesianTransformationOperator2DGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.TARGET_TYPE__IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_D:
