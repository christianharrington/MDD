...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Subsequent Applied Loads Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsTypeImpl#getIfcStructuralLoadGroup <em>Ifc Structural Load Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsTypeImpl#getIfcStructuralLoad <em>Ifc Structural Load</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubsequentAppliedLoadsTypeImpl extends EObjectImpl implements SubsequentAppliedLoadsType {
	/**
	 ...
	 * @generated
	 */
	protected SubsequentAppliedLoadsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getSubsequentAppliedLoadsType();
	}
	...
	public FeatureMap getIfcStructuralLoadGroup() {
		if (ifcStructuralLoadGroup == null) {
			ifcStructuralLoadGroup = new BasicFeatureMap(this, FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__IFC_STRUCTURAL_LOAD_GROUP);
		}
	...
	public EList<IfcStructuralLoad> getIfcStructuralLoad() {
		return getIfcStructuralLoadGroup().list(FinalPackage.eINSTANCE.getSubsequentAppliedLoadsType_IfcStructuralLoad());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__IFC_STRUCTURAL_LOAD_GROUP:
				return ((InternalEList<?>)getIfcStructuralLoadGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__IFC_STRUCTURAL_LOAD:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE__ITEM_TYPE:
				return getItemType();
		}
...
} //SubsequentAppliedLoadsTypeImpl
