 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialsTypeImpl#getIfcMaterial <em>Ifc Material</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MaterialsTypeImpl extends EObjectImpl implements MaterialsType {
	/**
	 * The cached value of the '{@link #getIfcMaterial() <em>Ifc Material</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIfcMaterial()
	 * @generated
	 * @ordered
	 */
	protected EList<IfcMaterial> ifcMaterial;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcMaterial");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getMaterialsType();
	}
	 ...
	 * @generated
	 */
	public EList<IfcMaterial> getIfcMaterial() {
		if (ifcMaterial == null) {
			ifcMaterial = new EObjectContainmentEList<IfcMaterial>(IfcMaterial.class, this, FinalPackage.MATERIALS_TYPE__IFC_MATERIAL);
		}
		return ifcMaterial;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MATERIALS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MATERIALS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MATERIALS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.MATERIALS_TYPE__IFC_MATERIAL:
				return ((InternalEList<?>)getIfcMaterial()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.MATERIALS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.MATERIALS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.MATERIALS_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FinalPackage.MATERIALS_TYPE__IFC_MATERIAL:
				getIfcMaterial().clear();
				getIfcMaterial().addAll((Collection<? extends IfcMaterial>)newValue);
				return;
			case FinalPackage.MATERIALS_TYPE__ARRAY_SIZE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.MATERIALS_TYPE__IFC_MATERIAL:
				return ifcMaterial != null && !ifcMaterial.isEmpty();
			case FinalPackage.MATERIALS_TYPE__ARRAY_SIZE:
