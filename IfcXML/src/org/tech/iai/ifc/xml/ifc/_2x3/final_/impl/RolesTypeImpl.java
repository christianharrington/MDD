 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RolesTypeImpl#getIfcActorRole <em>Ifc Actor Role</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RolesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RolesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RolesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RolesTypeImpl extends EObjectImpl implements RolesType {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRolesType();
	}
	...
	public EList<IfcActorRole> getIfcActorRole() {
		if (ifcActorRole == null) {
			ifcActorRole = new EObjectContainmentEList<IfcActorRole>(IfcActorRole.class, this, FinalPackage.ROLES_TYPE__IFC_ACTOR_ROLE);
		}
		return ifcActorRole;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROLES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROLES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROLES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.ROLES_TYPE__IFC_ACTOR_ROLE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.ROLES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.ROLES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.ROLES_TYPE__ITEM_TYPE:
				return getItemType();
		}
