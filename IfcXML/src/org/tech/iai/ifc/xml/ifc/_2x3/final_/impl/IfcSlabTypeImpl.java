...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcSlabType;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcSlabTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSlabTypeImpl extends IfcBuildingElementTypeImpl implements IfcSlabType {
	 ...
	 * @ordered
	 */
	protected static final IfcSlabTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcSlabTypeEnum.FLOOR;
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcSlabType();
	}
	...
	public void setPredefinedType(IfcSlabTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SLAB_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_SLAB_TYPE__PREDEFINED_TYPE:
