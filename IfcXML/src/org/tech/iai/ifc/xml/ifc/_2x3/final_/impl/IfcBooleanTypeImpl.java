...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ifc Boolean Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class IfcBooleanTypeImpl extends EObjectImpl implements IfcBooleanType {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcBooleanType();
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_BOOLEAN_TYPE__ID, oldId, id));
	}
	...
	public void setPath(List<String> newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_BOOLEAN_TYPE__PATH, oldPath, path));
	}
	...
	public void setPos(List<BigInteger> newPos) {
		...
		pos = newPos;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_BOOLEAN_TYPE__POS, oldPos, pos));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.IFC_BOOLEAN_TYPE__PATH:
				return getPath();
			case FinalPackage.IFC_BOOLEAN_TYPE__POS:
				return getPos();
		}
