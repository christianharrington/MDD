...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Related Objects Type3</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedObjectsType3Impl#getIfcObjectDefinitionGroup <em>Ifc Object Definition Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedObjectsType3Impl#getIfcObjectDefinition <em>Ifc Object Definition</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedObjectsType3Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedObjectsType3Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedObjectsType3Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RelatedObjectsType3Impl extends EObjectImpl implements RelatedObjectsType3 {
	/**
	 ...
	 * @generated
	 */
	protected RelatedObjectsType3Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRelatedObjectsType3();
	}
	...
	public FeatureMap getIfcObjectDefinitionGroup() {
		if (ifcObjectDefinitionGroup == null) {
			ifcObjectDefinitionGroup = new BasicFeatureMap(this, FinalPackage.RELATED_OBJECTS_TYPE3__IFC_OBJECT_DEFINITION_GROUP);
		}
	...
	public EList<IfcObjectDefinition> getIfcObjectDefinition() {
		return getIfcObjectDefinitionGroup().list(FinalPackage.eINSTANCE.getRelatedObjectsType3_IfcObjectDefinition());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_OBJECTS_TYPE3__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_OBJECTS_TYPE3__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_OBJECTS_TYPE3__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.RELATED_OBJECTS_TYPE3__IFC_OBJECT_DEFINITION_GROUP:
				return ((InternalEList<?>)getIfcObjectDefinitionGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.RELATED_OBJECTS_TYPE3__IFC_OBJECT_DEFINITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.RELATED_OBJECTS_TYPE3__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.RELATED_OBJECTS_TYPE3__CTYPE:
				return getCType();
			case FinalPackage.RELATED_OBJECTS_TYPE3__ITEM_TYPE:
				return getItemType();
		}
