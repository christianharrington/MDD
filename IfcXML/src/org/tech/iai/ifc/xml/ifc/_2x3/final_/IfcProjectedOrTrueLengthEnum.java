 ...
 * <!-- end-user-doc -->
 * @see org.tech.iai.ifc.xml.ifc._2x3.final_.FinalPackage#getIfcProjectedOrTrueLengthEnum()
 * @model extendedMetaData="name='IfcProjectedOrTrueLengthEnum'"
 * @generated
 */
public enum IfcProjectedOrTrueLengthEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	PROJECTED_LENGTH(0, "projectedLength", "projected_length"),
	 ...
	 * @ordered
	 */
	TRUE_LENGTH(1, "trueLength", "true_length");
	 ...
	 * @model name="projectedLength" literal="projected_length"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #TRUE_LENGTH
	 * @model name="trueLength" literal="true_length"
	 * @generated
	 * @ordered
	 */
