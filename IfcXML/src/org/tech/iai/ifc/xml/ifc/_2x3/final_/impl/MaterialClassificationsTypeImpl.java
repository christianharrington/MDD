...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Material Classifications Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialClassificationsTypeImpl#getIfcClassificationNotationSelect <em>Ifc Classification Notation Select</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialClassificationsTypeImpl#getIfcClassificationNotation <em>Ifc Classification Notation</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialClassificationsTypeImpl#getIfcClassificationReference <em>Ifc Classification Reference</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialClassificationsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialClassificationsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MaterialClassificationsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MaterialClassificationsTypeImpl extends EObjectImpl implements MaterialClassificationsType {
	/**
	 ...
	 * @generated
	 */
	protected MaterialClassificationsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getMaterialClassificationsType();
	}
	...
	public FeatureMap getIfcClassificationNotationSelect() {
		if (ifcClassificationNotationSelect == null) {
			ifcClassificationNotationSelect = new BasicFeatureMap(this, FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__IFC_CLASSIFICATION_NOTATION_SELECT);
		}
	...
	public EList<IfcClassificationNotation> getIfcClassificationNotation() {
		return getIfcClassificationNotationSelect().list(FinalPackage.eINSTANCE.getMaterialClassificationsType_IfcClassificationNotation());
	}
	...
	public EList<IfcClassificationReference> getIfcClassificationReference() {
		return getIfcClassificationNotationSelect().list(FinalPackage.eINSTANCE.getMaterialClassificationsType_IfcClassificationReference());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__IFC_CLASSIFICATION_NOTATION_SELECT:
				return ((InternalEList<?>)getIfcClassificationNotationSelect()).basicRemove(otherEnd, msgs);
			case FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__IFC_CLASSIFICATION_NOTATION:
				return ((InternalEList<?>)getIfcClassificationNotation()).basicRemove(otherEnd, msgs);
			case FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__IFC_CLASSIFICATION_REFERENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.MATERIAL_CLASSIFICATIONS_TYPE__ITEM_TYPE:
				return getItemType();
		}
...
} //MaterialClassificationsTypeImpl
