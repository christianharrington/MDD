...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcOrientationSelect;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcOrientationSelectImpl#getIfcPlaneAngleMeasure <em>Ifc Plane Angle Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcOrientationSelectImpl#getIfcDirection <em>Ifc Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcOrientationSelectImpl extends EObjectImpl implements IfcOrientationSelect {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcOrientationSelect();
	}
	...
	public NotificationChain basicSetIfcPlaneAngleMeasure(IfcPlaneAngleMeasureType newIfcPlaneAngleMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_ORIENTATION_SELECT__IFC_PLANE_ANGLE_MEASURE, oldIfcPlaneAngleMeasure, newIfcPlaneAngleMeasure);
	...
	public void setIfcPlaneAngleMeasure(IfcPlaneAngleMeasureType newIfcPlaneAngleMeasure) {
		if (newIfcPlaneAngleMeasure != ifcPlaneAngleMeasure) {
			...
			if (ifcPlaneAngleMeasure != null)
				msgs = ((InternalEObject)ifcPlaneAngleMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_ORIENTATION_SELECT__IFC_PLANE_ANGLE_MEASURE, null, msgs);
			if (newIfcPlaneAngleMeasure != null)
				msgs = ((InternalEObject)newIfcPlaneAngleMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_ORIENTATION_SELECT__IFC_PLANE_ANGLE_MEASURE, null, msgs);
			msgs = basicSetIfcPlaneAngleMeasure(newIfcPlaneAngleMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_ORIENTATION_SELECT__IFC_PLANE_ANGLE_MEASURE, newIfcPlaneAngleMeasure, newIfcPlaneAngleMeasure));
	}
	...
	public NotificationChain basicSetIfcDirection(IfcDirection newIfcDirection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_ORIENTATION_SELECT__IFC_DIRECTION, oldIfcDirection, newIfcDirection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcDirection(IfcDirection newIfcDirection) {
		if (newIfcDirection != ifcDirection) {
			...
			if (ifcDirection != null)
				msgs = ((InternalEObject)ifcDirection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_ORIENTATION_SELECT__IFC_DIRECTION, null, msgs);
			if (newIfcDirection != null)
				msgs = ((InternalEObject)newIfcDirection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_ORIENTATION_SELECT__IFC_DIRECTION, null, msgs);
			msgs = basicSetIfcDirection(newIfcDirection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_ORIENTATION_SELECT__IFC_DIRECTION, newIfcDirection, newIfcDirection));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_ORIENTATION_SELECT__IFC_PLANE_ANGLE_MEASURE:
				return basicSetIfcPlaneAngleMeasure(null, msgs);
			case FinalPackage.IFC_ORIENTATION_SELECT__IFC_DIRECTION:
