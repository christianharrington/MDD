...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Reflection Colour Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReflectionColourTypeImpl#getIfcColourRgb <em>Ifc Colour Rgb</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReflectionColourTypeImpl#getIfcNormalisedRatioMeasure <em>Ifc Normalised Ratio Measure</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReflectionColourTypeImpl extends EObjectImpl implements ReflectionColourType {
	/**
	 ...
	 * @generated
	 */
	protected ReflectionColourTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getReflectionColourType();
	}
	...
	public NotificationChain basicSetIfcColourRgb(IfcColourRgb newIfcColourRgb, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.REFLECTION_COLOUR_TYPE__IFC_COLOUR_RGB, oldIfcColourRgb, newIfcColourRgb);
	...
	public void setIfcColourRgb(IfcColourRgb newIfcColourRgb) {
		if (newIfcColourRgb != ifcColourRgb) {
			...
			if (ifcColourRgb != null)
				msgs = ((InternalEObject)ifcColourRgb).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.REFLECTION_COLOUR_TYPE__IFC_COLOUR_RGB, null, msgs);
			if (newIfcColourRgb != null)
				msgs = ((InternalEObject)newIfcColourRgb).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.REFLECTION_COLOUR_TYPE__IFC_COLOUR_RGB, null, msgs);
			msgs = basicSetIfcColourRgb(newIfcColourRgb, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.REFLECTION_COLOUR_TYPE__IFC_COLOUR_RGB, newIfcColourRgb, newIfcColourRgb));
	}
	...
	public NotificationChain basicSetIfcNormalisedRatioMeasure(IfcNormalisedRatioMeasureType newIfcNormalisedRatioMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.REFLECTION_COLOUR_TYPE__IFC_NORMALISED_RATIO_MEASURE, oldIfcNormalisedRatioMeasure, newIfcNormalisedRatioMeasure);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcNormalisedRatioMeasure(IfcNormalisedRatioMeasureType newIfcNormalisedRatioMeasure) {
		if (newIfcNormalisedRatioMeasure != ifcNormalisedRatioMeasure) {
			...
			if (ifcNormalisedRatioMeasure != null)
				msgs = ((InternalEObject)ifcNormalisedRatioMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.REFLECTION_COLOUR_TYPE__IFC_NORMALISED_RATIO_MEASURE, null, msgs);
			if (newIfcNormalisedRatioMeasure != null)
				msgs = ((InternalEObject)newIfcNormalisedRatioMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.REFLECTION_COLOUR_TYPE__IFC_NORMALISED_RATIO_MEASURE, null, msgs);
			msgs = basicSetIfcNormalisedRatioMeasure(newIfcNormalisedRatioMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.REFLECTION_COLOUR_TYPE__IFC_NORMALISED_RATIO_MEASURE, newIfcNormalisedRatioMeasure, newIfcNormalisedRatioMeasure));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.REFLECTION_COLOUR_TYPE__IFC_COLOUR_RGB:
				return basicSetIfcColourRgb(null, msgs);
			case FinalPackage.REFLECTION_COLOUR_TYPE__IFC_NORMALISED_RATIO_MEASURE:
