 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RolesType1Impl#getIfcActorRole <em>Ifc Actor Role</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RolesType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RolesType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RolesType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RolesType1Impl extends EObjectImpl implements RolesType1 {
	/**
	 * The cached value of the '{@link #getIfcActorRole() <em>Ifc Actor Role</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIfcActorRole()
	 * @generated
	 * @ordered
	 */
	protected EList<IfcActorRole> ifcActorRole;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcActorRole");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRolesType1();
	}
	 ...
	 * @generated
	 */
	public EList<IfcActorRole> getIfcActorRole() {
		if (ifcActorRole == null) {
			ifcActorRole = new EObjectContainmentEList<IfcActorRole>(IfcActorRole.class, this, FinalPackage.ROLES_TYPE1__IFC_ACTOR_ROLE);
		}
		return ifcActorRole;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROLES_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROLES_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROLES_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.ROLES_TYPE1__IFC_ACTOR_ROLE:
				return ((InternalEList<?>)getIfcActorRole()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.ROLES_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.ROLES_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.ROLES_TYPE1__ITEM_TYPE:
				return getItemType();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FinalPackage.ROLES_TYPE1__IFC_ACTOR_ROLE:
				getIfcActorRole().clear();
				getIfcActorRole().addAll((Collection<? extends IfcActorRole>)newValue);
				return;
			case FinalPackage.ROLES_TYPE1__ARRAY_SIZE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.ROLES_TYPE1__IFC_ACTOR_ROLE:
				return ifcActorRole != null && !ifcActorRole.isEmpty();
			case FinalPackage.ROLES_TYPE1__ARRAY_SIZE:
