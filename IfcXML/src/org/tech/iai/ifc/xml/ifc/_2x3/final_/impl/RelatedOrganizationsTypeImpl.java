...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Related Organizations Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedOrganizationsTypeImpl#getIfcOrganization <em>Ifc Organization</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedOrganizationsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedOrganizationsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedOrganizationsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RelatedOrganizationsTypeImpl extends EObjectImpl implements RelatedOrganizationsType {
	/**
	 * The cached value of the '{@link #getIfcOrganization() <em>Ifc Organization</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcOrganization> ifcOrganization;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcOrganization");
	 ...
	 * @generated
	 */
	protected RelatedOrganizationsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRelatedOrganizationsType();
	}
	...
	public EList<IfcOrganization> getIfcOrganization() {
		if (ifcOrganization == null) {
			ifcOrganization = new EObjectContainmentEList<IfcOrganization>(IfcOrganization.class, this, FinalPackage.RELATED_ORGANIZATIONS_TYPE__IFC_ORGANIZATION);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ORGANIZATIONS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ORGANIZATIONS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ORGANIZATIONS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.RELATED_ORGANIZATIONS_TYPE__IFC_ORGANIZATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.RELATED_ORGANIZATIONS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.RELATED_ORGANIZATIONS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.RELATED_ORGANIZATIONS_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.RELATED_ORGANIZATIONS_TYPE__IFC_ORGANIZATION:
				return ifcOrganization != null && !ifcOrganization.isEmpty();
			case FinalPackage.RELATED_ORGANIZATIONS_TYPE__ARRAY_SIZE:
