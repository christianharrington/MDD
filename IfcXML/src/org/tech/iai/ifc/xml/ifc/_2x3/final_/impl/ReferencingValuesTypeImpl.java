...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Referencing Values Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReferencingValuesTypeImpl#getIfcAppliedValueGroup <em>Ifc Applied Value Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReferencingValuesTypeImpl#getIfcAppliedValue <em>Ifc Applied Value</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReferencingValuesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReferencingValuesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReferencingValuesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReferencingValuesTypeImpl extends EObjectImpl implements ReferencingValuesType {
	/**
	 ...
	 * @generated
	 */
	protected ReferencingValuesTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getReferencingValuesType();
	}
	...
	public FeatureMap getIfcAppliedValueGroup() {
		if (ifcAppliedValueGroup == null) {
			ifcAppliedValueGroup = new BasicFeatureMap(this, FinalPackage.REFERENCING_VALUES_TYPE__IFC_APPLIED_VALUE_GROUP);
		}
	...
	public EList<IfcAppliedValue> getIfcAppliedValue() {
		return getIfcAppliedValueGroup().list(FinalPackage.eINSTANCE.getReferencingValuesType_IfcAppliedValue());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.REFERENCING_VALUES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.REFERENCING_VALUES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.REFERENCING_VALUES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.REFERENCING_VALUES_TYPE__IFC_APPLIED_VALUE_GROUP:
				return ((InternalEList<?>)getIfcAppliedValueGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.REFERENCING_VALUES_TYPE__IFC_APPLIED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.REFERENCING_VALUES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.REFERENCING_VALUES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.REFERENCING_VALUES_TYPE__ITEM_TYPE:
				return getItemType();
		}
