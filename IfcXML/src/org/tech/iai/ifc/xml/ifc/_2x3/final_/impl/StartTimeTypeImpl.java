...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Start Time Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StartTimeTypeImpl#getIfcCalendarDate <em>Ifc Calendar Date</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StartTimeTypeImpl#getIfcLocalTime <em>Ifc Local Time</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StartTimeTypeImpl#getIfcDateAndTime <em>Ifc Date And Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StartTimeTypeImpl extends EObjectImpl implements StartTimeType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getStartTimeType();
	}
	...
	public NotificationChain basicSetIfcCalendarDate(IfcCalendarDate newIfcCalendarDate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.START_TIME_TYPE__IFC_CALENDAR_DATE, oldIfcCalendarDate, newIfcCalendarDate);
	...
	public void setIfcCalendarDate(IfcCalendarDate newIfcCalendarDate) {
		if (newIfcCalendarDate != ifcCalendarDate) {
			...
			if (ifcCalendarDate != null)
				msgs = ((InternalEObject)ifcCalendarDate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.START_TIME_TYPE__IFC_CALENDAR_DATE, null, msgs);
			if (newIfcCalendarDate != null)
				msgs = ((InternalEObject)newIfcCalendarDate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.START_TIME_TYPE__IFC_CALENDAR_DATE, null, msgs);
			msgs = basicSetIfcCalendarDate(newIfcCalendarDate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.START_TIME_TYPE__IFC_CALENDAR_DATE, newIfcCalendarDate, newIfcCalendarDate));
	}
	...
	public NotificationChain basicSetIfcLocalTime(IfcLocalTime newIfcLocalTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.START_TIME_TYPE__IFC_LOCAL_TIME, oldIfcLocalTime, newIfcLocalTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcLocalTime(IfcLocalTime newIfcLocalTime) {
		if (newIfcLocalTime != ifcLocalTime) {
			...
			if (ifcLocalTime != null)
				msgs = ((InternalEObject)ifcLocalTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.START_TIME_TYPE__IFC_LOCAL_TIME, null, msgs);
			if (newIfcLocalTime != null)
				msgs = ((InternalEObject)newIfcLocalTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.START_TIME_TYPE__IFC_LOCAL_TIME, null, msgs);
			msgs = basicSetIfcLocalTime(newIfcLocalTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.START_TIME_TYPE__IFC_LOCAL_TIME, newIfcLocalTime, newIfcLocalTime));
	}
	...
	public NotificationChain basicSetIfcDateAndTime(IfcDateAndTime newIfcDateAndTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.START_TIME_TYPE__IFC_DATE_AND_TIME, oldIfcDateAndTime, newIfcDateAndTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcDateAndTime(IfcDateAndTime newIfcDateAndTime) {
		if (newIfcDateAndTime != ifcDateAndTime) {
			...
			if (ifcDateAndTime != null)
				msgs = ((InternalEObject)ifcDateAndTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.START_TIME_TYPE__IFC_DATE_AND_TIME, null, msgs);
			if (newIfcDateAndTime != null)
				msgs = ((InternalEObject)newIfcDateAndTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.START_TIME_TYPE__IFC_DATE_AND_TIME, null, msgs);
			msgs = basicSetIfcDateAndTime(newIfcDateAndTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.START_TIME_TYPE__IFC_DATE_AND_TIME, newIfcDateAndTime, newIfcDateAndTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.START_TIME_TYPE__IFC_CALENDAR_DATE:
				return basicSetIfcCalendarDate(null, msgs);
			case FinalPackage.START_TIME_TYPE__IFC_LOCAL_TIME:
				return basicSetIfcLocalTime(null, msgs);
			case FinalPackage.START_TIME_TYPE__IFC_DATE_AND_TIME:
