...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcCooledBeamType;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcCooledBeamTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcCooledBeamTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCooledBeamType {
	 ...
	 * @ordered
	 */
	protected static final IfcCooledBeamTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcCooledBeamTypeEnum.ACTIVE;
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcCooledBeamType();
	}
	...
	public void setPredefinedType(IfcCooledBeamTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_COOLED_BEAM_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_COOLED_BEAM_TYPE__PREDEFINED_TYPE:
