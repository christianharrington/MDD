...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cross Sections Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CrossSectionsTypeImpl#getIfcProfileDefGroup <em>Ifc Profile Def Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CrossSectionsTypeImpl#getIfcProfileDef <em>Ifc Profile Def</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CrossSectionsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CrossSectionsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CrossSectionsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CrossSectionsTypeImpl extends EObjectImpl implements CrossSectionsType {
	/**
	 ...
	 * @generated
	 */
	protected CrossSectionsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getCrossSectionsType();
	}
	...
	public FeatureMap getIfcProfileDefGroup() {
		if (ifcProfileDefGroup == null) {
			ifcProfileDefGroup = new BasicFeatureMap(this, FinalPackage.CROSS_SECTIONS_TYPE__IFC_PROFILE_DEF_GROUP);
		}
	...
	public EList<IfcProfileDef> getIfcProfileDef() {
		return getIfcProfileDefGroup().list(FinalPackage.eINSTANCE.getCrossSectionsType_IfcProfileDef());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CROSS_SECTIONS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CROSS_SECTIONS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CROSS_SECTIONS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.CROSS_SECTIONS_TYPE__IFC_PROFILE_DEF_GROUP:
				return ((InternalEList<?>)getIfcProfileDefGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.CROSS_SECTIONS_TYPE__IFC_PROFILE_DEF:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.CROSS_SECTIONS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.CROSS_SECTIONS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.CROSS_SECTIONS_TYPE__ITEM_TYPE:
				return getItemType();
		}
