...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Prepared By Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PreparedByTypeImpl#getIfcOrganization <em>Ifc Organization</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PreparedByTypeImpl#getIfcPerson <em>Ifc Person</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PreparedByTypeImpl#getIfcPersonAndOrganization <em>Ifc Person And Organization</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PreparedByTypeImpl extends EObjectImpl implements PreparedByType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPreparedByType();
	}
	...
	public NotificationChain basicSetIfcOrganization(IfcOrganization newIfcOrganization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PREPARED_BY_TYPE__IFC_ORGANIZATION, oldIfcOrganization, newIfcOrganization);
	...
	public void setIfcOrganization(IfcOrganization newIfcOrganization) {
		if (newIfcOrganization != ifcOrganization) {
			...
			if (ifcOrganization != null)
				msgs = ((InternalEObject)ifcOrganization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PREPARED_BY_TYPE__IFC_ORGANIZATION, null, msgs);
			if (newIfcOrganization != null)
				msgs = ((InternalEObject)newIfcOrganization).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PREPARED_BY_TYPE__IFC_ORGANIZATION, null, msgs);
			msgs = basicSetIfcOrganization(newIfcOrganization, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PREPARED_BY_TYPE__IFC_ORGANIZATION, newIfcOrganization, newIfcOrganization));
	}
	...
	public NotificationChain basicSetIfcPerson(IfcPerson newIfcPerson, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PREPARED_BY_TYPE__IFC_PERSON, oldIfcPerson, newIfcPerson);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcPerson(IfcPerson newIfcPerson) {
		if (newIfcPerson != ifcPerson) {
			NotificationChain msgs = null;
			if (ifcPerson != null)
				msgs = ((InternalEObject)ifcPerson).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PREPARED_BY_TYPE__IFC_PERSON, null, msgs);
			if (newIfcPerson != null)
				msgs = ((InternalEObject)newIfcPerson).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PREPARED_BY_TYPE__IFC_PERSON, null, msgs);
			msgs = basicSetIfcPerson(newIfcPerson, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PREPARED_BY_TYPE__IFC_PERSON, newIfcPerson, newIfcPerson));
	}
	...
	public NotificationChain basicSetIfcPersonAndOrganization(IfcPersonAndOrganization newIfcPersonAndOrganization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PREPARED_BY_TYPE__IFC_PERSON_AND_ORGANIZATION, oldIfcPersonAndOrganization, newIfcPersonAndOrganization);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcPersonAndOrganization(IfcPersonAndOrganization newIfcPersonAndOrganization) {
		if (newIfcPersonAndOrganization != ifcPersonAndOrganization) {
			...
			if (ifcPersonAndOrganization != null)
				msgs = ((InternalEObject)ifcPersonAndOrganization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PREPARED_BY_TYPE__IFC_PERSON_AND_ORGANIZATION, null, msgs);
			if (newIfcPersonAndOrganization != null)
				msgs = ((InternalEObject)newIfcPersonAndOrganization).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PREPARED_BY_TYPE__IFC_PERSON_AND_ORGANIZATION, null, msgs);
			msgs = basicSetIfcPersonAndOrganization(newIfcPersonAndOrganization, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PREPARED_BY_TYPE__IFC_PERSON_AND_ORGANIZATION, newIfcPersonAndOrganization, newIfcPersonAndOrganization));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.PREPARED_BY_TYPE__IFC_ORGANIZATION:
				return basicSetIfcOrganization(null, msgs);
			case FinalPackage.PREPARED_BY_TYPE__IFC_PERSON:
				return basicSetIfcPerson(null, msgs);
			case FinalPackage.PREPARED_BY_TYPE__IFC_PERSON_AND_ORGANIZATION:
