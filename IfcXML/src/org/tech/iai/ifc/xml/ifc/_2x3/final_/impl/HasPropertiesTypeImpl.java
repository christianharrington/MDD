...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Has Properties Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesTypeImpl#getIfcPropertyGroup <em>Ifc Property Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesTypeImpl#getIfcProperty <em>Ifc Property</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HasPropertiesTypeImpl extends EObjectImpl implements HasPropertiesType {
	/**
	 ...
	 * @generated
	 */
	protected HasPropertiesTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getHasPropertiesType();
	}
	...
	public FeatureMap getIfcPropertyGroup() {
		if (ifcPropertyGroup == null) {
			ifcPropertyGroup = new BasicFeatureMap(this, FinalPackage.HAS_PROPERTIES_TYPE__IFC_PROPERTY_GROUP);
		}
	...
	public EList<IfcProperty> getIfcProperty() {
		return getIfcPropertyGroup().list(FinalPackage.eINSTANCE.getHasPropertiesType_IfcProperty());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTIES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTIES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTIES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.HAS_PROPERTIES_TYPE__IFC_PROPERTY_GROUP:
				return ((InternalEList<?>)getIfcPropertyGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.HAS_PROPERTIES_TYPE__IFC_PROPERTY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.HAS_PROPERTIES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.HAS_PROPERTIES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.HAS_PROPERTIES_TYPE__ITEM_TYPE:
				return getItemType();
		}
