...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Curve Font Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CurveFontType1Impl#getIfcPreDefinedCurveFontGroup <em>Ifc Pre Defined Curve Font Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CurveFontType1Impl#getIfcPreDefinedCurveFont <em>Ifc Pre Defined Curve Font</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CurveFontType1Impl#getIfcCurveStyleFont <em>Ifc Curve Style Font</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CurveFontType1Impl#getIfcCurveStyleFontAndScaling <em>Ifc Curve Style Font And Scaling</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CurveFontType1Impl extends EObjectImpl implements CurveFontType1 {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getCurveFontType1();
	}
	...
	public FeatureMap getIfcPreDefinedCurveFontGroup() {
		if (ifcPreDefinedCurveFontGroup == null) {
			ifcPreDefinedCurveFontGroup = new BasicFeatureMap(this, FinalPackage.CURVE_FONT_TYPE1__IFC_PRE_DEFINED_CURVE_FONT_GROUP);
		}
	...
	public IfcPreDefinedCurveFont getIfcPreDefinedCurveFont() {
		return (IfcPreDefinedCurveFont)getIfcPreDefinedCurveFontGroup().get(FinalPackage.eINSTANCE.getCurveFontType1_IfcPreDefinedCurveFont(), true);
	}
	...
	public NotificationChain basicSetIfcPreDefinedCurveFont(IfcPreDefinedCurveFont newIfcPreDefinedCurveFont, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcPreDefinedCurveFontGroup()).basicAdd(FinalPackage.eINSTANCE.getCurveFontType1_IfcPreDefinedCurveFont(), newIfcPreDefinedCurveFont, msgs);
	}
	...
	public NotificationChain basicSetIfcCurveStyleFont(IfcCurveStyleFont newIfcCurveStyleFont, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT, oldIfcCurveStyleFont, newIfcCurveStyleFont);
	...
	public void setIfcCurveStyleFont(IfcCurveStyleFont newIfcCurveStyleFont) {
		if (newIfcCurveStyleFont != ifcCurveStyleFont) {
			...
			if (ifcCurveStyleFont != null)
				msgs = ((InternalEObject)ifcCurveStyleFont).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT, null, msgs);
			if (newIfcCurveStyleFont != null)
				msgs = ((InternalEObject)newIfcCurveStyleFont).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT, null, msgs);
			msgs = basicSetIfcCurveStyleFont(newIfcCurveStyleFont, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT, newIfcCurveStyleFont, newIfcCurveStyleFont));
	}
	...
	public NotificationChain basicSetIfcCurveStyleFontAndScaling(IfcCurveStyleFontAndScaling newIfcCurveStyleFontAndScaling, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT_AND_SCALING, oldIfcCurveStyleFontAndScaling, newIfcCurveStyleFontAndScaling);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcCurveStyleFontAndScaling(IfcCurveStyleFontAndScaling newIfcCurveStyleFontAndScaling) {
		if (newIfcCurveStyleFontAndScaling != ifcCurveStyleFontAndScaling) {
			...
			if (ifcCurveStyleFontAndScaling != null)
				msgs = ((InternalEObject)ifcCurveStyleFontAndScaling).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT_AND_SCALING, null, msgs);
			if (newIfcCurveStyleFontAndScaling != null)
				msgs = ((InternalEObject)newIfcCurveStyleFontAndScaling).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT_AND_SCALING, null, msgs);
			msgs = basicSetIfcCurveStyleFontAndScaling(newIfcCurveStyleFontAndScaling, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT_AND_SCALING, newIfcCurveStyleFontAndScaling, newIfcCurveStyleFontAndScaling));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.CURVE_FONT_TYPE1__IFC_PRE_DEFINED_CURVE_FONT_GROUP:
				return ((InternalEList<?>)getIfcPreDefinedCurveFontGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.CURVE_FONT_TYPE1__IFC_PRE_DEFINED_CURVE_FONT:
				return basicSetIfcPreDefinedCurveFont(null, msgs);
			case FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT:
				return basicSetIfcCurveStyleFont(null, msgs);
			case FinalPackage.CURVE_FONT_TYPE1__IFC_CURVE_STYLE_FONT_AND_SCALING:
