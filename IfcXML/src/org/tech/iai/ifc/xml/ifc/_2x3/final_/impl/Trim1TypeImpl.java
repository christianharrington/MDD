...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Trim1 Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.Trim1TypeImpl#getIfcTrimmingSelect <em>Ifc Trimming Select</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.Trim1TypeImpl#getIfcCartesianPoint <em>Ifc Cartesian Point</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.Trim1TypeImpl#getIfcParameterValue <em>Ifc Parameter Value</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.Trim1TypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.Trim1TypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.Trim1TypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Trim1TypeImpl extends EObjectImpl implements Trim1Type {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getTrim1Type();
	}
	...
	public FeatureMap getIfcTrimmingSelect() {
		if (ifcTrimmingSelect == null) {
			ifcTrimmingSelect = new BasicFeatureMap(this, FinalPackage.TRIM1_TYPE__IFC_TRIMMING_SELECT);
		}
	...
	public EList<IfcCartesianPoint> getIfcCartesianPoint() {
		return getIfcTrimmingSelect().list(FinalPackage.eINSTANCE.getTrim1Type_IfcCartesianPoint());
	}
	...
	public EList<IfcParameterValueType> getIfcParameterValue() {
		return getIfcTrimmingSelect().list(FinalPackage.eINSTANCE.getTrim1Type_IfcParameterValue());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TRIM1_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TRIM1_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TRIM1_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.TRIM1_TYPE__IFC_TRIMMING_SELECT:
				return ((InternalEList<?>)getIfcTrimmingSelect()).basicRemove(otherEnd, msgs);
			case FinalPackage.TRIM1_TYPE__IFC_CARTESIAN_POINT:
				return ((InternalEList<?>)getIfcCartesianPoint()).basicRemove(otherEnd, msgs);
			case FinalPackage.TRIM1_TYPE__IFC_PARAMETER_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.TRIM1_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.TRIM1_TYPE__CTYPE:
				return getCType();
			case FinalPackage.TRIM1_TYPE__ITEM_TYPE:
				return getItemType();
		}
