...
import org.tech.iai.ifc.xml.ifc._2x3.final_.PlacementType1;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Placement Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PlacementType1Impl#getIfcAxis2Placement2D <em>Ifc Axis2 Placement2 D</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PlacementType1Impl#getIfcAxis2Placement3D <em>Ifc Axis2 Placement3 D</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PlacementType1Impl extends EObjectImpl implements PlacementType1 {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPlacementType1();
	}
	...
	public NotificationChain basicSetIfcAxis2Placement2D(IfcAxis2Placement2D newIfcAxis2Placement2D, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT2_D, oldIfcAxis2Placement2D, newIfcAxis2Placement2D);
	...
	public void setIfcAxis2Placement2D(IfcAxis2Placement2D newIfcAxis2Placement2D) {
		if (newIfcAxis2Placement2D != ifcAxis2Placement2D) {
			...
			if (ifcAxis2Placement2D != null)
				msgs = ((InternalEObject)ifcAxis2Placement2D).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT2_D, null, msgs);
			if (newIfcAxis2Placement2D != null)
				msgs = ((InternalEObject)newIfcAxis2Placement2D).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT2_D, null, msgs);
			msgs = basicSetIfcAxis2Placement2D(newIfcAxis2Placement2D, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT2_D, newIfcAxis2Placement2D, newIfcAxis2Placement2D));
	}
	...
	public NotificationChain basicSetIfcAxis2Placement3D(IfcAxis2Placement3D newIfcAxis2Placement3D, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT3_D, oldIfcAxis2Placement3D, newIfcAxis2Placement3D);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcAxis2Placement3D(IfcAxis2Placement3D newIfcAxis2Placement3D) {
		if (newIfcAxis2Placement3D != ifcAxis2Placement3D) {
			...
			if (ifcAxis2Placement3D != null)
				msgs = ((InternalEObject)ifcAxis2Placement3D).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT3_D, null, msgs);
			if (newIfcAxis2Placement3D != null)
				msgs = ((InternalEObject)newIfcAxis2Placement3D).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT3_D, null, msgs);
			msgs = basicSetIfcAxis2Placement3D(newIfcAxis2Placement3D, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT3_D, newIfcAxis2Placement3D, newIfcAxis2Placement3D));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT2_D:
				return basicSetIfcAxis2Placement2D(null, msgs);
			case FinalPackage.PLACEMENT_TYPE1__IFC_AXIS2_PLACEMENT3_D:
