...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcCompressorType;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcCompressorTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcCompressorTypeImpl extends IfcFlowMovingDeviceTypeImpl implements IfcCompressorType {
	 ...
	 * @ordered
	 */
	protected static final IfcCompressorTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcCompressorTypeEnum.DYNAMIC;
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcCompressorType();
	}
	...
	public void setPredefinedType(IfcCompressorTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_COMPRESSOR_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_COMPRESSOR_TYPE__PREDEFINED_TYPE:
