...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcRailing;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcRailingImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcRailingImpl extends IfcBuildingElementImpl implements IfcRailing {
	 ...
	 * @ordered
	 */
	protected static final IfcRailingTypeEnum PREDEFINED_TYPE_EDEFAULT = null;
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcRailing();
	}
	...
	public void setPredefinedType(IfcRailingTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_RAILING__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_RAILING__PREDEFINED_TYPE:
