...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcSizeSelect;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcSizeSelectImpl#getIfcRatioMeasure <em>Ifc Ratio Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcSizeSelectImpl#getIfcLengthMeasure <em>Ifc Length Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcSizeSelectImpl#getIfcDescriptiveMeasure <em>Ifc Descriptive Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcSizeSelectImpl#getIfcPositiveLengthMeasure <em>Ifc Positive Length Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcSizeSelectImpl#getIfcNormalisedRatioMeasure <em>Ifc Normalised Ratio Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcSizeSelectImpl#getIfcPositiveRatioMeasure <em>Ifc Positive Ratio Measure</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcSizeSelectImpl extends EObjectImpl implements IfcSizeSelect {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcSizeSelect();
	}
	...
	public NotificationChain basicSetIfcRatioMeasure(IfcRatioMeasureType newIfcRatioMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_RATIO_MEASURE, oldIfcRatioMeasure, newIfcRatioMeasure);
	...
	public void setIfcRatioMeasure(IfcRatioMeasureType newIfcRatioMeasure) {
		if (newIfcRatioMeasure != ifcRatioMeasure) {
			...
			if (ifcRatioMeasure != null)
				msgs = ((InternalEObject)ifcRatioMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_RATIO_MEASURE, null, msgs);
			if (newIfcRatioMeasure != null)
				msgs = ((InternalEObject)newIfcRatioMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_RATIO_MEASURE, null, msgs);
			msgs = basicSetIfcRatioMeasure(newIfcRatioMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_RATIO_MEASURE, newIfcRatioMeasure, newIfcRatioMeasure));
	}
	...
	public NotificationChain basicSetIfcLengthMeasure(IfcLengthMeasureType newIfcLengthMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_LENGTH_MEASURE, oldIfcLengthMeasure, newIfcLengthMeasure);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcLengthMeasure(IfcLengthMeasureType newIfcLengthMeasure) {
		if (newIfcLengthMeasure != ifcLengthMeasure) {
			...
			if (ifcLengthMeasure != null)
				msgs = ((InternalEObject)ifcLengthMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_LENGTH_MEASURE, null, msgs);
			if (newIfcLengthMeasure != null)
				msgs = ((InternalEObject)newIfcLengthMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_LENGTH_MEASURE, null, msgs);
			msgs = basicSetIfcLengthMeasure(newIfcLengthMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_LENGTH_MEASURE, newIfcLengthMeasure, newIfcLengthMeasure));
	}
	...
	public NotificationChain basicSetIfcDescriptiveMeasure(IfcDescriptiveMeasureType newIfcDescriptiveMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_DESCRIPTIVE_MEASURE, oldIfcDescriptiveMeasure, newIfcDescriptiveMeasure);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcDescriptiveMeasure(IfcDescriptiveMeasureType newIfcDescriptiveMeasure) {
		if (newIfcDescriptiveMeasure != ifcDescriptiveMeasure) {
			...
			if (ifcDescriptiveMeasure != null)
				msgs = ((InternalEObject)ifcDescriptiveMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_DESCRIPTIVE_MEASURE, null, msgs);
			if (newIfcDescriptiveMeasure != null)
				msgs = ((InternalEObject)newIfcDescriptiveMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_DESCRIPTIVE_MEASURE, null, msgs);
			msgs = basicSetIfcDescriptiveMeasure(newIfcDescriptiveMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_DESCRIPTIVE_MEASURE, newIfcDescriptiveMeasure, newIfcDescriptiveMeasure));
	}
	...
	public NotificationChain basicSetIfcPositiveLengthMeasure(IfcPositiveLengthMeasureType newIfcPositiveLengthMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_LENGTH_MEASURE, oldIfcPositiveLengthMeasure, newIfcPositiveLengthMeasure);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcPositiveLengthMeasure(IfcPositiveLengthMeasureType newIfcPositiveLengthMeasure) {
		if (newIfcPositiveLengthMeasure != ifcPositiveLengthMeasure) {
			...
			if (ifcPositiveLengthMeasure != null)
				msgs = ((InternalEObject)ifcPositiveLengthMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_LENGTH_MEASURE, null, msgs);
			if (newIfcPositiveLengthMeasure != null)
				msgs = ((InternalEObject)newIfcPositiveLengthMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_LENGTH_MEASURE, null, msgs);
			msgs = basicSetIfcPositiveLengthMeasure(newIfcPositiveLengthMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_LENGTH_MEASURE, newIfcPositiveLengthMeasure, newIfcPositiveLengthMeasure));
	}
	...
	public NotificationChain basicSetIfcNormalisedRatioMeasure(IfcNormalisedRatioMeasureType newIfcNormalisedRatioMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_NORMALISED_RATIO_MEASURE, oldIfcNormalisedRatioMeasure, newIfcNormalisedRatioMeasure);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcNormalisedRatioMeasure(IfcNormalisedRatioMeasureType newIfcNormalisedRatioMeasure) {
		if (newIfcNormalisedRatioMeasure != ifcNormalisedRatioMeasure) {
			...
			if (ifcNormalisedRatioMeasure != null)
				msgs = ((InternalEObject)ifcNormalisedRatioMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_NORMALISED_RATIO_MEASURE, null, msgs);
			if (newIfcNormalisedRatioMeasure != null)
				msgs = ((InternalEObject)newIfcNormalisedRatioMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_NORMALISED_RATIO_MEASURE, null, msgs);
			msgs = basicSetIfcNormalisedRatioMeasure(newIfcNormalisedRatioMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_NORMALISED_RATIO_MEASURE, newIfcNormalisedRatioMeasure, newIfcNormalisedRatioMeasure));
	}
	...
	public NotificationChain basicSetIfcPositiveRatioMeasure(IfcPositiveRatioMeasureType newIfcPositiveRatioMeasure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_RATIO_MEASURE, oldIfcPositiveRatioMeasure, newIfcPositiveRatioMeasure);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcPositiveRatioMeasure(IfcPositiveRatioMeasureType newIfcPositiveRatioMeasure) {
		if (newIfcPositiveRatioMeasure != ifcPositiveRatioMeasure) {
			...
			if (ifcPositiveRatioMeasure != null)
				msgs = ((InternalEObject)ifcPositiveRatioMeasure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_RATIO_MEASURE, null, msgs);
			if (newIfcPositiveRatioMeasure != null)
				msgs = ((InternalEObject)newIfcPositiveRatioMeasure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_RATIO_MEASURE, null, msgs);
			msgs = basicSetIfcPositiveRatioMeasure(newIfcPositiveRatioMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_RATIO_MEASURE, newIfcPositiveRatioMeasure, newIfcPositiveRatioMeasure));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_SIZE_SELECT__IFC_RATIO_MEASURE:
				return basicSetIfcRatioMeasure(null, msgs);
			case FinalPackage.IFC_SIZE_SELECT__IFC_LENGTH_MEASURE:
				return basicSetIfcLengthMeasure(null, msgs);
			case FinalPackage.IFC_SIZE_SELECT__IFC_DESCRIPTIVE_MEASURE:
				return basicSetIfcDescriptiveMeasure(null, msgs);
			case FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_LENGTH_MEASURE:
				return basicSetIfcPositiveLengthMeasure(null, msgs);
			case FinalPackage.IFC_SIZE_SELECT__IFC_NORMALISED_RATIO_MEASURE:
				return basicSetIfcNormalisedRatioMeasure(null, msgs);
			case FinalPackage.IFC_SIZE_SELECT__IFC_POSITIVE_RATIO_MEASURE:
