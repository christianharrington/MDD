...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Related Constraints Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedConstraintsType1Impl#getIfcConstraintGroup <em>Ifc Constraint Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedConstraintsType1Impl#getIfcConstraint <em>Ifc Constraint</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedConstraintsType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedConstraintsType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedConstraintsType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RelatedConstraintsType1Impl extends EObjectImpl implements RelatedConstraintsType1 {
	/**
	 ...
	 * @generated
	 */
	protected RelatedConstraintsType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRelatedConstraintsType1();
	}
	...
	public FeatureMap getIfcConstraintGroup() {
		if (ifcConstraintGroup == null) {
			ifcConstraintGroup = new BasicFeatureMap(this, FinalPackage.RELATED_CONSTRAINTS_TYPE1__IFC_CONSTRAINT_GROUP);
		}
	...
	public EList<IfcConstraint> getIfcConstraint() {
		return getIfcConstraintGroup().list(FinalPackage.eINSTANCE.getRelatedConstraintsType1_IfcConstraint());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_CONSTRAINTS_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_CONSTRAINTS_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_CONSTRAINTS_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.RELATED_CONSTRAINTS_TYPE1__IFC_CONSTRAINT_GROUP:
				return ((InternalEList<?>)getIfcConstraintGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.RELATED_CONSTRAINTS_TYPE1__IFC_CONSTRAINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.RELATED_CONSTRAINTS_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.RELATED_CONSTRAINTS_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.RELATED_CONSTRAINTS_TYPE1__ITEM_TYPE:
				return getItemType();
		}
