 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PublisherTypeImpl#getIfcOrganization <em>Ifc Organization</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PublisherTypeImpl extends EObjectImpl implements PublisherType {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPublisherType();
	}
	...
	public NotificationChain basicSetIfcOrganization(IfcOrganization newIfcOrganization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PUBLISHER_TYPE__IFC_ORGANIZATION, oldIfcOrganization, newIfcOrganization);
	...
	public void setIfcOrganization(IfcOrganization newIfcOrganization) {
		if (newIfcOrganization != ifcOrganization) {
			...
			if (ifcOrganization != null)
				msgs = ((InternalEObject)ifcOrganization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PUBLISHER_TYPE__IFC_ORGANIZATION, null, msgs);
			if (newIfcOrganization != null)
				msgs = ((InternalEObject)newIfcOrganization).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PUBLISHER_TYPE__IFC_ORGANIZATION, null, msgs);
			msgs = basicSetIfcOrganization(newIfcOrganization, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PUBLISHER_TYPE__IFC_ORGANIZATION, newIfcOrganization, newIfcOrganization));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.PUBLISHER_TYPE__IFC_ORGANIZATION:
