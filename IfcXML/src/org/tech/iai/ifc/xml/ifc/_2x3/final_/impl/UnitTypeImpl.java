 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UnitTypeImpl#getIfcDerivedUnit <em>Ifc Derived Unit</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UnitTypeImpl#getIfcNamedUnitGroup <em>Ifc Named Unit Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UnitTypeImpl#getIfcNamedUnit <em>Ifc Named Unit</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UnitTypeImpl#getIfcMonetaryUnit <em>Ifc Monetary Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitTypeImpl extends EObjectImpl implements UnitType {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getUnitType();
	}
	...
	public NotificationChain basicSetIfcDerivedUnit(IfcDerivedUnit newIfcDerivedUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.UNIT_TYPE__IFC_DERIVED_UNIT, oldIfcDerivedUnit, newIfcDerivedUnit);
	...
	public void setIfcDerivedUnit(IfcDerivedUnit newIfcDerivedUnit) {
		if (newIfcDerivedUnit != ifcDerivedUnit) {
			...
			if (ifcDerivedUnit != null)
				msgs = ((InternalEObject)ifcDerivedUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.UNIT_TYPE__IFC_DERIVED_UNIT, null, msgs);
			if (newIfcDerivedUnit != null)
				msgs = ((InternalEObject)newIfcDerivedUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.UNIT_TYPE__IFC_DERIVED_UNIT, null, msgs);
			msgs = basicSetIfcDerivedUnit(newIfcDerivedUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.UNIT_TYPE__IFC_DERIVED_UNIT, newIfcDerivedUnit, newIfcDerivedUnit));
	}
	...
	public FeatureMap getIfcNamedUnitGroup() {
		if (ifcNamedUnitGroup == null) {
			ifcNamedUnitGroup = new BasicFeatureMap(this, FinalPackage.UNIT_TYPE__IFC_NAMED_UNIT_GROUP);
		}
	...
	public IfcNamedUnit getIfcNamedUnit() {
		return (IfcNamedUnit)getIfcNamedUnitGroup().get(FinalPackage.eINSTANCE.getUnitType_IfcNamedUnit(), true);
	}
	...
	public NotificationChain basicSetIfcNamedUnit(IfcNamedUnit newIfcNamedUnit, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcNamedUnitGroup()).basicAdd(FinalPackage.eINSTANCE.getUnitType_IfcNamedUnit(), newIfcNamedUnit, msgs);
	}
	...
	public NotificationChain basicSetIfcMonetaryUnit(IfcMonetaryUnit newIfcMonetaryUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.UNIT_TYPE__IFC_MONETARY_UNIT, oldIfcMonetaryUnit, newIfcMonetaryUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMonetaryUnit(IfcMonetaryUnit newIfcMonetaryUnit) {
		if (newIfcMonetaryUnit != ifcMonetaryUnit) {
			...
			if (ifcMonetaryUnit != null)
				msgs = ((InternalEObject)ifcMonetaryUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.UNIT_TYPE__IFC_MONETARY_UNIT, null, msgs);
			if (newIfcMonetaryUnit != null)
				msgs = ((InternalEObject)newIfcMonetaryUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.UNIT_TYPE__IFC_MONETARY_UNIT, null, msgs);
			msgs = basicSetIfcMonetaryUnit(newIfcMonetaryUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.UNIT_TYPE__IFC_MONETARY_UNIT, newIfcMonetaryUnit, newIfcMonetaryUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.UNIT_TYPE__IFC_DERIVED_UNIT:
				return basicSetIfcDerivedUnit(null, msgs);
			case FinalPackage.UNIT_TYPE__IFC_NAMED_UNIT_GROUP:
				return ((InternalEList<?>)getIfcNamedUnitGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.UNIT_TYPE__IFC_NAMED_UNIT:
				return basicSetIfcNamedUnit(null, msgs);
			case FinalPackage.UNIT_TYPE__IFC_MONETARY_UNIT:
