...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>End Profile Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EndProfileTypeImpl#getIfcProfileDefGroup <em>Ifc Profile Def Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EndProfileTypeImpl#getIfcProfileDef <em>Ifc Profile Def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EndProfileTypeImpl extends EObjectImpl implements EndProfileType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getEndProfileType();
	}
	...
	public FeatureMap getIfcProfileDefGroup() {
		if (ifcProfileDefGroup == null) {
			ifcProfileDefGroup = new BasicFeatureMap(this, FinalPackage.END_PROFILE_TYPE__IFC_PROFILE_DEF_GROUP);
		}
	...
	public IfcProfileDef getIfcProfileDef() {
		return (IfcProfileDef)getIfcProfileDefGroup().get(FinalPackage.eINSTANCE.getEndProfileType_IfcProfileDef(), true);
	}
	...
	public NotificationChain basicSetIfcProfileDef(IfcProfileDef newIfcProfileDef, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcProfileDefGroup()).basicAdd(FinalPackage.eINSTANCE.getEndProfileType_IfcProfileDef(), newIfcProfileDef, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.END_PROFILE_TYPE__IFC_PROFILE_DEF_GROUP:
				return ((InternalEList<?>)getIfcProfileDefGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.END_PROFILE_TYPE__IFC_PROFILE_DEF:
