...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Texture Points Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TexturePointsTypeImpl#getIfcCartesianPoint <em>Ifc Cartesian Point</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TexturePointsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TexturePointsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TexturePointsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TexturePointsTypeImpl extends EObjectImpl implements TexturePointsType {
	/**
	 ...
	 * @generated
	 */
	protected TexturePointsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getTexturePointsType();
	}
	...
	public EList<IfcCartesianPoint> getIfcCartesianPoint() {
		if (ifcCartesianPoint == null) {
			ifcCartesianPoint = new EObjectContainmentEList<IfcCartesianPoint>(IfcCartesianPoint.class, this, FinalPackage.TEXTURE_POINTS_TYPE__IFC_CARTESIAN_POINT);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TEXTURE_POINTS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TEXTURE_POINTS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TEXTURE_POINTS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.TEXTURE_POINTS_TYPE__IFC_CARTESIAN_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.TEXTURE_POINTS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.TEXTURE_POINTS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.TEXTURE_POINTS_TYPE__ITEM_TYPE:
				return getItemType();
		}
