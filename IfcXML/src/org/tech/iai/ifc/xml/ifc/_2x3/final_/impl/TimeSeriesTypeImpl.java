...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Time Series Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TimeSeriesTypeImpl#getIfcTimeSeriesGroup <em>Ifc Time Series Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TimeSeriesTypeImpl#getIfcTimeSeries <em>Ifc Time Series</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimeSeriesTypeImpl extends EObjectImpl implements TimeSeriesType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getTimeSeriesType();
	}
	...
	public FeatureMap getIfcTimeSeriesGroup() {
		if (ifcTimeSeriesGroup == null) {
			ifcTimeSeriesGroup = new BasicFeatureMap(this, FinalPackage.TIME_SERIES_TYPE__IFC_TIME_SERIES_GROUP);
		}
	...
	public IfcTimeSeries getIfcTimeSeries() {
		return (IfcTimeSeries)getIfcTimeSeriesGroup().get(FinalPackage.eINSTANCE.getTimeSeriesType_IfcTimeSeries(), true);
	}
	...
	public NotificationChain basicSetIfcTimeSeries(IfcTimeSeries newIfcTimeSeries, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcTimeSeriesGroup()).basicAdd(FinalPackage.eINSTANCE.getTimeSeriesType_IfcTimeSeries(), newIfcTimeSeries, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.TIME_SERIES_TYPE__IFC_TIME_SERIES_GROUP:
				return ((InternalEList<?>)getIfcTimeSeriesGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.TIME_SERIES_TYPE__IFC_TIME_SERIES:
