 ...
 * <!-- end-user-doc -->
 * @see org.tech.iai.ifc.xml.ifc._2x3.final_.FinalPackage#getIfcStructuralCurveTypeEnum()
 * @model extendedMetaData="name='IfcStructuralCurveTypeEnum'"
 * @generated
 */
public enum IfcStructuralCurveTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	RIGID_JOINED_MEMBER(0, "rigidJoinedMember", "rigid_joined_member"),
	 ...
	 * @ordered
	 */
	PIN_JOINED_MEMBER(1, "pinJoinedMember", "pin_joined_member"),
	 ...
	 * @ordered
	 */
	TENSION_MEMBER(3, "tensionMember", "tension_member"),
	 ...
	 * @ordered
	 */
	COMPRESSION_MEMBER(4, "compressionMember", "compression_member"),
	 ...
	 * @model name="rigidJoinedMember" literal="rigid_joined_member"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="pinJoinedMember" literal="pin_joined_member"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #TENSION_MEMBER
	 * @model name="tensionMember" literal="tension_member"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="compressionMember" literal="compression_member"
	 * @generated
	 * @ordered
	 */
