...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Styles Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getIfcPresentationStyleSelect <em>Ifc Presentation Style Select</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getIfcNullStyle <em>Ifc Null Style</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getIfcCurveStyle <em>Ifc Curve Style</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getIfcSymbolStyle <em>Ifc Symbol Style</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getIfcFillAreaStyle <em>Ifc Fill Area Style</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getIfcTextStyle <em>Ifc Text Style</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getIfcSurfaceStyle <em>Ifc Surface Style</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.StylesType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StylesType1Impl extends EObjectImpl implements StylesType1 {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getStylesType1();
	}
	...
	public FeatureMap getIfcPresentationStyleSelect() {
		if (ifcPresentationStyleSelect == null) {
			ifcPresentationStyleSelect = new BasicFeatureMap(this, FinalPackage.STYLES_TYPE1__IFC_PRESENTATION_STYLE_SELECT);
		}
	...
	public EList<IfcNullStyleType> getIfcNullStyle() {
		return getIfcPresentationStyleSelect().list(FinalPackage.eINSTANCE.getStylesType1_IfcNullStyle());
	}
	...
	public EList<IfcCurveStyle> getIfcCurveStyle() {
		return getIfcPresentationStyleSelect().list(FinalPackage.eINSTANCE.getStylesType1_IfcCurveStyle());
	}
	...
	public EList<IfcSymbolStyle> getIfcSymbolStyle() {
		return getIfcPresentationStyleSelect().list(FinalPackage.eINSTANCE.getStylesType1_IfcSymbolStyle());
	}
	...
	public EList<IfcFillAreaStyle> getIfcFillAreaStyle() {
		return getIfcPresentationStyleSelect().list(FinalPackage.eINSTANCE.getStylesType1_IfcFillAreaStyle());
	}
	...
	public EList<IfcTextStyle> getIfcTextStyle() {
		return getIfcPresentationStyleSelect().list(FinalPackage.eINSTANCE.getStylesType1_IfcTextStyle());
	}
	...
	public EList<IfcSurfaceStyle> getIfcSurfaceStyle() {
		return getIfcPresentationStyleSelect().list(FinalPackage.eINSTANCE.getStylesType1_IfcSurfaceStyle());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.STYLES_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.STYLES_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.STYLES_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.STYLES_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.STYLES_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.STYLES_TYPE1__ITEM_TYPE:
				return getItemType();
		}
