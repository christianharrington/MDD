...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Coordinates Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CoordinatesType1Impl#getIfcLengthMeasure <em>Ifc Length Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CoordinatesType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CoordinatesType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CoordinatesType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CoordinatesType1Impl extends EObjectImpl implements CoordinatesType1 {
	/**
	 ...
	 * @generated
	 */
	protected CoordinatesType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getCoordinatesType1();
	}
	...
	public EList<IfcLengthMeasureType> getIfcLengthMeasure() {
		if (ifcLengthMeasure == null) {
			ifcLengthMeasure = new EObjectContainmentEList<IfcLengthMeasureType>(IfcLengthMeasureType.class, this, FinalPackage.COORDINATES_TYPE1__IFC_LENGTH_MEASURE);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.COORDINATES_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.COORDINATES_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.COORDINATES_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.COORDINATES_TYPE1__IFC_LENGTH_MEASURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.COORDINATES_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.COORDINATES_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.COORDINATES_TYPE1__ITEM_TYPE:
				return getItemType();
		}
