...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcEllipse;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcEllipseImpl#getSemiAxis1 <em>Semi Axis1</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcEllipseImpl#getSemiAxis2 <em>Semi Axis2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcEllipseImpl extends IfcConicImpl implements IfcEllipse {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcEllipse();
	}
	...
	public void setSemiAxis1(double newSemiAxis1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_ELLIPSE__SEMI_AXIS1, oldSemiAxis1, semiAxis1));
	}
	...
	public void setSemiAxis2(double newSemiAxis2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_ELLIPSE__SEMI_AXIS2, oldSemiAxis2, semiAxis2));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_ELLIPSE__SEMI_AXIS1:
				return getSemiAxis1();
			case FinalPackage.IFC_ELLIPSE__SEMI_AXIS2:
				return getSemiAxis2();
		}
