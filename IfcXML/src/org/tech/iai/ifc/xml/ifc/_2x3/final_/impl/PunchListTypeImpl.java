...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Punch List Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PunchListTypeImpl#getIfcText <em>Ifc Text</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PunchListTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PunchListTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PunchListTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PunchListTypeImpl extends EObjectImpl implements PunchListType {
	/**
	 * The cached value of the '{@link #getIfcText() <em>Ifc Text</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIfcText()
	 * @generated
	 * @ordered
	 */
	protected EList<IfcTextType> ifcText;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcText");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPunchListType();
	}
	...
	public EList<IfcTextType> getIfcText() {
		if (ifcText == null) {
			ifcText = new EObjectContainmentEList<IfcTextType>(IfcTextType.class, this, FinalPackage.PUNCH_LIST_TYPE__IFC_TEXT);
		}
		return ifcText;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PUNCH_LIST_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PUNCH_LIST_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PUNCH_LIST_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.PUNCH_LIST_TYPE__IFC_TEXT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.PUNCH_LIST_TYPE__IFC_TEXT:
				return getIfcText();
			case FinalPackage.PUNCH_LIST_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.PUNCH_LIST_TYPE__CTYPE:
				return getCType();
			case FinalPackage.PUNCH_LIST_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.PUNCH_LIST_TYPE__IFC_TEXT:
				return ifcText != null && !ifcText.isEmpty();
			case FinalPackage.PUNCH_LIST_TYPE__ARRAY_SIZE:
