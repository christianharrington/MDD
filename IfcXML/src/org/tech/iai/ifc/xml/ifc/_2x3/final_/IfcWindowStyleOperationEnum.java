 ...
 * <!-- end-user-doc -->
 * @see org.tech.iai.ifc.xml.ifc._2x3.final_.FinalPackage#getIfcWindowStyleOperationEnum()
 * @model extendedMetaData="name='IfcWindowStyleOperationEnum'"
 * @generated
 */
public enum IfcWindowStyleOperationEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	SINGLE_PANEL(0, "singlePanel", "single_panel"),
	 ...
	 * @ordered
	 */
	DOUBLE_PANEL_VERTICAL(1, "doublePanelVertical", "double_panel_vertical"),
	 ...
	 * @ordered
	 */
	DOUBLE_PANEL_HORIZONTAL(2, "doublePanelHorizontal", "double_panel_horizontal"),
	 ...
	 * @ordered
	 */
	TRIPLE_PANEL_VERTICAL(3, "triplePanelVertical", "triple_panel_vertical"),
	 ...
	 * @ordered
	 */
	TRIPLE_PANEL_BOTTOM(4, "triplePanelBottom", "triple_panel_bottom"),
	 ...
	 * @ordered
	 */
	TRIPLE_PANEL_TOP(5, "triplePanelTop", "triple_panel_top"),
	 ...
	 * @ordered
	 */
	TRIPLE_PANEL_LEFT(6, "triplePanelLeft", "triple_panel_left"),
	 ...
	 * @ordered
	 */
	TRIPLE_PANEL_RIGHT(7, "triplePanelRight", "triple_panel_right"),
	 ...
	 * @ordered
	 */
	TRIPLE_PANEL_HORIZONTAL(8, "triplePanelHorizontal", "triple_panel_horizontal"),
	 ...
	 * <!-- end-user-doc -->
	 * @see #SINGLE_PANEL
	 * @model name="singlePanel" literal="single_panel"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="doublePanelVertical" literal="double_panel_vertical"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="doublePanelHorizontal" literal="double_panel_horizontal"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="triplePanelVertical" literal="triple_panel_vertical"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="triplePanelBottom" literal="triple_panel_bottom"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="triplePanelTop" literal="triple_panel_top"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="triplePanelLeft" literal="triple_panel_left"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="triplePanelRight" literal="triple_panel_right"
	 * @generated
	 * @ordered
	 */
	 ...
	 * @model name="triplePanelHorizontal" literal="triple_panel_horizontal"
	 * @generated
	 * @ordered
	 */
