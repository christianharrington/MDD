...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcDistributionControlElement;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcDistributionControlElementImpl#getControlElementId <em>Control Element Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcDistributionControlElementImpl extends IfcDistributionElementImpl implements IfcDistributionControlElement {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcDistributionControlElement();
	}
	...
	public void setControlElementId(String newControlElementId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_DISTRIBUTION_CONTROL_ELEMENT__CONTROL_ELEMENT_ID, oldControlElementId, controlElementId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_DISTRIBUTION_CONTROL_ELEMENT__CONTROL_ELEMENT_ID:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FinalPackage.IFC_DISTRIBUTION_CONTROL_ELEMENT__CONTROL_ELEMENT_ID:
				setControlElementId(CONTROL_ELEMENT_ID_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.IFC_DISTRIBUTION_CONTROL_ELEMENT__CONTROL_ELEMENT_ID:
				return CONTROL_ELEMENT_ID_EDEFAULT == null ? controlElementId != null : !CONTROL_ELEMENT_ID_EDEFAULT.equals(controlElementId);
		}
