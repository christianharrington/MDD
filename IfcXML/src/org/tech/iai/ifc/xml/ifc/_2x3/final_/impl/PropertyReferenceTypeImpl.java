...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Property Reference Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcMaterial <em>Ifc Material</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcPerson <em>Ifc Person</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcDateAndTime <em>Ifc Date And Time</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcMaterialList <em>Ifc Material List</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcOrganization <em>Ifc Organization</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcCalendarDate <em>Ifc Calendar Date</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcLocalTime <em>Ifc Local Time</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcPersonAndOrganization <em>Ifc Person And Organization</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcMaterialLayer <em>Ifc Material Layer</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcExternalReferenceGroup <em>Ifc External Reference Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcExternalReference <em>Ifc External Reference</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcTimeSeriesGroup <em>Ifc Time Series Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcTimeSeries <em>Ifc Time Series</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcAddressGroup <em>Ifc Address Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcAddress <em>Ifc Address</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcAppliedValueGroup <em>Ifc Applied Value Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PropertyReferenceTypeImpl#getIfcAppliedValue <em>Ifc Applied Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PropertyReferenceTypeImpl extends EObjectImpl implements PropertyReferenceType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPropertyReferenceType();
	}
	...
	public NotificationChain basicSetIfcMaterial(IfcMaterial newIfcMaterial, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL, oldIfcMaterial, newIfcMaterial);
	...
	public void setIfcMaterial(IfcMaterial newIfcMaterial) {
		if (newIfcMaterial != ifcMaterial) {
			...
			if (ifcMaterial != null)
				msgs = ((InternalEObject)ifcMaterial).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL, null, msgs);
			if (newIfcMaterial != null)
				msgs = ((InternalEObject)newIfcMaterial).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL, null, msgs);
			msgs = basicSetIfcMaterial(newIfcMaterial, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL, newIfcMaterial, newIfcMaterial));
	}
	...
	public NotificationChain basicSetIfcPerson(IfcPerson newIfcPerson, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON, oldIfcPerson, newIfcPerson);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcPerson(IfcPerson newIfcPerson) {
		if (newIfcPerson != ifcPerson) {
			NotificationChain msgs = null;
			if (ifcPerson != null)
				msgs = ((InternalEObject)ifcPerson).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON, null, msgs);
			if (newIfcPerson != null)
				msgs = ((InternalEObject)newIfcPerson).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON, null, msgs);
			msgs = basicSetIfcPerson(newIfcPerson, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON, newIfcPerson, newIfcPerson));
	}
	...
	public NotificationChain basicSetIfcDateAndTime(IfcDateAndTime newIfcDateAndTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_DATE_AND_TIME, oldIfcDateAndTime, newIfcDateAndTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcDateAndTime(IfcDateAndTime newIfcDateAndTime) {
		if (newIfcDateAndTime != ifcDateAndTime) {
			...
			if (ifcDateAndTime != null)
				msgs = ((InternalEObject)ifcDateAndTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_DATE_AND_TIME, null, msgs);
			if (newIfcDateAndTime != null)
				msgs = ((InternalEObject)newIfcDateAndTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_DATE_AND_TIME, null, msgs);
			msgs = basicSetIfcDateAndTime(newIfcDateAndTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_DATE_AND_TIME, newIfcDateAndTime, newIfcDateAndTime));
	}
	...
	public NotificationChain basicSetIfcMaterialList(IfcMaterialList newIfcMaterialList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LIST, oldIfcMaterialList, newIfcMaterialList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMaterialList(IfcMaterialList newIfcMaterialList) {
		if (newIfcMaterialList != ifcMaterialList) {
			...
			if (ifcMaterialList != null)
				msgs = ((InternalEObject)ifcMaterialList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LIST, null, msgs);
			if (newIfcMaterialList != null)
				msgs = ((InternalEObject)newIfcMaterialList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LIST, null, msgs);
			msgs = basicSetIfcMaterialList(newIfcMaterialList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LIST, newIfcMaterialList, newIfcMaterialList));
	}
	...
	public NotificationChain basicSetIfcOrganization(IfcOrganization newIfcOrganization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_ORGANIZATION, oldIfcOrganization, newIfcOrganization);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcOrganization(IfcOrganization newIfcOrganization) {
		if (newIfcOrganization != ifcOrganization) {
			...
			if (ifcOrganization != null)
				msgs = ((InternalEObject)ifcOrganization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_ORGANIZATION, null, msgs);
			if (newIfcOrganization != null)
				msgs = ((InternalEObject)newIfcOrganization).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_ORGANIZATION, null, msgs);
			msgs = basicSetIfcOrganization(newIfcOrganization, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_ORGANIZATION, newIfcOrganization, newIfcOrganization));
	}
	...
	public NotificationChain basicSetIfcCalendarDate(IfcCalendarDate newIfcCalendarDate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_CALENDAR_DATE, oldIfcCalendarDate, newIfcCalendarDate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcCalendarDate(IfcCalendarDate newIfcCalendarDate) {
		if (newIfcCalendarDate != ifcCalendarDate) {
			...
			if (ifcCalendarDate != null)
				msgs = ((InternalEObject)ifcCalendarDate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_CALENDAR_DATE, null, msgs);
			if (newIfcCalendarDate != null)
				msgs = ((InternalEObject)newIfcCalendarDate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_CALENDAR_DATE, null, msgs);
			msgs = basicSetIfcCalendarDate(newIfcCalendarDate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_CALENDAR_DATE, newIfcCalendarDate, newIfcCalendarDate));
	}
	...
	public NotificationChain basicSetIfcLocalTime(IfcLocalTime newIfcLocalTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_LOCAL_TIME, oldIfcLocalTime, newIfcLocalTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcLocalTime(IfcLocalTime newIfcLocalTime) {
		if (newIfcLocalTime != ifcLocalTime) {
			...
			if (ifcLocalTime != null)
				msgs = ((InternalEObject)ifcLocalTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_LOCAL_TIME, null, msgs);
			if (newIfcLocalTime != null)
				msgs = ((InternalEObject)newIfcLocalTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_LOCAL_TIME, null, msgs);
			msgs = basicSetIfcLocalTime(newIfcLocalTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_LOCAL_TIME, newIfcLocalTime, newIfcLocalTime));
	}
	...
	public NotificationChain basicSetIfcPersonAndOrganization(IfcPersonAndOrganization newIfcPersonAndOrganization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON_AND_ORGANIZATION, oldIfcPersonAndOrganization, newIfcPersonAndOrganization);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcPersonAndOrganization(IfcPersonAndOrganization newIfcPersonAndOrganization) {
		if (newIfcPersonAndOrganization != ifcPersonAndOrganization) {
			...
			if (ifcPersonAndOrganization != null)
				msgs = ((InternalEObject)ifcPersonAndOrganization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON_AND_ORGANIZATION, null, msgs);
			if (newIfcPersonAndOrganization != null)
				msgs = ((InternalEObject)newIfcPersonAndOrganization).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON_AND_ORGANIZATION, null, msgs);
			msgs = basicSetIfcPersonAndOrganization(newIfcPersonAndOrganization, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON_AND_ORGANIZATION, newIfcPersonAndOrganization, newIfcPersonAndOrganization));
	}
	...
	public NotificationChain basicSetIfcMaterialLayer(IfcMaterialLayer newIfcMaterialLayer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LAYER, oldIfcMaterialLayer, newIfcMaterialLayer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMaterialLayer(IfcMaterialLayer newIfcMaterialLayer) {
		if (newIfcMaterialLayer != ifcMaterialLayer) {
			...
			if (ifcMaterialLayer != null)
				msgs = ((InternalEObject)ifcMaterialLayer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LAYER, null, msgs);
			if (newIfcMaterialLayer != null)
				msgs = ((InternalEObject)newIfcMaterialLayer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LAYER, null, msgs);
			msgs = basicSetIfcMaterialLayer(newIfcMaterialLayer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LAYER, newIfcMaterialLayer, newIfcMaterialLayer));
	}
	...
	public FeatureMap getIfcExternalReferenceGroup() {
		if (ifcExternalReferenceGroup == null) {
			ifcExternalReferenceGroup = new BasicFeatureMap(this, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_EXTERNAL_REFERENCE_GROUP);
		}
	...
	public IfcExternalReference getIfcExternalReference() {
		return (IfcExternalReference)getIfcExternalReferenceGroup().get(FinalPackage.eINSTANCE.getPropertyReferenceType_IfcExternalReference(), true);
	}
	...
	public NotificationChain basicSetIfcExternalReference(IfcExternalReference newIfcExternalReference, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcExternalReferenceGroup()).basicAdd(FinalPackage.eINSTANCE.getPropertyReferenceType_IfcExternalReference(), newIfcExternalReference, msgs);
	}
	...
	public FeatureMap getIfcTimeSeriesGroup() {
		if (ifcTimeSeriesGroup == null) {
			ifcTimeSeriesGroup = new BasicFeatureMap(this, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_TIME_SERIES_GROUP);
		}
	...
	public IfcTimeSeries getIfcTimeSeries() {
		return (IfcTimeSeries)getIfcTimeSeriesGroup().get(FinalPackage.eINSTANCE.getPropertyReferenceType_IfcTimeSeries(), true);
	}
	...
	public NotificationChain basicSetIfcTimeSeries(IfcTimeSeries newIfcTimeSeries, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcTimeSeriesGroup()).basicAdd(FinalPackage.eINSTANCE.getPropertyReferenceType_IfcTimeSeries(), newIfcTimeSeries, msgs);
	}
	...
	public FeatureMap getIfcAddressGroup() {
		if (ifcAddressGroup == null) {
			ifcAddressGroup = new BasicFeatureMap(this, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_ADDRESS_GROUP);
		}
	...
	public IfcAddress getIfcAddress() {
		return (IfcAddress)getIfcAddressGroup().get(FinalPackage.eINSTANCE.getPropertyReferenceType_IfcAddress(), true);
	}
	...
	public NotificationChain basicSetIfcAddress(IfcAddress newIfcAddress, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcAddressGroup()).basicAdd(FinalPackage.eINSTANCE.getPropertyReferenceType_IfcAddress(), newIfcAddress, msgs);
	}
	...
	public FeatureMap getIfcAppliedValueGroup() {
		if (ifcAppliedValueGroup == null) {
			ifcAppliedValueGroup = new BasicFeatureMap(this, FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_APPLIED_VALUE_GROUP);
		}
	...
	public IfcAppliedValue getIfcAppliedValue() {
		return (IfcAppliedValue)getIfcAppliedValueGroup().get(FinalPackage.eINSTANCE.getPropertyReferenceType_IfcAppliedValue(), true);
	}
	...
	public NotificationChain basicSetIfcAppliedValue(IfcAppliedValue newIfcAppliedValue, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcAppliedValueGroup()).basicAdd(FinalPackage.eINSTANCE.getPropertyReferenceType_IfcAppliedValue(), newIfcAppliedValue, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL:
				return basicSetIfcMaterial(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON:
				return basicSetIfcPerson(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_DATE_AND_TIME:
				return basicSetIfcDateAndTime(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LIST:
				return basicSetIfcMaterialList(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_ORGANIZATION:
				return basicSetIfcOrganization(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_CALENDAR_DATE:
				return basicSetIfcCalendarDate(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_LOCAL_TIME:
				return basicSetIfcLocalTime(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_PERSON_AND_ORGANIZATION:
				return basicSetIfcPersonAndOrganization(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_MATERIAL_LAYER:
				return basicSetIfcMaterialLayer(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_EXTERNAL_REFERENCE_GROUP:
				return ((InternalEList<?>)getIfcExternalReferenceGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_EXTERNAL_REFERENCE:
				return basicSetIfcExternalReference(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_TIME_SERIES_GROUP:
				return ((InternalEList<?>)getIfcTimeSeriesGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_TIME_SERIES:
				return basicSetIfcTimeSeries(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_ADDRESS_GROUP:
				return ((InternalEList<?>)getIfcAddressGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_ADDRESS:
				return basicSetIfcAddress(null, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_APPLIED_VALUE_GROUP:
				return ((InternalEList<?>)getIfcAppliedValueGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.PROPERTY_REFERENCE_TYPE__IFC_APPLIED_VALUE:
