...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcWindow;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcWindowImpl#getOverallHeight <em>Overall Height</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcWindowImpl#getOverallWidth <em>Overall Width</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcWindowImpl extends IfcBuildingElementImpl implements IfcWindow {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcWindow();
	}
	...
	public void setOverallHeight(Double newOverallHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_WINDOW__OVERALL_HEIGHT, oldOverallHeight, overallHeight));
	}
	...
	public void setOverallWidth(Double newOverallWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_WINDOW__OVERALL_WIDTH, oldOverallWidth, overallWidth));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_WINDOW__OVERALL_HEIGHT:
				return getOverallHeight();
			case FinalPackage.IFC_WINDOW__OVERALL_WIDTH:
