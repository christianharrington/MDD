 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ValuesType1Impl#getIfcIrregularTimeSeriesValue <em>Ifc Irregular Time Series Value</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ValuesType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ValuesType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ValuesType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValuesType1Impl extends EObjectImpl implements ValuesType1 {
	/**
	 * The cached value of the '{@link #getIfcIrregularTimeSeriesValue() <em>Ifc Irregular Time Series Value</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcIrregularTimeSeriesValue> ifcIrregularTimeSeriesValue;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcIrregularTimeSeriesValue");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getValuesType1();
	}
	 ...
	 * @generated
	 */
	public EList<IfcIrregularTimeSeriesValue> getIfcIrregularTimeSeriesValue() {
		if (ifcIrregularTimeSeriesValue == null) {
			ifcIrregularTimeSeriesValue = new EObjectContainmentEList<IfcIrregularTimeSeriesValue>(IfcIrregularTimeSeriesValue.class, this, FinalPackage.VALUES_TYPE1__IFC_IRREGULAR_TIME_SERIES_VALUE);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VALUES_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VALUES_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VALUES_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.VALUES_TYPE1__IFC_IRREGULAR_TIME_SERIES_VALUE:
				return ((InternalEList<?>)getIfcIrregularTimeSeriesValue()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.VALUES_TYPE1__IFC_IRREGULAR_TIME_SERIES_VALUE:
				return getIfcIrregularTimeSeriesValue();
			case FinalPackage.VALUES_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.VALUES_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.VALUES_TYPE1__ITEM_TYPE:
				return getItemType();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FinalPackage.VALUES_TYPE1__IFC_IRREGULAR_TIME_SERIES_VALUE:
				getIfcIrregularTimeSeriesValue().clear();
				getIfcIrregularTimeSeriesValue().addAll((Collection<? extends IfcIrregularTimeSeriesValue>)newValue);
				return;
			case FinalPackage.VALUES_TYPE1__ARRAY_SIZE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.VALUES_TYPE1__IFC_IRREGULAR_TIME_SERIES_VALUE:
				return ifcIrregularTimeSeriesValue != null && !ifcIrregularTimeSeriesValue.isEmpty();
			case FinalPackage.VALUES_TYPE1__ARRAY_SIZE:
