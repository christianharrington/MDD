...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcPointOrVertexPoint;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcPointOrVertexPointImpl#getIfcPointGroup <em>Ifc Point Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcPointOrVertexPointImpl#getIfcPoint <em>Ifc Point</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcPointOrVertexPointImpl#getIfcVertexPoint <em>Ifc Vertex Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcPointOrVertexPointImpl extends EObjectImpl implements IfcPointOrVertexPoint {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcPointOrVertexPoint();
	}
	...
	public FeatureMap getIfcPointGroup() {
		if (ifcPointGroup == null) {
			ifcPointGroup = new BasicFeatureMap(this, FinalPackage.IFC_POINT_OR_VERTEX_POINT__IFC_POINT_GROUP);
		}
	...
	public IfcPoint getIfcPoint() {
		return (IfcPoint)getIfcPointGroup().get(FinalPackage.eINSTANCE.getIfcPointOrVertexPoint_IfcPoint(), true);
	}
	...
	public NotificationChain basicSetIfcPoint(IfcPoint newIfcPoint, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcPointGroup()).basicAdd(FinalPackage.eINSTANCE.getIfcPointOrVertexPoint_IfcPoint(), newIfcPoint, msgs);
	}
	...
	public NotificationChain basicSetIfcVertexPoint(IfcVertexPoint newIfcVertexPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_POINT_OR_VERTEX_POINT__IFC_VERTEX_POINT, oldIfcVertexPoint, newIfcVertexPoint);
	...
	public void setIfcVertexPoint(IfcVertexPoint newIfcVertexPoint) {
		if (newIfcVertexPoint != ifcVertexPoint) {
			...
			if (ifcVertexPoint != null)
				msgs = ((InternalEObject)ifcVertexPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_POINT_OR_VERTEX_POINT__IFC_VERTEX_POINT, null, msgs);
			if (newIfcVertexPoint != null)
				msgs = ((InternalEObject)newIfcVertexPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_POINT_OR_VERTEX_POINT__IFC_VERTEX_POINT, null, msgs);
			msgs = basicSetIfcVertexPoint(newIfcVertexPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_POINT_OR_VERTEX_POINT__IFC_VERTEX_POINT, newIfcVertexPoint, newIfcVertexPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_POINT_OR_VERTEX_POINT__IFC_POINT_GROUP:
				return ((InternalEList<?>)getIfcPointGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.IFC_POINT_OR_VERTEX_POINT__IFC_POINT:
				return basicSetIfcPoint(null, msgs);
			case FinalPackage.IFC_POINT_OR_VERTEX_POINT__IFC_VERTEX_POINT:
