...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Creators Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CreatorsTypeImpl#getIfcPerson <em>Ifc Person</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CreatorsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CreatorsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CreatorsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CreatorsTypeImpl extends EObjectImpl implements CreatorsType {
	/**
	 * The cached value of the '{@link #getIfcPerson() <em>Ifc Person</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIfcPerson()
	 * @generated
	 * @ordered
	 */
	protected EList<IfcPerson> ifcPerson;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcPerson");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getCreatorsType();
	}
	...
	public EList<IfcPerson> getIfcPerson() {
		if (ifcPerson == null) {
			ifcPerson = new EObjectContainmentEList<IfcPerson>(IfcPerson.class, this, FinalPackage.CREATORS_TYPE__IFC_PERSON);
		}
		return ifcPerson;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CREATORS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CREATORS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CREATORS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.CREATORS_TYPE__IFC_PERSON:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.CREATORS_TYPE__IFC_PERSON:
				return getIfcPerson();
			case FinalPackage.CREATORS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.CREATORS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.CREATORS_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.CREATORS_TYPE__IFC_PERSON:
				return ifcPerson != null && !ifcPerson.isEmpty();
			case FinalPackage.CREATORS_TYPE__ARRAY_SIZE:
