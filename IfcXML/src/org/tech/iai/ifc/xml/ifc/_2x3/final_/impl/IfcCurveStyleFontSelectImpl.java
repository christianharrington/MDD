...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcCurveStyleFontSelect;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcCurveStyleFontSelectImpl#getIfcPreDefinedCurveFontGroup <em>Ifc Pre Defined Curve Font Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcCurveStyleFontSelectImpl#getIfcPreDefinedCurveFont <em>Ifc Pre Defined Curve Font</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcCurveStyleFontSelectImpl#getIfcCurveStyleFont <em>Ifc Curve Style Font</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcCurveStyleFontSelectImpl extends EObjectImpl implements IfcCurveStyleFontSelect {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcCurveStyleFontSelect();
	}
	...
	public FeatureMap getIfcPreDefinedCurveFontGroup() {
		if (ifcPreDefinedCurveFontGroup == null) {
			ifcPreDefinedCurveFontGroup = new BasicFeatureMap(this, FinalPackage.IFC_CURVE_STYLE_FONT_SELECT__IFC_PRE_DEFINED_CURVE_FONT_GROUP);
		}
	...
	public IfcPreDefinedCurveFont getIfcPreDefinedCurveFont() {
		return (IfcPreDefinedCurveFont)getIfcPreDefinedCurveFontGroup().get(FinalPackage.eINSTANCE.getIfcCurveStyleFontSelect_IfcPreDefinedCurveFont(), true);
	}
	...
	public NotificationChain basicSetIfcPreDefinedCurveFont(IfcPreDefinedCurveFont newIfcPreDefinedCurveFont, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcPreDefinedCurveFontGroup()).basicAdd(FinalPackage.eINSTANCE.getIfcCurveStyleFontSelect_IfcPreDefinedCurveFont(), newIfcPreDefinedCurveFont, msgs);
	}
	...
	public NotificationChain basicSetIfcCurveStyleFont(IfcCurveStyleFont newIfcCurveStyleFont, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_CURVE_STYLE_FONT_SELECT__IFC_CURVE_STYLE_FONT, oldIfcCurveStyleFont, newIfcCurveStyleFont);
	...
	public void setIfcCurveStyleFont(IfcCurveStyleFont newIfcCurveStyleFont) {
		if (newIfcCurveStyleFont != ifcCurveStyleFont) {
			...
			if (ifcCurveStyleFont != null)
				msgs = ((InternalEObject)ifcCurveStyleFont).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_CURVE_STYLE_FONT_SELECT__IFC_CURVE_STYLE_FONT, null, msgs);
			if (newIfcCurveStyleFont != null)
				msgs = ((InternalEObject)newIfcCurveStyleFont).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_CURVE_STYLE_FONT_SELECT__IFC_CURVE_STYLE_FONT, null, msgs);
			msgs = basicSetIfcCurveStyleFont(newIfcCurveStyleFont, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_CURVE_STYLE_FONT_SELECT__IFC_CURVE_STYLE_FONT, newIfcCurveStyleFont, newIfcCurveStyleFont));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_CURVE_STYLE_FONT_SELECT__IFC_PRE_DEFINED_CURVE_FONT_GROUP:
				return ((InternalEList<?>)getIfcPreDefinedCurveFontGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.IFC_CURVE_STYLE_FONT_SELECT__IFC_PRE_DEFINED_CURVE_FONT:
				return basicSetIfcPreDefinedCurveFont(null, msgs);
			case FinalPackage.IFC_CURVE_STYLE_FONT_SELECT__IFC_CURVE_STYLE_FONT:
