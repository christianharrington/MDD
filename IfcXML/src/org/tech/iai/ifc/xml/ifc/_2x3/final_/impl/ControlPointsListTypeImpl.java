...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Control Points List Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ControlPointsListTypeImpl#getIfcCartesianPoint <em>Ifc Cartesian Point</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ControlPointsListTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ControlPointsListTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ControlPointsListTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ControlPointsListTypeImpl extends EObjectImpl implements ControlPointsListType {
	/**
	 * The cached value of the '{@link #getIfcCartesianPoint() <em>Ifc Cartesian Point</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcCartesianPoint> ifcCartesianPoint;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcCartesianPoint");
	 ...
	 * @generated
	 */
	protected ControlPointsListTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getControlPointsListType();
	}
	...
	public EList<IfcCartesianPoint> getIfcCartesianPoint() {
		if (ifcCartesianPoint == null) {
			ifcCartesianPoint = new EObjectContainmentEList<IfcCartesianPoint>(IfcCartesianPoint.class, this, FinalPackage.CONTROL_POINTS_LIST_TYPE__IFC_CARTESIAN_POINT);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CONTROL_POINTS_LIST_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CONTROL_POINTS_LIST_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CONTROL_POINTS_LIST_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.CONTROL_POINTS_LIST_TYPE__IFC_CARTESIAN_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.CONTROL_POINTS_LIST_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.CONTROL_POINTS_LIST_TYPE__CTYPE:
				return getCType();
			case FinalPackage.CONTROL_POINTS_LIST_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.CONTROL_POINTS_LIST_TYPE__IFC_CARTESIAN_POINT:
				return ifcCartesianPoint != null && !ifcCartesianPoint.isEmpty();
			case FinalPackage.CONTROL_POINTS_LIST_TYPE__ARRAY_SIZE:
