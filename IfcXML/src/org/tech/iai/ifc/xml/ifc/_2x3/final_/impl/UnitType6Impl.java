...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Unit Type6</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UnitType6Impl#getIfcNamedUnitGroup <em>Ifc Named Unit Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.UnitType6Impl#getIfcNamedUnit <em>Ifc Named Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UnitType6Impl extends EObjectImpl implements UnitType6 {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getUnitType6();
	}
	...
	public FeatureMap getIfcNamedUnitGroup() {
		if (ifcNamedUnitGroup == null) {
			ifcNamedUnitGroup = new BasicFeatureMap(this, FinalPackage.UNIT_TYPE6__IFC_NAMED_UNIT_GROUP);
		}
	...
	public IfcNamedUnit getIfcNamedUnit() {
		return (IfcNamedUnit)getIfcNamedUnitGroup().get(FinalPackage.eINSTANCE.getUnitType6_IfcNamedUnit(), true);
	}
	...
	public NotificationChain basicSetIfcNamedUnit(IfcNamedUnit newIfcNamedUnit, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcNamedUnitGroup()).basicAdd(FinalPackage.eINSTANCE.getUnitType6_IfcNamedUnit(), newIfcNamedUnit, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.UNIT_TYPE6__IFC_NAMED_UNIT_GROUP:
				return ((InternalEList<?>)getIfcNamedUnitGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.UNIT_TYPE6__IFC_NAMED_UNIT:
