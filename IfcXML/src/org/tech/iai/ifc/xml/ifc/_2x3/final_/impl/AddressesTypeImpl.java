 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesTypeImpl#getIfcAddressGroup <em>Ifc Address Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesTypeImpl#getIfcAddress <em>Ifc Address</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddressesTypeImpl extends EObjectImpl implements AddressesType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getAddressesType();
	}
	...
	public FeatureMap getIfcAddressGroup() {
		if (ifcAddressGroup == null) {
			ifcAddressGroup = new BasicFeatureMap(this, FinalPackage.ADDRESSES_TYPE__IFC_ADDRESS_GROUP);
		}
	...
	public EList<IfcAddress> getIfcAddress() {
		return getIfcAddressGroup().list(FinalPackage.eINSTANCE.getAddressesType_IfcAddress());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESSES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESSES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESSES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.ADDRESSES_TYPE__IFC_ADDRESS_GROUP:
				return ((InternalEList<?>)getIfcAddressGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.ADDRESSES_TYPE__IFC_ADDRESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.ADDRESSES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.ADDRESSES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.ADDRESSES_TYPE__ITEM_TYPE:
				return getItemType();
		}
