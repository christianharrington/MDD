...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Facsimile Numbers Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.FacsimileNumbersTypeImpl#getIfcLabel <em>Ifc Label</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.FacsimileNumbersTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.FacsimileNumbersTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.FacsimileNumbersTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FacsimileNumbersTypeImpl extends EObjectImpl implements FacsimileNumbersType {
	/**
	 ...
	 * @generated
	 */
	protected FacsimileNumbersTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getFacsimileNumbersType();
	}
	...
	public EList<IfcLabelType> getIfcLabel() {
		if (ifcLabel == null) {
			ifcLabel = new EObjectContainmentEList<IfcLabelType>(IfcLabelType.class, this, FinalPackage.FACSIMILE_NUMBERS_TYPE__IFC_LABEL);
		}
		return ifcLabel;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.FACSIMILE_NUMBERS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.FACSIMILE_NUMBERS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.FACSIMILE_NUMBERS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.FACSIMILE_NUMBERS_TYPE__IFC_LABEL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.FACSIMILE_NUMBERS_TYPE__IFC_LABEL:
				return getIfcLabel();
			case FinalPackage.FACSIMILE_NUMBERS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.FACSIMILE_NUMBERS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.FACSIMILE_NUMBERS_TYPE__ITEM_TYPE:
				return getItemType();
		}
