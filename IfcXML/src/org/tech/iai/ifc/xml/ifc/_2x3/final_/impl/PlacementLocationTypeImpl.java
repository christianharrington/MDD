...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Placement Location Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PlacementLocationTypeImpl#getIfcVirtualGridIntersection <em>Ifc Virtual Grid Intersection</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PlacementLocationTypeImpl extends EObjectImpl implements PlacementLocationType {
	/**
	 ...
	 * @generated
	 */
	protected PlacementLocationTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPlacementLocationType();
	}
	...
	public NotificationChain basicSetIfcVirtualGridIntersection(IfcVirtualGridIntersection newIfcVirtualGridIntersection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PLACEMENT_LOCATION_TYPE__IFC_VIRTUAL_GRID_INTERSECTION, oldIfcVirtualGridIntersection, newIfcVirtualGridIntersection);
	...
	public void setIfcVirtualGridIntersection(IfcVirtualGridIntersection newIfcVirtualGridIntersection) {
		if (newIfcVirtualGridIntersection != ifcVirtualGridIntersection) {
			...
			if (ifcVirtualGridIntersection != null)
				msgs = ((InternalEObject)ifcVirtualGridIntersection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PLACEMENT_LOCATION_TYPE__IFC_VIRTUAL_GRID_INTERSECTION, null, msgs);
			if (newIfcVirtualGridIntersection != null)
				msgs = ((InternalEObject)newIfcVirtualGridIntersection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PLACEMENT_LOCATION_TYPE__IFC_VIRTUAL_GRID_INTERSECTION, null, msgs);
			msgs = basicSetIfcVirtualGridIntersection(newIfcVirtualGridIntersection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PLACEMENT_LOCATION_TYPE__IFC_VIRTUAL_GRID_INTERSECTION, newIfcVirtualGridIntersection, newIfcVirtualGridIntersection));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.PLACEMENT_LOCATION_TYPE__IFC_VIRTUAL_GRID_INTERSECTION:
