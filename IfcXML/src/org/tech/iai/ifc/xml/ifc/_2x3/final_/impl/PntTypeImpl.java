...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pnt Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PntTypeImpl#getIfcCartesianPoint <em>Ifc Cartesian Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PntTypeImpl extends EObjectImpl implements PntType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPntType();
	}
	...
	public NotificationChain basicSetIfcCartesianPoint(IfcCartesianPoint newIfcCartesianPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.PNT_TYPE__IFC_CARTESIAN_POINT, oldIfcCartesianPoint, newIfcCartesianPoint);
	...
	public void setIfcCartesianPoint(IfcCartesianPoint newIfcCartesianPoint) {
		if (newIfcCartesianPoint != ifcCartesianPoint) {
			...
			if (ifcCartesianPoint != null)
				msgs = ((InternalEObject)ifcCartesianPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PNT_TYPE__IFC_CARTESIAN_POINT, null, msgs);
			if (newIfcCartesianPoint != null)
				msgs = ((InternalEObject)newIfcCartesianPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.PNT_TYPE__IFC_CARTESIAN_POINT, null, msgs);
			msgs = basicSetIfcCartesianPoint(newIfcCartesianPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.PNT_TYPE__IFC_CARTESIAN_POINT, newIfcCartesianPoint, newIfcCartesianPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.PNT_TYPE__IFC_CARTESIAN_POINT:
