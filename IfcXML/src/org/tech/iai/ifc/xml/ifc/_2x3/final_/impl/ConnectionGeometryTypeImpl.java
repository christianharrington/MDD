...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Connection Geometry Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ConnectionGeometryTypeImpl#getIfcConnectionGeometryGroup <em>Ifc Connection Geometry Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ConnectionGeometryTypeImpl#getIfcConnectionGeometry <em>Ifc Connection Geometry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConnectionGeometryTypeImpl extends EObjectImpl implements ConnectionGeometryType {
	/**
	 ...
	 * @generated
	 */
	protected ConnectionGeometryTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getConnectionGeometryType();
	}
	...
	public FeatureMap getIfcConnectionGeometryGroup() {
		if (ifcConnectionGeometryGroup == null) {
			ifcConnectionGeometryGroup = new BasicFeatureMap(this, FinalPackage.CONNECTION_GEOMETRY_TYPE__IFC_CONNECTION_GEOMETRY_GROUP);
		}
	...
	public IfcConnectionGeometry getIfcConnectionGeometry() {
		return (IfcConnectionGeometry)getIfcConnectionGeometryGroup().get(FinalPackage.eINSTANCE.getConnectionGeometryType_IfcConnectionGeometry(), true);
	}
	...
	public NotificationChain basicSetIfcConnectionGeometry(IfcConnectionGeometry newIfcConnectionGeometry, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcConnectionGeometryGroup()).basicAdd(FinalPackage.eINSTANCE.getConnectionGeometryType_IfcConnectionGeometry(), newIfcConnectionGeometry, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.CONNECTION_GEOMETRY_TYPE__IFC_CONNECTION_GEOMETRY_GROUP:
				return ((InternalEList<?>)getIfcConnectionGeometryGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.CONNECTION_GEOMETRY_TYPE__IFC_CONNECTION_GEOMETRY:
