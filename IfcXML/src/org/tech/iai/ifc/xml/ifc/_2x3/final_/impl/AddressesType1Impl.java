...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Addresses Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesType1Impl#getIfcAddressGroup <em>Ifc Address Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesType1Impl#getIfcAddress <em>Ifc Address</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressesType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddressesType1Impl extends EObjectImpl implements AddressesType1 {
	/**
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcAddress");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getAddressesType1();
	}
	...
	public FeatureMap getIfcAddressGroup() {
		if (ifcAddressGroup == null) {
			ifcAddressGroup = new BasicFeatureMap(this, FinalPackage.ADDRESSES_TYPE1__IFC_ADDRESS_GROUP);
		}
	 ...
	 * @generated
	 */
	public EList<IfcAddress> getIfcAddress() {
		return getIfcAddressGroup().list(FinalPackage.eINSTANCE.getAddressesType1_IfcAddress());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESSES_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESSES_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESSES_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.ADDRESSES_TYPE1__IFC_ADDRESS_GROUP:
				return ((InternalEList<?>)getIfcAddressGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.ADDRESSES_TYPE1__IFC_ADDRESS:
				return ((InternalEList<?>)getIfcAddress()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.ADDRESSES_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.ADDRESSES_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.ADDRESSES_TYPE1__ITEM_TYPE:
				return getItemType();
		}
