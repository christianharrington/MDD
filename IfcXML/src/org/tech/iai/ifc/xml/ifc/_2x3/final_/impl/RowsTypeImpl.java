...
import org.tech.iai.ifc.xml.ifc._2x3.final_.RowsType;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RowsTypeImpl#getIfcTableRow <em>Ifc Table Row</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RowsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RowsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RowsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RowsTypeImpl extends EObjectImpl implements RowsType {
	/**
	 * The cached value of the '{@link #getIfcTableRow() <em>Ifc Table Row</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIfcTableRow()
	 * @generated
	 * @ordered
	 */
	protected EList<IfcTableRow> ifcTableRow;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcTableRow");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRowsType();
	}
	 ...
	 * @generated
	 */
	public EList<IfcTableRow> getIfcTableRow() {
		if (ifcTableRow == null) {
			ifcTableRow = new EObjectContainmentEList<IfcTableRow>(IfcTableRow.class, this, FinalPackage.ROWS_TYPE__IFC_TABLE_ROW);
		}
		return ifcTableRow;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROWS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROWS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ROWS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.ROWS_TYPE__IFC_TABLE_ROW:
				return ((InternalEList<?>)getIfcTableRow()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.ROWS_TYPE__IFC_TABLE_ROW:
				return getIfcTableRow();
			case FinalPackage.ROWS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.ROWS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.ROWS_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FinalPackage.ROWS_TYPE__IFC_TABLE_ROW:
				getIfcTableRow().clear();
				getIfcTableRow().addAll((Collection<? extends IfcTableRow>)newValue);
				return;
			case FinalPackage.ROWS_TYPE__ARRAY_SIZE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.ROWS_TYPE__IFC_TABLE_ROW:
				return ifcTableRow != null && !ifcTableRow.isEmpty();
			case FinalPackage.ROWS_TYPE__ARRAY_SIZE:
