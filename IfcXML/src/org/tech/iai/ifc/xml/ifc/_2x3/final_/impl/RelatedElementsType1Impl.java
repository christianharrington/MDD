...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Related Elements Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsType1Impl#getIfcProductGroup <em>Ifc Product Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsType1Impl#getIfcProduct <em>Ifc Product</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RelatedElementsType1Impl extends EObjectImpl implements RelatedElementsType1 {
	/**
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcProduct");
	 ...
	 * @generated
	 */
	protected RelatedElementsType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRelatedElementsType1();
	}
	...
	public FeatureMap getIfcProductGroup() {
		if (ifcProductGroup == null) {
			ifcProductGroup = new BasicFeatureMap(this, FinalPackage.RELATED_ELEMENTS_TYPE1__IFC_PRODUCT_GROUP);
		}
	 ...
	 * @generated
	 */
	public EList<IfcProduct> getIfcProduct() {
		return getIfcProductGroup().list(FinalPackage.eINSTANCE.getRelatedElementsType1_IfcProduct());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ELEMENTS_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ELEMENTS_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ELEMENTS_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.RELATED_ELEMENTS_TYPE1__IFC_PRODUCT_GROUP:
				return ((InternalEList<?>)getIfcProductGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.RELATED_ELEMENTS_TYPE1__IFC_PRODUCT:
				return ((InternalEList<?>)getIfcProduct()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.RELATED_ELEMENTS_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.RELATED_ELEMENTS_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.RELATED_ELEMENTS_TYPE1__ITEM_TYPE:
				return getItemType();
		}
