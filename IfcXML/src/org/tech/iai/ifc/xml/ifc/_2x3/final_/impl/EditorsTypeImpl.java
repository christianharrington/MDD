...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Editors Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EditorsTypeImpl#getIfcActorSelect <em>Ifc Actor Select</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EditorsTypeImpl#getIfcOrganization <em>Ifc Organization</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EditorsTypeImpl#getIfcPerson <em>Ifc Person</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EditorsTypeImpl#getIfcPersonAndOrganization <em>Ifc Person And Organization</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EditorsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EditorsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.EditorsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EditorsTypeImpl extends EObjectImpl implements EditorsType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getEditorsType();
	}
	...
	public FeatureMap getIfcActorSelect() {
		if (ifcActorSelect == null) {
			ifcActorSelect = new BasicFeatureMap(this, FinalPackage.EDITORS_TYPE__IFC_ACTOR_SELECT);
		}
	...
	public EList<IfcOrganization> getIfcOrganization() {
		return getIfcActorSelect().list(FinalPackage.eINSTANCE.getEditorsType_IfcOrganization());
	}
	...
	public EList<IfcPerson> getIfcPerson() {
		return getIfcActorSelect().list(FinalPackage.eINSTANCE.getEditorsType_IfcPerson());
	}
	...
	public EList<IfcPersonAndOrganization> getIfcPersonAndOrganization() {
		return getIfcActorSelect().list(FinalPackage.eINSTANCE.getEditorsType_IfcPersonAndOrganization());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.EDITORS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.EDITORS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.EDITORS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.EDITORS_TYPE__IFC_ACTOR_SELECT:
				return ((InternalEList<?>)getIfcActorSelect()).basicRemove(otherEnd, msgs);
			case FinalPackage.EDITORS_TYPE__IFC_ORGANIZATION:
				return ((InternalEList<?>)getIfcOrganization()).basicRemove(otherEnd, msgs);
			case FinalPackage.EDITORS_TYPE__IFC_PERSON:
				return ((InternalEList<?>)getIfcPerson()).basicRemove(otherEnd, msgs);
			case FinalPackage.EDITORS_TYPE__IFC_PERSON_AND_ORGANIZATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.EDITORS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.EDITORS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.EDITORS_TYPE__ITEM_TYPE:
				return getItemType();
		}
