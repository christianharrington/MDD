...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Related Elements Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsTypeImpl#getIfcProductGroup <em>Ifc Product Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsTypeImpl#getIfcProduct <em>Ifc Product</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedElementsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RelatedElementsTypeImpl extends EObjectImpl implements RelatedElementsType {
	/**
	 ...
	 * @generated
	 */
	protected RelatedElementsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRelatedElementsType();
	}
	...
	public FeatureMap getIfcProductGroup() {
		if (ifcProductGroup == null) {
			ifcProductGroup = new BasicFeatureMap(this, FinalPackage.RELATED_ELEMENTS_TYPE__IFC_PRODUCT_GROUP);
		}
	...
	public EList<IfcProduct> getIfcProduct() {
		return getIfcProductGroup().list(FinalPackage.eINSTANCE.getRelatedElementsType_IfcProduct());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ELEMENTS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ELEMENTS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_ELEMENTS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.RELATED_ELEMENTS_TYPE__IFC_PRODUCT_GROUP:
				return ((InternalEList<?>)getIfcProductGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.RELATED_ELEMENTS_TYPE__IFC_PRODUCT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.RELATED_ELEMENTS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.RELATED_ELEMENTS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.RELATED_ELEMENTS_TYPE__ITEM_TYPE:
				return getItemType();
		}
