...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcDefinedSymbolSelect;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcDefinedSymbolSelectImpl#getIfcPreDefinedSymbolGroup <em>Ifc Pre Defined Symbol Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcDefinedSymbolSelectImpl#getIfcPreDefinedSymbol <em>Ifc Pre Defined Symbol</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcDefinedSymbolSelectImpl#getIfcExternallyDefinedSymbol <em>Ifc Externally Defined Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcDefinedSymbolSelectImpl extends EObjectImpl implements IfcDefinedSymbolSelect {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcDefinedSymbolSelect();
	}
	...
	public FeatureMap getIfcPreDefinedSymbolGroup() {
		if (ifcPreDefinedSymbolGroup == null) {
			ifcPreDefinedSymbolGroup = new BasicFeatureMap(this, FinalPackage.IFC_DEFINED_SYMBOL_SELECT__IFC_PRE_DEFINED_SYMBOL_GROUP);
		}
	...
	public IfcPreDefinedSymbol getIfcPreDefinedSymbol() {
		return (IfcPreDefinedSymbol)getIfcPreDefinedSymbolGroup().get(FinalPackage.eINSTANCE.getIfcDefinedSymbolSelect_IfcPreDefinedSymbol(), true);
	}
	...
	public NotificationChain basicSetIfcPreDefinedSymbol(IfcPreDefinedSymbol newIfcPreDefinedSymbol, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcPreDefinedSymbolGroup()).basicAdd(FinalPackage.eINSTANCE.getIfcDefinedSymbolSelect_IfcPreDefinedSymbol(), newIfcPreDefinedSymbol, msgs);
	}
	...
	public NotificationChain basicSetIfcExternallyDefinedSymbol(IfcExternallyDefinedSymbol newIfcExternallyDefinedSymbol, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_DEFINED_SYMBOL_SELECT__IFC_EXTERNALLY_DEFINED_SYMBOL, oldIfcExternallyDefinedSymbol, newIfcExternallyDefinedSymbol);
	...
	public void setIfcExternallyDefinedSymbol(IfcExternallyDefinedSymbol newIfcExternallyDefinedSymbol) {
		if (newIfcExternallyDefinedSymbol != ifcExternallyDefinedSymbol) {
			...
			if (ifcExternallyDefinedSymbol != null)
				msgs = ((InternalEObject)ifcExternallyDefinedSymbol).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_DEFINED_SYMBOL_SELECT__IFC_EXTERNALLY_DEFINED_SYMBOL, null, msgs);
			if (newIfcExternallyDefinedSymbol != null)
				msgs = ((InternalEObject)newIfcExternallyDefinedSymbol).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_DEFINED_SYMBOL_SELECT__IFC_EXTERNALLY_DEFINED_SYMBOL, null, msgs);
			msgs = basicSetIfcExternallyDefinedSymbol(newIfcExternallyDefinedSymbol, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_DEFINED_SYMBOL_SELECT__IFC_EXTERNALLY_DEFINED_SYMBOL, newIfcExternallyDefinedSymbol, newIfcExternallyDefinedSymbol));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_DEFINED_SYMBOL_SELECT__IFC_PRE_DEFINED_SYMBOL_GROUP:
				return ((InternalEList<?>)getIfcPreDefinedSymbolGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.IFC_DEFINED_SYMBOL_SELECT__IFC_PRE_DEFINED_SYMBOL:
				return basicSetIfcPreDefinedSymbol(null, msgs);
			case FinalPackage.IFC_DEFINED_SYMBOL_SELECT__IFC_EXTERNALLY_DEFINED_SYMBOL:
