...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Middle Names Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MiddleNamesTypeImpl#getIfcLabel <em>Ifc Label</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MiddleNamesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MiddleNamesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MiddleNamesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MiddleNamesTypeImpl extends EObjectImpl implements MiddleNamesType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getMiddleNamesType();
	}
	...
	public EList<IfcLabelType> getIfcLabel() {
		if (ifcLabel == null) {
			ifcLabel = new EObjectContainmentEList<IfcLabelType>(IfcLabelType.class, this, FinalPackage.MIDDLE_NAMES_TYPE__IFC_LABEL);
		}
		return ifcLabel;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MIDDLE_NAMES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MIDDLE_NAMES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.MIDDLE_NAMES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.MIDDLE_NAMES_TYPE__IFC_LABEL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.MIDDLE_NAMES_TYPE__IFC_LABEL:
				return getIfcLabel();
			case FinalPackage.MIDDLE_NAMES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.MIDDLE_NAMES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.MIDDLE_NAMES_TYPE__ITEM_TYPE:
				return getItemType();
		}
