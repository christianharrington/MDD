...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcBooleanOperand;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcBooleanOperandImpl#getIfcSolidModelGroup <em>Ifc Solid Model Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcBooleanOperandImpl#getIfcSolidModel <em>Ifc Solid Model</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcBooleanOperandImpl#getIfcHalfSpaceSolidGroup <em>Ifc Half Space Solid Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcBooleanOperandImpl#getIfcHalfSpaceSolid <em>Ifc Half Space Solid</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcBooleanOperandImpl#getIfcBooleanResultGroup <em>Ifc Boolean Result Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcBooleanOperandImpl#getIfcBooleanResult <em>Ifc Boolean Result</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcBooleanOperandImpl#getIfcCsgPrimitive3DGroup <em>Ifc Csg Primitive3 DGroup</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcBooleanOperandImpl#getIfcCsgPrimitive3D <em>Ifc Csg Primitive3 D</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcBooleanOperandImpl extends EObjectImpl implements IfcBooleanOperand {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcBooleanOperand();
	}
	...
	public FeatureMap getIfcSolidModelGroup() {
		if (ifcSolidModelGroup == null) {
			ifcSolidModelGroup = new BasicFeatureMap(this, FinalPackage.IFC_BOOLEAN_OPERAND__IFC_SOLID_MODEL_GROUP);
		}
	...
	public IfcSolidModel getIfcSolidModel() {
		return (IfcSolidModel)getIfcSolidModelGroup().get(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcSolidModel(), true);
	}
	...
	public NotificationChain basicSetIfcSolidModel(IfcSolidModel newIfcSolidModel, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcSolidModelGroup()).basicAdd(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcSolidModel(), newIfcSolidModel, msgs);
	}
	...
	public FeatureMap getIfcHalfSpaceSolidGroup() {
		if (ifcHalfSpaceSolidGroup == null) {
			ifcHalfSpaceSolidGroup = new BasicFeatureMap(this, FinalPackage.IFC_BOOLEAN_OPERAND__IFC_HALF_SPACE_SOLID_GROUP);
		}
	...
	public IfcHalfSpaceSolid getIfcHalfSpaceSolid() {
		return (IfcHalfSpaceSolid)getIfcHalfSpaceSolidGroup().get(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcHalfSpaceSolid(), true);
	}
	...
	public NotificationChain basicSetIfcHalfSpaceSolid(IfcHalfSpaceSolid newIfcHalfSpaceSolid, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcHalfSpaceSolidGroup()).basicAdd(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcHalfSpaceSolid(), newIfcHalfSpaceSolid, msgs);
	}
	...
	public void setIfcHalfSpaceSolid(IfcHalfSpaceSolid newIfcHalfSpaceSolid) {
		((FeatureMap.Internal)getIfcHalfSpaceSolidGroup()).set(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcHalfSpaceSolid(), newIfcHalfSpaceSolid);
	}
	...
	public FeatureMap getIfcBooleanResultGroup() {
		if (ifcBooleanResultGroup == null) {
			ifcBooleanResultGroup = new BasicFeatureMap(this, FinalPackage.IFC_BOOLEAN_OPERAND__IFC_BOOLEAN_RESULT_GROUP);
		}
	...
	public IfcBooleanResult getIfcBooleanResult() {
		return (IfcBooleanResult)getIfcBooleanResultGroup().get(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcBooleanResult(), true);
	}
	...
	public NotificationChain basicSetIfcBooleanResult(IfcBooleanResult newIfcBooleanResult, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcBooleanResultGroup()).basicAdd(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcBooleanResult(), newIfcBooleanResult, msgs);
	}
	...
	public void setIfcBooleanResult(IfcBooleanResult newIfcBooleanResult) {
		((FeatureMap.Internal)getIfcBooleanResultGroup()).set(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcBooleanResult(), newIfcBooleanResult);
	}
	...
	public FeatureMap getIfcCsgPrimitive3DGroup() {
		if (ifcCsgPrimitive3DGroup == null) {
			ifcCsgPrimitive3DGroup = new BasicFeatureMap(this, FinalPackage.IFC_BOOLEAN_OPERAND__IFC_CSG_PRIMITIVE3_DGROUP);
		}
	...
	public IfcCsgPrimitive3D getIfcCsgPrimitive3D() {
		return (IfcCsgPrimitive3D)getIfcCsgPrimitive3DGroup().get(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcCsgPrimitive3D(), true);
	}
	...
	public NotificationChain basicSetIfcCsgPrimitive3D(IfcCsgPrimitive3D newIfcCsgPrimitive3D, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcCsgPrimitive3DGroup()).basicAdd(FinalPackage.eINSTANCE.getIfcBooleanOperand_IfcCsgPrimitive3D(), newIfcCsgPrimitive3D, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_BOOLEAN_OPERAND__IFC_SOLID_MODEL_GROUP:
				return ((InternalEList<?>)getIfcSolidModelGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.IFC_BOOLEAN_OPERAND__IFC_SOLID_MODEL:
				return basicSetIfcSolidModel(null, msgs);
			case FinalPackage.IFC_BOOLEAN_OPERAND__IFC_HALF_SPACE_SOLID_GROUP:
				return ((InternalEList<?>)getIfcHalfSpaceSolidGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.IFC_BOOLEAN_OPERAND__IFC_HALF_SPACE_SOLID:
				return basicSetIfcHalfSpaceSolid(null, msgs);
			case FinalPackage.IFC_BOOLEAN_OPERAND__IFC_BOOLEAN_RESULT_GROUP:
				return ((InternalEList<?>)getIfcBooleanResultGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.IFC_BOOLEAN_OPERAND__IFC_BOOLEAN_RESULT:
				return basicSetIfcBooleanResult(null, msgs);
			case FinalPackage.IFC_BOOLEAN_OPERAND__IFC_CSG_PRIMITIVE3_DGROUP:
				return ((InternalEList<?>)getIfcCsgPrimitive3DGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.IFC_BOOLEAN_OPERAND__IFC_CSG_PRIMITIVE3_D:
