...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Responsible Persons Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ResponsiblePersonsTypeImpl#getIfcPerson <em>Ifc Person</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ResponsiblePersonsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ResponsiblePersonsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ResponsiblePersonsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ResponsiblePersonsTypeImpl extends EObjectImpl implements ResponsiblePersonsType {
	/**
	 ...
	 * @generated
	 */
	protected ResponsiblePersonsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getResponsiblePersonsType();
	}
	...
	public EList<IfcPerson> getIfcPerson() {
		if (ifcPerson == null) {
			ifcPerson = new EObjectContainmentEList<IfcPerson>(IfcPerson.class, this, FinalPackage.RESPONSIBLE_PERSONS_TYPE__IFC_PERSON);
		}
		return ifcPerson;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RESPONSIBLE_PERSONS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RESPONSIBLE_PERSONS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RESPONSIBLE_PERSONS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.RESPONSIBLE_PERSONS_TYPE__IFC_PERSON:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.RESPONSIBLE_PERSONS_TYPE__IFC_PERSON:
				return getIfcPerson();
			case FinalPackage.RESPONSIBLE_PERSONS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.RESPONSIBLE_PERSONS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.RESPONSIBLE_PERSONS_TYPE__ITEM_TYPE:
				return getItemType();
		}
