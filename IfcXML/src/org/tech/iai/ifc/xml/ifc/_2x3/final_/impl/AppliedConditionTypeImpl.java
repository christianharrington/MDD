...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Applied Condition Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AppliedConditionTypeImpl#getIfcBoundaryConditionGroup <em>Ifc Boundary Condition Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AppliedConditionTypeImpl#getIfcBoundaryCondition <em>Ifc Boundary Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AppliedConditionTypeImpl extends EObjectImpl implements AppliedConditionType {
	/**
	 ...
	 * @generated
	 */
	protected AppliedConditionTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getAppliedConditionType();
	}
	...
	public FeatureMap getIfcBoundaryConditionGroup() {
		if (ifcBoundaryConditionGroup == null) {
			ifcBoundaryConditionGroup = new BasicFeatureMap(this, FinalPackage.APPLIED_CONDITION_TYPE__IFC_BOUNDARY_CONDITION_GROUP);
		}
	...
	public IfcBoundaryCondition getIfcBoundaryCondition() {
		return (IfcBoundaryCondition)getIfcBoundaryConditionGroup().get(FinalPackage.eINSTANCE.getAppliedConditionType_IfcBoundaryCondition(), true);
	}
	...
	public NotificationChain basicSetIfcBoundaryCondition(IfcBoundaryCondition newIfcBoundaryCondition, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcBoundaryConditionGroup()).basicAdd(FinalPackage.eINSTANCE.getAppliedConditionType_IfcBoundaryCondition(), newIfcBoundaryCondition, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.APPLIED_CONDITION_TYPE__IFC_BOUNDARY_CONDITION_GROUP:
				return ((InternalEList<?>)getIfcBoundaryConditionGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.APPLIED_CONDITION_TYPE__IFC_BOUNDARY_CONDITION:
