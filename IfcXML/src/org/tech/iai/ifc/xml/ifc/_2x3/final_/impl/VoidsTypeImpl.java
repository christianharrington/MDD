...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Voids Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.VoidsTypeImpl#getIfcClosedShell <em>Ifc Closed Shell</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.VoidsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.VoidsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.VoidsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VoidsTypeImpl extends EObjectImpl implements VoidsType {
	/**
	 * The cached value of the '{@link #getIfcClosedShell() <em>Ifc Closed Shell</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcClosedShell> ifcClosedShell;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcClosedShell");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getVoidsType();
	}
	...
	public EList<IfcClosedShell> getIfcClosedShell() {
		if (ifcClosedShell == null) {
			ifcClosedShell = new EObjectContainmentEList<IfcClosedShell>(IfcClosedShell.class, this, FinalPackage.VOIDS_TYPE__IFC_CLOSED_SHELL);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VOIDS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VOIDS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VOIDS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.VOIDS_TYPE__IFC_CLOSED_SHELL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.VOIDS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.VOIDS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.VOIDS_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.VOIDS_TYPE__IFC_CLOSED_SHELL:
				return ifcClosedShell != null && !ifcClosedShell.isEmpty();
			case FinalPackage.VOIDS_TYPE__ARRAY_SIZE:
