...
import org.tech.iai.ifc.xml.ifc._2x3.final_.AxisType;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AxisTypeImpl#getIfcAxis1Placement <em>Ifc Axis1 Placement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AxisTypeImpl extends EObjectImpl implements AxisType {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getAxisType();
	}
	...
	public NotificationChain basicSetIfcAxis1Placement(IfcAxis1Placement newIfcAxis1Placement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.AXIS_TYPE__IFC_AXIS1_PLACEMENT, oldIfcAxis1Placement, newIfcAxis1Placement);
	...
	public void setIfcAxis1Placement(IfcAxis1Placement newIfcAxis1Placement) {
		if (newIfcAxis1Placement != ifcAxis1Placement) {
			...
			if (ifcAxis1Placement != null)
				msgs = ((InternalEObject)ifcAxis1Placement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.AXIS_TYPE__IFC_AXIS1_PLACEMENT, null, msgs);
			if (newIfcAxis1Placement != null)
				msgs = ((InternalEObject)newIfcAxis1Placement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.AXIS_TYPE__IFC_AXIS1_PLACEMENT, null, msgs);
			msgs = basicSetIfcAxis1Placement(newIfcAxis1Placement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.AXIS_TYPE__IFC_AXIS1_PLACEMENT, newIfcAxis1Placement, newIfcAxis1Placement));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.AXIS_TYPE__IFC_AXIS1_PLACEMENT:
