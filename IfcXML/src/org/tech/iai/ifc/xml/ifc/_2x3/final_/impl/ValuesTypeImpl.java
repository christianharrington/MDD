 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ValuesTypeImpl#getIfcTimeSeriesValue <em>Ifc Time Series Value</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ValuesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ValuesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ValuesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValuesTypeImpl extends EObjectImpl implements ValuesType {
	/**
	 * The cached value of the '{@link #getIfcTimeSeriesValue() <em>Ifc Time Series Value</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcTimeSeriesValue> ifcTimeSeriesValue;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcTimeSeriesValue");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getValuesType();
	}
	 ...
	 * @generated
	 */
	public EList<IfcTimeSeriesValue> getIfcTimeSeriesValue() {
		if (ifcTimeSeriesValue == null) {
			ifcTimeSeriesValue = new EObjectContainmentEList<IfcTimeSeriesValue>(IfcTimeSeriesValue.class, this, FinalPackage.VALUES_TYPE__IFC_TIME_SERIES_VALUE);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VALUES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VALUES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.VALUES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.VALUES_TYPE__IFC_TIME_SERIES_VALUE:
				return ((InternalEList<?>)getIfcTimeSeriesValue()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.VALUES_TYPE__IFC_TIME_SERIES_VALUE:
				return getIfcTimeSeriesValue();
			case FinalPackage.VALUES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.VALUES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.VALUES_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FinalPackage.VALUES_TYPE__IFC_TIME_SERIES_VALUE:
				getIfcTimeSeriesValue().clear();
				getIfcTimeSeriesValue().addAll((Collection<? extends IfcTimeSeriesValue>)newValue);
				return;
			case FinalPackage.VALUES_TYPE__ARRAY_SIZE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.VALUES_TYPE__IFC_TIME_SERIES_VALUE:
				return ifcTimeSeriesValue != null && !ifcTimeSeriesValue.isEmpty();
			case FinalPackage.VALUES_TYPE__ARRAY_SIZE:
