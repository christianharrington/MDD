...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcRailingType;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcRailingTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcRailingTypeImpl extends IfcBuildingElementTypeImpl implements IfcRailingType {
	 ...
	 * @ordered
	 */
	protected static final IfcRailingTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcRailingTypeEnum.HANDRAIL;
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcRailingType();
	}
	...
	public void setPredefinedType(IfcRailingTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_RAILING_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_RAILING_TYPE__PREDEFINED_TYPE:
