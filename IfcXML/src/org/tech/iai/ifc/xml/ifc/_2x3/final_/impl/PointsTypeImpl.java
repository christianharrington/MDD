...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Points Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PointsTypeImpl#getIfcCartesianPoint <em>Ifc Cartesian Point</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PointsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PointsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PointsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PointsTypeImpl extends EObjectImpl implements PointsType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPointsType();
	}
	...
	public EList<IfcCartesianPoint> getIfcCartesianPoint() {
		if (ifcCartesianPoint == null) {
			ifcCartesianPoint = new EObjectContainmentEList<IfcCartesianPoint>(IfcCartesianPoint.class, this, FinalPackage.POINTS_TYPE__IFC_CARTESIAN_POINT);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.POINTS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.POINTS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.POINTS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.POINTS_TYPE__IFC_CARTESIAN_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.POINTS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.POINTS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.POINTS_TYPE__ITEM_TYPE:
				return getItemType();
		}
