...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcCableCarrierSegmentType;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcCableCarrierSegmentTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcCableCarrierSegmentTypeImpl extends IfcFlowSegmentTypeImpl implements IfcCableCarrierSegmentType {
	 ...
	 * @ordered
	 */
	protected static final IfcCableCarrierSegmentTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcCableCarrierSegmentTypeEnum.CABLELADDERSEGMENT;
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcCableCarrierSegmentType();
	}
	...
	public void setPredefinedType(IfcCableCarrierSegmentTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_CABLE_CARRIER_SEGMENT_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_CABLE_CARRIER_SEGMENT_TYPE__PREDEFINED_TYPE:
