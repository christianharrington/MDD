...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Corner Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.CornerTypeImpl#getIfcCartesianPoint <em>Ifc Cartesian Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CornerTypeImpl extends EObjectImpl implements CornerType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getCornerType();
	}
	...
	public NotificationChain basicSetIfcCartesianPoint(IfcCartesianPoint newIfcCartesianPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.CORNER_TYPE__IFC_CARTESIAN_POINT, oldIfcCartesianPoint, newIfcCartesianPoint);
	...
	public void setIfcCartesianPoint(IfcCartesianPoint newIfcCartesianPoint) {
		if (newIfcCartesianPoint != ifcCartesianPoint) {
			...
			if (ifcCartesianPoint != null)
				msgs = ((InternalEObject)ifcCartesianPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.CORNER_TYPE__IFC_CARTESIAN_POINT, null, msgs);
			if (newIfcCartesianPoint != null)
				msgs = ((InternalEObject)newIfcCartesianPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.CORNER_TYPE__IFC_CARTESIAN_POINT, null, msgs);
			msgs = basicSetIfcCartesianPoint(newIfcCartesianPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.CORNER_TYPE__IFC_CARTESIAN_POINT, newIfcCartesianPoint, newIfcCartesianPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.CORNER_TYPE__IFC_CARTESIAN_POINT:
