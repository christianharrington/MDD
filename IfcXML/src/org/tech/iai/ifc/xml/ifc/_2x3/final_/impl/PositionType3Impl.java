...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Position Type3</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.PositionType3Impl#getIfcAxis2Placement3D <em>Ifc Axis2 Placement3 D</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PositionType3Impl extends EObjectImpl implements PositionType3 {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getPositionType3();
	}
	...
	public NotificationChain basicSetIfcAxis2Placement3D(IfcAxis2Placement3D newIfcAxis2Placement3D, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.POSITION_TYPE3__IFC_AXIS2_PLACEMENT3_D, oldIfcAxis2Placement3D, newIfcAxis2Placement3D);
	...
	public void setIfcAxis2Placement3D(IfcAxis2Placement3D newIfcAxis2Placement3D) {
		if (newIfcAxis2Placement3D != ifcAxis2Placement3D) {
			...
			if (ifcAxis2Placement3D != null)
				msgs = ((InternalEObject)ifcAxis2Placement3D).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.POSITION_TYPE3__IFC_AXIS2_PLACEMENT3_D, null, msgs);
			if (newIfcAxis2Placement3D != null)
				msgs = ((InternalEObject)newIfcAxis2Placement3D).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.POSITION_TYPE3__IFC_AXIS2_PLACEMENT3_D, null, msgs);
			msgs = basicSetIfcAxis2Placement3D(newIfcAxis2Placement3D, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.POSITION_TYPE3__IFC_AXIS2_PLACEMENT3_D, newIfcAxis2Placement3D, newIfcAxis2Placement3D));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.POSITION_TYPE3__IFC_AXIS2_PLACEMENT3_D:
