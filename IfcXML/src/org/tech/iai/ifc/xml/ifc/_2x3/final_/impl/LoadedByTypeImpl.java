...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Loaded By Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LoadedByTypeImpl#getIfcStructuralLoadGroup <em>Ifc Structural Load Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LoadedByTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LoadedByTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LoadedByTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LoadedByTypeImpl extends EObjectImpl implements LoadedByType {
	/**
	 * The cached value of the '{@link #getIfcStructuralLoadGroup() <em>Ifc Structural Load Group</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcStructuralLoadGroup> ifcStructuralLoadGroup;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcStructuralLoadGroup");
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getLoadedByType();
	}
	 ...
	 * @generated
	 */
	public EList<IfcStructuralLoadGroup> getIfcStructuralLoadGroup() {
		if (ifcStructuralLoadGroup == null) {
			ifcStructuralLoadGroup = new EObjectContainmentEList<IfcStructuralLoadGroup>(IfcStructuralLoadGroup.class, this, FinalPackage.LOADED_BY_TYPE__IFC_STRUCTURAL_LOAD_GROUP);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.LOADED_BY_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.LOADED_BY_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.LOADED_BY_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.LOADED_BY_TYPE__IFC_STRUCTURAL_LOAD_GROUP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.LOADED_BY_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.LOADED_BY_TYPE__CTYPE:
				return getCType();
			case FinalPackage.LOADED_BY_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FinalPackage.LOADED_BY_TYPE__IFC_STRUCTURAL_LOAD_GROUP:
				...
				getIfcStructuralLoadGroup().addAll((Collection<? extends IfcStructuralLoadGroup>)newValue);
				return;
			case FinalPackage.LOADED_BY_TYPE__ARRAY_SIZE:
