...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcStructuralPlanarAction;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcStructuralPlanarActionImpl#getProjectedOrTrue <em>Projected Or True</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcStructuralPlanarActionImpl extends IfcStructuralActionImpl implements IfcStructuralPlanarAction {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcStructuralPlanarAction();
	}
	...
	public void setProjectedOrTrue(IfcProjectedOrTrueLengthEnum newProjectedOrTrue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_STRUCTURAL_PLANAR_ACTION__PROJECTED_OR_TRUE, oldProjectedOrTrue, projectedOrTrue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_STRUCTURAL_PLANAR_ACTION__PROJECTED_OR_TRUE:
