 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.OrientationTypeImpl#getIfcDirection <em>Ifc Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrientationTypeImpl extends EObjectImpl implements OrientationType {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getOrientationType();
	}
	...
	public NotificationChain basicSetIfcDirection(IfcDirection newIfcDirection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.ORIENTATION_TYPE__IFC_DIRECTION, oldIfcDirection, newIfcDirection);
	...
	public void setIfcDirection(IfcDirection newIfcDirection) {
		if (newIfcDirection != ifcDirection) {
			...
			if (ifcDirection != null)
				msgs = ((InternalEObject)ifcDirection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.ORIENTATION_TYPE__IFC_DIRECTION, null, msgs);
			if (newIfcDirection != null)
				msgs = ((InternalEObject)newIfcDirection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.ORIENTATION_TYPE__IFC_DIRECTION, null, msgs);
			msgs = basicSetIfcDirection(newIfcDirection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ORIENTATION_TYPE__IFC_DIRECTION, newIfcDirection, newIfcDirection));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.ORIENTATION_TYPE__IFC_DIRECTION:
