...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Light Distribution Data Source Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LightDistributionDataSourceTypeImpl#getIfcExternalReferenceGroup <em>Ifc External Reference Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LightDistributionDataSourceTypeImpl#getIfcExternalReference <em>Ifc External Reference</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LightDistributionDataSourceTypeImpl#getIfcLightIntensityDistribution <em>Ifc Light Intensity Distribution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LightDistributionDataSourceTypeImpl extends EObjectImpl implements LightDistributionDataSourceType {
	/**
	 ...
	 * @generated
	 */
	protected LightDistributionDataSourceTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getLightDistributionDataSourceType();
	}
	...
	public FeatureMap getIfcExternalReferenceGroup() {
		if (ifcExternalReferenceGroup == null) {
			ifcExternalReferenceGroup = new BasicFeatureMap(this, FinalPackage.LIGHT_DISTRIBUTION_DATA_SOURCE_TYPE__IFC_EXTERNAL_REFERENCE_GROUP);
		}
	...
	public IfcExternalReference getIfcExternalReference() {
		return (IfcExternalReference)getIfcExternalReferenceGroup().get(FinalPackage.eINSTANCE.getLightDistributionDataSourceType_IfcExternalReference(), true);
	}
	...
	public NotificationChain basicSetIfcExternalReference(IfcExternalReference newIfcExternalReference, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcExternalReferenceGroup()).basicAdd(FinalPackage.eINSTANCE.getLightDistributionDataSourceType_IfcExternalReference(), newIfcExternalReference, msgs);
	}
	...
	public NotificationChain basicSetIfcLightIntensityDistribution(IfcLightIntensityDistribution newIfcLightIntensityDistribution, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.LIGHT_DISTRIBUTION_DATA_SOURCE_TYPE__IFC_LIGHT_INTENSITY_DISTRIBUTION, oldIfcLightIntensityDistribution, newIfcLightIntensityDistribution);
	...
	public void setIfcLightIntensityDistribution(IfcLightIntensityDistribution newIfcLightIntensityDistribution) {
		if (newIfcLightIntensityDistribution != ifcLightIntensityDistribution) {
			...
			if (ifcLightIntensityDistribution != null)
				msgs = ((InternalEObject)ifcLightIntensityDistribution).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.LIGHT_DISTRIBUTION_DATA_SOURCE_TYPE__IFC_LIGHT_INTENSITY_DISTRIBUTION, null, msgs);
			if (newIfcLightIntensityDistribution != null)
				msgs = ((InternalEObject)newIfcLightIntensityDistribution).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.LIGHT_DISTRIBUTION_DATA_SOURCE_TYPE__IFC_LIGHT_INTENSITY_DISTRIBUTION, null, msgs);
			msgs = basicSetIfcLightIntensityDistribution(newIfcLightIntensityDistribution, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.LIGHT_DISTRIBUTION_DATA_SOURCE_TYPE__IFC_LIGHT_INTENSITY_DISTRIBUTION, newIfcLightIntensityDistribution, newIfcLightIntensityDistribution));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.LIGHT_DISTRIBUTION_DATA_SOURCE_TYPE__IFC_EXTERNAL_REFERENCE_GROUP:
				return ((InternalEList<?>)getIfcExternalReferenceGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.LIGHT_DISTRIBUTION_DATA_SOURCE_TYPE__IFC_EXTERNAL_REFERENCE:
				return basicSetIfcExternalReference(null, msgs);
			case FinalPackage.LIGHT_DISTRIBUTION_DATA_SOURCE_TYPE__IFC_LIGHT_INTENSITY_DISTRIBUTION:
...
} //LightDistributionDataSourceTypeImpl
