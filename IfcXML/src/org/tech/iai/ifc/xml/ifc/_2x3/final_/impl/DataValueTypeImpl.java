...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Value Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcCalendarDate <em>Ifc Calendar Date</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcLocalTime <em>Ifc Local Time</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcDateAndTime <em>Ifc Date And Time</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcMeasureWithUnit <em>Ifc Measure With Unit</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcTable <em>Ifc Table</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcText <em>Ifc Text</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcTimeSeriesGroup <em>Ifc Time Series Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcTimeSeries <em>Ifc Time Series</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.DataValueTypeImpl#getIfcCostValue <em>Ifc Cost Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DataValueTypeImpl extends EObjectImpl implements DataValueType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getDataValueType();
	}
	...
	public NotificationChain basicSetIfcCalendarDate(IfcCalendarDate newIfcCalendarDate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_CALENDAR_DATE, oldIfcCalendarDate, newIfcCalendarDate);
	...
	public void setIfcCalendarDate(IfcCalendarDate newIfcCalendarDate) {
		if (newIfcCalendarDate != ifcCalendarDate) {
			...
			if (ifcCalendarDate != null)
				msgs = ((InternalEObject)ifcCalendarDate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_CALENDAR_DATE, null, msgs);
			if (newIfcCalendarDate != null)
				msgs = ((InternalEObject)newIfcCalendarDate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_CALENDAR_DATE, null, msgs);
			msgs = basicSetIfcCalendarDate(newIfcCalendarDate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_CALENDAR_DATE, newIfcCalendarDate, newIfcCalendarDate));
	}
	...
	public NotificationChain basicSetIfcLocalTime(IfcLocalTime newIfcLocalTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_LOCAL_TIME, oldIfcLocalTime, newIfcLocalTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcLocalTime(IfcLocalTime newIfcLocalTime) {
		if (newIfcLocalTime != ifcLocalTime) {
			...
			if (ifcLocalTime != null)
				msgs = ((InternalEObject)ifcLocalTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_LOCAL_TIME, null, msgs);
			if (newIfcLocalTime != null)
				msgs = ((InternalEObject)newIfcLocalTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_LOCAL_TIME, null, msgs);
			msgs = basicSetIfcLocalTime(newIfcLocalTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_LOCAL_TIME, newIfcLocalTime, newIfcLocalTime));
	}
	...
	public NotificationChain basicSetIfcDateAndTime(IfcDateAndTime newIfcDateAndTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_DATE_AND_TIME, oldIfcDateAndTime, newIfcDateAndTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcDateAndTime(IfcDateAndTime newIfcDateAndTime) {
		if (newIfcDateAndTime != ifcDateAndTime) {
			...
			if (ifcDateAndTime != null)
				msgs = ((InternalEObject)ifcDateAndTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_DATE_AND_TIME, null, msgs);
			if (newIfcDateAndTime != null)
				msgs = ((InternalEObject)newIfcDateAndTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_DATE_AND_TIME, null, msgs);
			msgs = basicSetIfcDateAndTime(newIfcDateAndTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_DATE_AND_TIME, newIfcDateAndTime, newIfcDateAndTime));
	}
	...
	public NotificationChain basicSetIfcMeasureWithUnit(IfcMeasureWithUnit newIfcMeasureWithUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_MEASURE_WITH_UNIT, oldIfcMeasureWithUnit, newIfcMeasureWithUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMeasureWithUnit(IfcMeasureWithUnit newIfcMeasureWithUnit) {
		if (newIfcMeasureWithUnit != ifcMeasureWithUnit) {
			...
			if (ifcMeasureWithUnit != null)
				msgs = ((InternalEObject)ifcMeasureWithUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_MEASURE_WITH_UNIT, null, msgs);
			if (newIfcMeasureWithUnit != null)
				msgs = ((InternalEObject)newIfcMeasureWithUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_MEASURE_WITH_UNIT, null, msgs);
			msgs = basicSetIfcMeasureWithUnit(newIfcMeasureWithUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_MEASURE_WITH_UNIT, newIfcMeasureWithUnit, newIfcMeasureWithUnit));
	}
	...
	public NotificationChain basicSetIfcTable(IfcTable newIfcTable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_TABLE, oldIfcTable, newIfcTable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcTable(IfcTable newIfcTable) {
		if (newIfcTable != ifcTable) {
			NotificationChain msgs = null;
			if (ifcTable != null)
				msgs = ((InternalEObject)ifcTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_TABLE, null, msgs);
			if (newIfcTable != null)
				msgs = ((InternalEObject)newIfcTable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_TABLE, null, msgs);
			msgs = basicSetIfcTable(newIfcTable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_TABLE, newIfcTable, newIfcTable));
	}
	...
	public NotificationChain basicSetIfcText(IfcTextType newIfcText, NotificationChain msgs) {
		...
		ifcText = newIfcText;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_TEXT, oldIfcText, newIfcText);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcText(IfcTextType newIfcText) {
		if (newIfcText != ifcText) {
			NotificationChain msgs = null;
			if (ifcText != null)
				msgs = ((InternalEObject)ifcText).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_TEXT, null, msgs);
			if (newIfcText != null)
				msgs = ((InternalEObject)newIfcText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_TEXT, null, msgs);
			msgs = basicSetIfcText(newIfcText, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_TEXT, newIfcText, newIfcText));
	}
	...
	public FeatureMap getIfcTimeSeriesGroup() {
		if (ifcTimeSeriesGroup == null) {
			ifcTimeSeriesGroup = new BasicFeatureMap(this, FinalPackage.DATA_VALUE_TYPE__IFC_TIME_SERIES_GROUP);
		}
	...
	public IfcTimeSeries getIfcTimeSeries() {
		return (IfcTimeSeries)getIfcTimeSeriesGroup().get(FinalPackage.eINSTANCE.getDataValueType_IfcTimeSeries(), true);
	}
	...
	public NotificationChain basicSetIfcTimeSeries(IfcTimeSeries newIfcTimeSeries, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcTimeSeriesGroup()).basicAdd(FinalPackage.eINSTANCE.getDataValueType_IfcTimeSeries(), newIfcTimeSeries, msgs);
	}
	...
	public NotificationChain basicSetIfcCostValue(IfcCostValue newIfcCostValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_COST_VALUE, oldIfcCostValue, newIfcCostValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcCostValue(IfcCostValue newIfcCostValue) {
		if (newIfcCostValue != ifcCostValue) {
			...
			if (ifcCostValue != null)
				msgs = ((InternalEObject)ifcCostValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_COST_VALUE, null, msgs);
			if (newIfcCostValue != null)
				msgs = ((InternalEObject)newIfcCostValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.DATA_VALUE_TYPE__IFC_COST_VALUE, null, msgs);
			msgs = basicSetIfcCostValue(newIfcCostValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.DATA_VALUE_TYPE__IFC_COST_VALUE, newIfcCostValue, newIfcCostValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.DATA_VALUE_TYPE__IFC_CALENDAR_DATE:
				return basicSetIfcCalendarDate(null, msgs);
			case FinalPackage.DATA_VALUE_TYPE__IFC_LOCAL_TIME:
				return basicSetIfcLocalTime(null, msgs);
			case FinalPackage.DATA_VALUE_TYPE__IFC_DATE_AND_TIME:
				return basicSetIfcDateAndTime(null, msgs);
			case FinalPackage.DATA_VALUE_TYPE__IFC_MEASURE_WITH_UNIT:
				return basicSetIfcMeasureWithUnit(null, msgs);
			case FinalPackage.DATA_VALUE_TYPE__IFC_TABLE:
				return basicSetIfcTable(null, msgs);
			case FinalPackage.DATA_VALUE_TYPE__IFC_TEXT:
				return basicSetIfcText(null, msgs);
			case FinalPackage.DATA_VALUE_TYPE__IFC_TIME_SERIES_GROUP:
				return ((InternalEList<?>)getIfcTimeSeriesGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.DATA_VALUE_TYPE__IFC_TIME_SERIES:
				return basicSetIfcTimeSeries(null, msgs);
			case FinalPackage.DATA_VALUE_TYPE__IFC_COST_VALUE:
