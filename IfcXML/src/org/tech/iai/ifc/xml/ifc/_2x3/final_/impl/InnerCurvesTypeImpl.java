...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Inner Curves Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.InnerCurvesTypeImpl#getIfcCurveGroup <em>Ifc Curve Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.InnerCurvesTypeImpl#getIfcCurve <em>Ifc Curve</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.InnerCurvesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.InnerCurvesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.InnerCurvesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InnerCurvesTypeImpl extends EObjectImpl implements InnerCurvesType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getInnerCurvesType();
	}
	...
	public FeatureMap getIfcCurveGroup() {
		if (ifcCurveGroup == null) {
			ifcCurveGroup = new BasicFeatureMap(this, FinalPackage.INNER_CURVES_TYPE__IFC_CURVE_GROUP);
		}
	...
	public EList<IfcCurve> getIfcCurve() {
		return getIfcCurveGroup().list(FinalPackage.eINSTANCE.getInnerCurvesType_IfcCurve());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.INNER_CURVES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.INNER_CURVES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.INNER_CURVES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.INNER_CURVES_TYPE__IFC_CURVE_GROUP:
				return ((InternalEList<?>)getIfcCurveGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.INNER_CURVES_TYPE__IFC_CURVE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.INNER_CURVES_TYPE__IFC_CURVE:
				return getIfcCurve();
			case FinalPackage.INNER_CURVES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.INNER_CURVES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.INNER_CURVES_TYPE__ITEM_TYPE:
				return getItemType();
		}
