...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Move To Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MoveToTypeImpl#getIfcSpatialStructureElementGroup <em>Ifc Spatial Structure Element Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.MoveToTypeImpl#getIfcSpatialStructureElement <em>Ifc Spatial Structure Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MoveToTypeImpl extends EObjectImpl implements MoveToType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getMoveToType();
	}
	...
	public FeatureMap getIfcSpatialStructureElementGroup() {
		if (ifcSpatialStructureElementGroup == null) {
			ifcSpatialStructureElementGroup = new BasicFeatureMap(this, FinalPackage.MOVE_TO_TYPE__IFC_SPATIAL_STRUCTURE_ELEMENT_GROUP);
		}
	...
	public IfcSpatialStructureElement getIfcSpatialStructureElement() {
		return (IfcSpatialStructureElement)getIfcSpatialStructureElementGroup().get(FinalPackage.eINSTANCE.getMoveToType_IfcSpatialStructureElement(), true);
	}
	...
	public NotificationChain basicSetIfcSpatialStructureElement(IfcSpatialStructureElement newIfcSpatialStructureElement, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcSpatialStructureElementGroup()).basicAdd(FinalPackage.eINSTANCE.getMoveToType_IfcSpatialStructureElement(), newIfcSpatialStructureElement, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.MOVE_TO_TYPE__IFC_SPATIAL_STRUCTURE_ELEMENT_GROUP:
				return ((InternalEList<?>)getIfcSpatialStructureElementGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.MOVE_TO_TYPE__IFC_SPATIAL_STRUCTURE_ELEMENT:
