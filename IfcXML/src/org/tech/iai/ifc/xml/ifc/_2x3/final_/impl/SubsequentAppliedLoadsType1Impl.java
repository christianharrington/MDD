...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Subsequent Applied Loads Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsType1Impl#getIfcStructuralLoadGroup <em>Ifc Structural Load Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsType1Impl#getIfcStructuralLoad <em>Ifc Structural Load</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SubsequentAppliedLoadsType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubsequentAppliedLoadsType1Impl extends EObjectImpl implements SubsequentAppliedLoadsType1 {
	/**
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcStructuralLoad");
	 ...
	 * @generated
	 */
	protected SubsequentAppliedLoadsType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getSubsequentAppliedLoadsType1();
	}
	...
	public FeatureMap getIfcStructuralLoadGroup() {
		if (ifcStructuralLoadGroup == null) {
			ifcStructuralLoadGroup = new BasicFeatureMap(this, FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__IFC_STRUCTURAL_LOAD_GROUP);
		}
	 ...
	 * @generated
	 */
	public EList<IfcStructuralLoad> getIfcStructuralLoad() {
		return getIfcStructuralLoadGroup().list(FinalPackage.eINSTANCE.getSubsequentAppliedLoadsType1_IfcStructuralLoad());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__IFC_STRUCTURAL_LOAD_GROUP:
				return ((InternalEList<?>)getIfcStructuralLoadGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__IFC_STRUCTURAL_LOAD:
				return ((InternalEList<?>)getIfcStructuralLoad()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__IFC_STRUCTURAL_LOAD:
				return !getIfcStructuralLoad().isEmpty();
			case FinalPackage.SUBSEQUENT_APPLIED_LOADS_TYPE1__ARRAY_SIZE:
...
} //SubsequentAppliedLoadsType1Impl
