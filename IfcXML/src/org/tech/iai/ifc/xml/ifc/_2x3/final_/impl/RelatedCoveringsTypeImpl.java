...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Related Coverings Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedCoveringsTypeImpl#getIfcCovering <em>Ifc Covering</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedCoveringsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedCoveringsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.RelatedCoveringsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RelatedCoveringsTypeImpl extends EObjectImpl implements RelatedCoveringsType {
	/**
	 ...
	 * @generated
	 */
	protected RelatedCoveringsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getRelatedCoveringsType();
	}
	...
	public EList<IfcCovering> getIfcCovering() {
		if (ifcCovering == null) {
			ifcCovering = new EObjectContainmentEList<IfcCovering>(IfcCovering.class, this, FinalPackage.RELATED_COVERINGS_TYPE__IFC_COVERING);
		}
		return ifcCovering;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_COVERINGS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_COVERINGS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.RELATED_COVERINGS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.RELATED_COVERINGS_TYPE__IFC_COVERING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.RELATED_COVERINGS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.RELATED_COVERINGS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.RELATED_COVERINGS_TYPE__ITEM_TYPE:
				return getItemType();
		}
