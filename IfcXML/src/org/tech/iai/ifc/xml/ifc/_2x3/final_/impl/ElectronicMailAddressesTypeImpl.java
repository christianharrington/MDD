...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Electronic Mail Addresses Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ElectronicMailAddressesTypeImpl#getIfcLabel <em>Ifc Label</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ElectronicMailAddressesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ElectronicMailAddressesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ElectronicMailAddressesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ElectronicMailAddressesTypeImpl extends EObjectImpl implements ElectronicMailAddressesType {
	/**
	 * The cached value of the '{@link #getIfcLabel() <em>Ifc Label</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIfcLabel()
	 * @generated
	 * @ordered
	 */
	protected EList<IfcLabelType> ifcLabel;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcLabel");
	 ...
	 * @generated
	 */
	protected ElectronicMailAddressesTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getElectronicMailAddressesType();
	}
	...
	public EList<IfcLabelType> getIfcLabel() {
		if (ifcLabel == null) {
			ifcLabel = new EObjectContainmentEList<IfcLabelType>(IfcLabelType.class, this, FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__IFC_LABEL);
		}
		return ifcLabel;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__IFC_LABEL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__IFC_LABEL:
				return getIfcLabel();
			case FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__IFC_LABEL:
				return ifcLabel != null && !ifcLabel.isEmpty();
			case FinalPackage.ELECTRONIC_MAIL_ADDRESSES_TYPE__ARRAY_SIZE:
...
} //ElectronicMailAddressesTypeImpl
