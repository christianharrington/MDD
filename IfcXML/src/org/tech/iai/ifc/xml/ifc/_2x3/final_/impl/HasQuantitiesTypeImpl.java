...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Has Quantities Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasQuantitiesTypeImpl#getIfcPhysicalQuantityGroup <em>Ifc Physical Quantity Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasQuantitiesTypeImpl#getIfcPhysicalQuantity <em>Ifc Physical Quantity</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasQuantitiesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasQuantitiesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasQuantitiesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HasQuantitiesTypeImpl extends EObjectImpl implements HasQuantitiesType {
	/**
	 ...
	 * @generated
	 */
	protected HasQuantitiesTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getHasQuantitiesType();
	}
	...
	public FeatureMap getIfcPhysicalQuantityGroup() {
		if (ifcPhysicalQuantityGroup == null) {
			ifcPhysicalQuantityGroup = new BasicFeatureMap(this, FinalPackage.HAS_QUANTITIES_TYPE__IFC_PHYSICAL_QUANTITY_GROUP);
		}
	...
	public EList<IfcPhysicalQuantity> getIfcPhysicalQuantity() {
		return getIfcPhysicalQuantityGroup().list(FinalPackage.eINSTANCE.getHasQuantitiesType_IfcPhysicalQuantity());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_QUANTITIES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_QUANTITIES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_QUANTITIES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.HAS_QUANTITIES_TYPE__IFC_PHYSICAL_QUANTITY_GROUP:
				return ((InternalEList<?>)getIfcPhysicalQuantityGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.HAS_QUANTITIES_TYPE__IFC_PHYSICAL_QUANTITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.HAS_QUANTITIES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.HAS_QUANTITIES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.HAS_QUANTITIES_TYPE__ITEM_TYPE:
				return getItemType();
		}
