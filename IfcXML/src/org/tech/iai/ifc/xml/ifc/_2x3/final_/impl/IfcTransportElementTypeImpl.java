...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcTransportElementType;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcTransportElementTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcTransportElementTypeImpl extends IfcElementTypeImpl implements IfcTransportElementType {
	 ...
	 * @ordered
	 */
	protected static final IfcTransportElementTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcTransportElementTypeEnum.ELEVATOR;
	 ...
	 * @ordered
	 */
	protected IfcTransportElementTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcTransportElementType();
	}
	...
	public void setPredefinedType(IfcTransportElementTypeEnum newPredefinedType) {
		IfcTransportElementTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FinalPackage.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcTransportElementTypeEnum)newValue);
				return;
		}
