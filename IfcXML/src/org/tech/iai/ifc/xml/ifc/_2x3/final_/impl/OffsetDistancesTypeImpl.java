...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Offset Distances Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.OffsetDistancesTypeImpl#getIfcLengthMeasure <em>Ifc Length Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.OffsetDistancesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.OffsetDistancesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.OffsetDistancesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OffsetDistancesTypeImpl extends EObjectImpl implements OffsetDistancesType {
	/**
	 * The cached value of the '{@link #getIfcLengthMeasure() <em>Ifc Length Measure</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcLengthMeasureType> ifcLengthMeasure;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcLengthMeasure");
	 ...
	 * @generated
	 */
	protected OffsetDistancesTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getOffsetDistancesType();
	}
	...
	public EList<IfcLengthMeasureType> getIfcLengthMeasure() {
		if (ifcLengthMeasure == null) {
			ifcLengthMeasure = new EObjectContainmentEList<IfcLengthMeasureType>(IfcLengthMeasureType.class, this, FinalPackage.OFFSET_DISTANCES_TYPE__IFC_LENGTH_MEASURE);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.OFFSET_DISTANCES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.OFFSET_DISTANCES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.OFFSET_DISTANCES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.OFFSET_DISTANCES_TYPE__IFC_LENGTH_MEASURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.OFFSET_DISTANCES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.OFFSET_DISTANCES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.OFFSET_DISTANCES_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.OFFSET_DISTANCES_TYPE__IFC_LENGTH_MEASURE:
				return ifcLengthMeasure != null && !ifcLengthMeasure.isEmpty();
			case FinalPackage.OFFSET_DISTANCES_TYPE__ARRAY_SIZE:
