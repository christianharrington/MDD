...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Surface On Related Element Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SurfaceOnRelatedElementTypeImpl#getIfcSurfaceGroup <em>Ifc Surface Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SurfaceOnRelatedElementTypeImpl#getIfcSurface <em>Ifc Surface</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SurfaceOnRelatedElementTypeImpl#getIfcFaceSurface <em>Ifc Face Surface</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.SurfaceOnRelatedElementTypeImpl#getIfcFaceBasedSurfaceModel <em>Ifc Face Based Surface Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SurfaceOnRelatedElementTypeImpl extends EObjectImpl implements SurfaceOnRelatedElementType {
	/**
	 ...
	 * @generated
	 */
	protected SurfaceOnRelatedElementTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getSurfaceOnRelatedElementType();
	}
	...
	public FeatureMap getIfcSurfaceGroup() {
		if (ifcSurfaceGroup == null) {
			ifcSurfaceGroup = new BasicFeatureMap(this, FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_SURFACE_GROUP);
		}
	...
	public IfcSurface getIfcSurface() {
		return (IfcSurface)getIfcSurfaceGroup().get(FinalPackage.eINSTANCE.getSurfaceOnRelatedElementType_IfcSurface(), true);
	}
	...
	public NotificationChain basicSetIfcSurface(IfcSurface newIfcSurface, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcSurfaceGroup()).basicAdd(FinalPackage.eINSTANCE.getSurfaceOnRelatedElementType_IfcSurface(), newIfcSurface, msgs);
	}
	...
	public NotificationChain basicSetIfcFaceSurface(IfcFaceSurface newIfcFaceSurface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_SURFACE, oldIfcFaceSurface, newIfcFaceSurface);
	...
	public void setIfcFaceSurface(IfcFaceSurface newIfcFaceSurface) {
		if (newIfcFaceSurface != ifcFaceSurface) {
			...
			if (ifcFaceSurface != null)
				msgs = ((InternalEObject)ifcFaceSurface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_SURFACE, null, msgs);
			if (newIfcFaceSurface != null)
				msgs = ((InternalEObject)newIfcFaceSurface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_SURFACE, null, msgs);
			msgs = basicSetIfcFaceSurface(newIfcFaceSurface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_SURFACE, newIfcFaceSurface, newIfcFaceSurface));
	}
	...
	public NotificationChain basicSetIfcFaceBasedSurfaceModel(IfcFaceBasedSurfaceModel newIfcFaceBasedSurfaceModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_BASED_SURFACE_MODEL, oldIfcFaceBasedSurfaceModel, newIfcFaceBasedSurfaceModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcFaceBasedSurfaceModel(IfcFaceBasedSurfaceModel newIfcFaceBasedSurfaceModel) {
		if (newIfcFaceBasedSurfaceModel != ifcFaceBasedSurfaceModel) {
			...
			if (ifcFaceBasedSurfaceModel != null)
				msgs = ((InternalEObject)ifcFaceBasedSurfaceModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_BASED_SURFACE_MODEL, null, msgs);
			if (newIfcFaceBasedSurfaceModel != null)
				msgs = ((InternalEObject)newIfcFaceBasedSurfaceModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_BASED_SURFACE_MODEL, null, msgs);
			msgs = basicSetIfcFaceBasedSurfaceModel(newIfcFaceBasedSurfaceModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_BASED_SURFACE_MODEL, newIfcFaceBasedSurfaceModel, newIfcFaceBasedSurfaceModel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_SURFACE_GROUP:
				return ((InternalEList<?>)getIfcSurfaceGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_SURFACE:
				return basicSetIfcSurface(null, msgs);
			case FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_SURFACE:
				return basicSetIfcFaceSurface(null, msgs);
			case FinalPackage.SURFACE_ON_RELATED_ELEMENT_TYPE__IFC_FACE_BASED_SURFACE_MODEL:
...
} //SurfaceOnRelatedElementTypeImpl
