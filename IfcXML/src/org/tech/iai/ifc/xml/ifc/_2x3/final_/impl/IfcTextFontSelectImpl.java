...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcTextFontSelect;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcTextFontSelectImpl#getIfcPreDefinedTextFontGroup <em>Ifc Pre Defined Text Font Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcTextFontSelectImpl#getIfcPreDefinedTextFont <em>Ifc Pre Defined Text Font</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcTextFontSelectImpl#getIfcExternallyDefinedTextFont <em>Ifc Externally Defined Text Font</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcTextFontSelectImpl extends EObjectImpl implements IfcTextFontSelect {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcTextFontSelect();
	}
	...
	public FeatureMap getIfcPreDefinedTextFontGroup() {
		if (ifcPreDefinedTextFontGroup == null) {
			ifcPreDefinedTextFontGroup = new BasicFeatureMap(this, FinalPackage.IFC_TEXT_FONT_SELECT__IFC_PRE_DEFINED_TEXT_FONT_GROUP);
		}
	...
	public IfcPreDefinedTextFont getIfcPreDefinedTextFont() {
		return (IfcPreDefinedTextFont)getIfcPreDefinedTextFontGroup().get(FinalPackage.eINSTANCE.getIfcTextFontSelect_IfcPreDefinedTextFont(), true);
	}
	...
	public NotificationChain basicSetIfcPreDefinedTextFont(IfcPreDefinedTextFont newIfcPreDefinedTextFont, NotificationChain msgs) {
		return ((FeatureMap.Internal)getIfcPreDefinedTextFontGroup()).basicAdd(FinalPackage.eINSTANCE.getIfcTextFontSelect_IfcPreDefinedTextFont(), newIfcPreDefinedTextFont, msgs);
	}
	...
	public NotificationChain basicSetIfcExternallyDefinedTextFont(IfcExternallyDefinedTextFont newIfcExternallyDefinedTextFont, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_TEXT_FONT_SELECT__IFC_EXTERNALLY_DEFINED_TEXT_FONT, oldIfcExternallyDefinedTextFont, newIfcExternallyDefinedTextFont);
	...
	public void setIfcExternallyDefinedTextFont(IfcExternallyDefinedTextFont newIfcExternallyDefinedTextFont) {
		if (newIfcExternallyDefinedTextFont != ifcExternallyDefinedTextFont) {
			...
			if (ifcExternallyDefinedTextFont != null)
				msgs = ((InternalEObject)ifcExternallyDefinedTextFont).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_TEXT_FONT_SELECT__IFC_EXTERNALLY_DEFINED_TEXT_FONT, null, msgs);
			if (newIfcExternallyDefinedTextFont != null)
				msgs = ((InternalEObject)newIfcExternallyDefinedTextFont).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_TEXT_FONT_SELECT__IFC_EXTERNALLY_DEFINED_TEXT_FONT, null, msgs);
			msgs = basicSetIfcExternallyDefinedTextFont(newIfcExternallyDefinedTextFont, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_TEXT_FONT_SELECT__IFC_EXTERNALLY_DEFINED_TEXT_FONT, newIfcExternallyDefinedTextFont, newIfcExternallyDefinedTextFont));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_TEXT_FONT_SELECT__IFC_PRE_DEFINED_TEXT_FONT_GROUP:
				return ((InternalEList<?>)getIfcPreDefinedTextFontGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.IFC_TEXT_FONT_SELECT__IFC_PRE_DEFINED_TEXT_FONT:
				return basicSetIfcPreDefinedTextFont(null, msgs);
			case FinalPackage.IFC_TEXT_FONT_SELECT__IFC_EXTERNALLY_DEFINED_TEXT_FONT:
