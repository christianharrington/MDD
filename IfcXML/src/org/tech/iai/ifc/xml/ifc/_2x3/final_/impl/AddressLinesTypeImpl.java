 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressLinesTypeImpl#getIfcLabel <em>Ifc Label</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressLinesTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressLinesTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.AddressLinesTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressLinesTypeImpl extends EObjectImpl implements AddressLinesType {
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getAddressLinesType();
	}
	...
	public EList<IfcLabelType> getIfcLabel() {
		if (ifcLabel == null) {
			ifcLabel = new EObjectContainmentEList<IfcLabelType>(IfcLabelType.class, this, FinalPackage.ADDRESS_LINES_TYPE__IFC_LABEL);
		}
		return ifcLabel;
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESS_LINES_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESS_LINES_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.ADDRESS_LINES_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.ADDRESS_LINES_TYPE__IFC_LABEL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.ADDRESS_LINES_TYPE__IFC_LABEL:
				return getIfcLabel();
			case FinalPackage.ADDRESS_LINES_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.ADDRESS_LINES_TYPE__CTYPE:
				return getCType();
			case FinalPackage.ADDRESS_LINES_TYPE__ITEM_TYPE:
				return getItemType();
		}
