...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcRoof;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcRoofImpl#getShapeType <em>Shape Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcRoofImpl extends IfcBuildingElementImpl implements IfcRoof {
	 ...
	 * @ordered
	 */
	protected static final IfcRoofTypeEnum SHAPE_TYPE_EDEFAULT = IfcRoofTypeEnum.FLAT_ROOF;
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcRoof();
	}
	...
	public void setShapeType(IfcRoofTypeEnum newShapeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_ROOF__SHAPE_TYPE, oldShapeType, shapeType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_ROOF__SHAPE_TYPE:
				return getShapeType();
		}
