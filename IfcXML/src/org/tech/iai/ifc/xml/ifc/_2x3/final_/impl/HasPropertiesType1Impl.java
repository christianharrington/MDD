...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Has Properties Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesType1Impl#getIfcPropertyGroup <em>Ifc Property Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesType1Impl#getIfcProperty <em>Ifc Property</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesType1Impl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesType1Impl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertiesType1Impl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HasPropertiesType1Impl extends EObjectImpl implements HasPropertiesType1 {
	/**
	 ...
	 * @generated
	 */
	protected HasPropertiesType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getHasPropertiesType1();
	}
	...
	public FeatureMap getIfcPropertyGroup() {
		if (ifcPropertyGroup == null) {
			ifcPropertyGroup = new BasicFeatureMap(this, FinalPackage.HAS_PROPERTIES_TYPE1__IFC_PROPERTY_GROUP);
		}
	...
	public EList<IfcProperty> getIfcProperty() {
		return getIfcPropertyGroup().list(FinalPackage.eINSTANCE.getHasPropertiesType1_IfcProperty());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTIES_TYPE1__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTIES_TYPE1__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTIES_TYPE1__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.HAS_PROPERTIES_TYPE1__IFC_PROPERTY_GROUP:
				return ((InternalEList<?>)getIfcPropertyGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.HAS_PROPERTIES_TYPE1__IFC_PROPERTY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.HAS_PROPERTIES_TYPE1__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.HAS_PROPERTIES_TYPE1__CTYPE:
				return getCType();
			case FinalPackage.HAS_PROPERTIES_TYPE1__ITEM_TYPE:
				return getItemType();
		}
