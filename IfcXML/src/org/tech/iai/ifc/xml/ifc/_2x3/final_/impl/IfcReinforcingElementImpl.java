...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcReinforcingElement;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcReinforcingElementImpl#getSteelGrade <em>Steel Grade</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class IfcReinforcingElementImpl extends IfcBuildingElementComponentImpl implements IfcReinforcingElement {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcReinforcingElement();
	}
	...
	public void setSteelGrade(String newSteelGrade) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_REINFORCING_ELEMENT__STEEL_GRADE, oldSteelGrade, steelGrade));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FinalPackage.IFC_REINFORCING_ELEMENT__STEEL_GRADE:
