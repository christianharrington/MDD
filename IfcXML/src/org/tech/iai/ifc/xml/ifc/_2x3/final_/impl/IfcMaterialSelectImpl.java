...
import org.tech.iai.ifc.xml.ifc._2x3.final_.IfcMaterialSelect;
 ...
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcMaterialSelectImpl#getIfcMaterial <em>Ifc Material</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcMaterialSelectImpl#getIfcMaterialList <em>Ifc Material List</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcMaterialSelectImpl#getIfcMaterialLayerSetUsage <em>Ifc Material Layer Set Usage</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcMaterialSelectImpl#getIfcMaterialLayerSet <em>Ifc Material Layer Set</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.IfcMaterialSelectImpl#getIfcMaterialLayer <em>Ifc Material Layer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcMaterialSelectImpl extends EObjectImpl implements IfcMaterialSelect {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getIfcMaterialSelect();
	}
	...
	public NotificationChain basicSetIfcMaterial(IfcMaterial newIfcMaterial, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL, oldIfcMaterial, newIfcMaterial);
	...
	public void setIfcMaterial(IfcMaterial newIfcMaterial) {
		if (newIfcMaterial != ifcMaterial) {
			...
			if (ifcMaterial != null)
				msgs = ((InternalEObject)ifcMaterial).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL, null, msgs);
			if (newIfcMaterial != null)
				msgs = ((InternalEObject)newIfcMaterial).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL, null, msgs);
			msgs = basicSetIfcMaterial(newIfcMaterial, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL, newIfcMaterial, newIfcMaterial));
	}
	...
	public NotificationChain basicSetIfcMaterialList(IfcMaterialList newIfcMaterialList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LIST, oldIfcMaterialList, newIfcMaterialList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMaterialList(IfcMaterialList newIfcMaterialList) {
		if (newIfcMaterialList != ifcMaterialList) {
			...
			if (ifcMaterialList != null)
				msgs = ((InternalEObject)ifcMaterialList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LIST, null, msgs);
			if (newIfcMaterialList != null)
				msgs = ((InternalEObject)newIfcMaterialList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LIST, null, msgs);
			msgs = basicSetIfcMaterialList(newIfcMaterialList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LIST, newIfcMaterialList, newIfcMaterialList));
	}
	...
	public NotificationChain basicSetIfcMaterialLayerSetUsage(IfcMaterialLayerSetUsage newIfcMaterialLayerSetUsage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET_USAGE, oldIfcMaterialLayerSetUsage, newIfcMaterialLayerSetUsage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMaterialLayerSetUsage(IfcMaterialLayerSetUsage newIfcMaterialLayerSetUsage) {
		if (newIfcMaterialLayerSetUsage != ifcMaterialLayerSetUsage) {
			...
			if (ifcMaterialLayerSetUsage != null)
				msgs = ((InternalEObject)ifcMaterialLayerSetUsage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET_USAGE, null, msgs);
			if (newIfcMaterialLayerSetUsage != null)
				msgs = ((InternalEObject)newIfcMaterialLayerSetUsage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET_USAGE, null, msgs);
			msgs = basicSetIfcMaterialLayerSetUsage(newIfcMaterialLayerSetUsage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET_USAGE, newIfcMaterialLayerSetUsage, newIfcMaterialLayerSetUsage));
	}
	...
	public NotificationChain basicSetIfcMaterialLayerSet(IfcMaterialLayerSet newIfcMaterialLayerSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET, oldIfcMaterialLayerSet, newIfcMaterialLayerSet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMaterialLayerSet(IfcMaterialLayerSet newIfcMaterialLayerSet) {
		if (newIfcMaterialLayerSet != ifcMaterialLayerSet) {
			...
			if (ifcMaterialLayerSet != null)
				msgs = ((InternalEObject)ifcMaterialLayerSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET, null, msgs);
			if (newIfcMaterialLayerSet != null)
				msgs = ((InternalEObject)newIfcMaterialLayerSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET, null, msgs);
			msgs = basicSetIfcMaterialLayerSet(newIfcMaterialLayerSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET, newIfcMaterialLayerSet, newIfcMaterialLayerSet));
	}
	...
	public NotificationChain basicSetIfcMaterialLayer(IfcMaterialLayer newIfcMaterialLayer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER, oldIfcMaterialLayer, newIfcMaterialLayer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcMaterialLayer(IfcMaterialLayer newIfcMaterialLayer) {
		if (newIfcMaterialLayer != ifcMaterialLayer) {
			...
			if (ifcMaterialLayer != null)
				msgs = ((InternalEObject)ifcMaterialLayer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER, null, msgs);
			if (newIfcMaterialLayer != null)
				msgs = ((InternalEObject)newIfcMaterialLayer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER, null, msgs);
			msgs = basicSetIfcMaterialLayer(newIfcMaterialLayer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER, newIfcMaterialLayer, newIfcMaterialLayer));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL:
				return basicSetIfcMaterial(null, msgs);
			case FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LIST:
				return basicSetIfcMaterialList(null, msgs);
			case FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET_USAGE:
				return basicSetIfcMaterialLayerSetUsage(null, msgs);
			case FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER_SET:
				return basicSetIfcMaterialLayerSet(null, msgs);
			case FinalPackage.IFC_MATERIAL_SELECT__IFC_MATERIAL_LAYER:
