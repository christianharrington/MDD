...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Has Property Sets Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertySetsTypeImpl#getIfcPropertySetDefinitionGroup <em>Ifc Property Set Definition Group</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertySetsTypeImpl#getIfcPropertySetDefinition <em>Ifc Property Set Definition</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertySetsTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertySetsTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.HasPropertySetsTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HasPropertySetsTypeImpl extends EObjectImpl implements HasPropertySetsType {
	/**
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcPropertySetDefinition");
	 ...
	 * @generated
	 */
	protected HasPropertySetsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getHasPropertySetsType();
	}
	...
	public FeatureMap getIfcPropertySetDefinitionGroup() {
		if (ifcPropertySetDefinitionGroup == null) {
			ifcPropertySetDefinitionGroup = new BasicFeatureMap(this, FinalPackage.HAS_PROPERTY_SETS_TYPE__IFC_PROPERTY_SET_DEFINITION_GROUP);
		}
	 ...
	 * @generated
	 */
	public EList<IfcPropertySetDefinition> getIfcPropertySetDefinition() {
		return getIfcPropertySetDefinitionGroup().list(FinalPackage.eINSTANCE.getHasPropertySetsType_IfcPropertySetDefinition());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTY_SETS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTY_SETS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.HAS_PROPERTY_SETS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.HAS_PROPERTY_SETS_TYPE__IFC_PROPERTY_SET_DEFINITION_GROUP:
				return ((InternalEList<?>)getIfcPropertySetDefinitionGroup()).basicRemove(otherEnd, msgs);
			case FinalPackage.HAS_PROPERTY_SETS_TYPE__IFC_PROPERTY_SET_DEFINITION:
				return ((InternalEList<?>)getIfcPropertySetDefinition()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.HAS_PROPERTY_SETS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.HAS_PROPERTY_SETS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.HAS_PROPERTY_SETS_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FinalPackage.HAS_PROPERTY_SETS_TYPE__IFC_PROPERTY_SET_DEFINITION:
				return !getIfcPropertySetDefinition().isEmpty();
			case FinalPackage.HAS_PROPERTY_SETS_TYPE__ARRAY_SIZE:
