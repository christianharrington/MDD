...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Luminous Intensity Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LuminousIntensityTypeImpl#getIfcLuminousIntensityDistributionMeasure <em>Ifc Luminous Intensity Distribution Measure</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LuminousIntensityTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LuminousIntensityTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.LuminousIntensityTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LuminousIntensityTypeImpl extends EObjectImpl implements LuminousIntensityType {
	/**
	 * The cached value of the '{@link #getIfcLuminousIntensityDistributionMeasure() <em>Ifc Luminous Intensity Distribution Measure</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<IfcLuminousIntensityDistributionMeasureType> ifcLuminousIntensityDistributionMeasure;
	 ...
	 * @ordered
	 */
	protected static final QName ITEM_TYPE_EDEFAULT = (QName)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.eINSTANCE.getQName(), "ifc:IfcLuminousIntensityDistributionMeasure");
	 ...
	 * @generated
	 */
	protected LuminousIntensityTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getLuminousIntensityType();
	}
	...
	public EList<IfcLuminousIntensityDistributionMeasureType> getIfcLuminousIntensityDistributionMeasure() {
		if (ifcLuminousIntensityDistributionMeasure == null) {
			ifcLuminousIntensityDistributionMeasure = new EObjectContainmentEList<IfcLuminousIntensityDistributionMeasureType>(IfcLuminousIntensityDistributionMeasureType.class, this, FinalPackage.LUMINOUS_INTENSITY_TYPE__IFC_LUMINOUS_INTENSITY_DISTRIBUTION_MEASURE);
		}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.LUMINOUS_INTENSITY_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.LUMINOUS_INTENSITY_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.LUMINOUS_INTENSITY_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.LUMINOUS_INTENSITY_TYPE__IFC_LUMINOUS_INTENSITY_DISTRIBUTION_MEASURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.LUMINOUS_INTENSITY_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.LUMINOUS_INTENSITY_TYPE__CTYPE:
				return getCType();
			case FinalPackage.LUMINOUS_INTENSITY_TYPE__ITEM_TYPE:
				return getItemType();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case FinalPackage.LUMINOUS_INTENSITY_TYPE__IFC_LUMINOUS_INTENSITY_DISTRIBUTION_MEASURE:
				return ifcLuminousIntensityDistributionMeasure != null && !ifcLuminousIntensityDistributionMeasure.isEmpty();
			case FinalPackage.LUMINOUS_INTENSITY_TYPE__ARRAY_SIZE:
