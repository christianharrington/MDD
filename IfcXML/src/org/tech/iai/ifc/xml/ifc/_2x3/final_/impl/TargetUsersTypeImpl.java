...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Target Users Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetUsersTypeImpl#getIfcActorSelect <em>Ifc Actor Select</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetUsersTypeImpl#getIfcOrganization <em>Ifc Organization</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetUsersTypeImpl#getIfcPerson <em>Ifc Person</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetUsersTypeImpl#getIfcPersonAndOrganization <em>Ifc Person And Organization</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetUsersTypeImpl#getArraySize <em>Array Size</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetUsersTypeImpl#getCType <em>CType</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.TargetUsersTypeImpl#getItemType <em>Item Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TargetUsersTypeImpl extends EObjectImpl implements TargetUsersType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getTargetUsersType();
	}
	...
	public FeatureMap getIfcActorSelect() {
		if (ifcActorSelect == null) {
			ifcActorSelect = new BasicFeatureMap(this, FinalPackage.TARGET_USERS_TYPE__IFC_ACTOR_SELECT);
		}
	...
	public EList<IfcOrganization> getIfcOrganization() {
		return getIfcActorSelect().list(FinalPackage.eINSTANCE.getTargetUsersType_IfcOrganization());
	}
	...
	public EList<IfcPerson> getIfcPerson() {
		return getIfcActorSelect().list(FinalPackage.eINSTANCE.getTargetUsersType_IfcPerson());
	}
	...
	public EList<IfcPersonAndOrganization> getIfcPersonAndOrganization() {
		return getIfcActorSelect().list(FinalPackage.eINSTANCE.getTargetUsersType_IfcPersonAndOrganization());
	}
	...
	public void setArraySize(List<BigInteger> newArraySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TARGET_USERS_TYPE__ARRAY_SIZE, oldArraySize, arraySize));
	}
	...
	public void setCType(List<AggregateType> newCType) {
		...
		cType = newCType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TARGET_USERS_TYPE__CTYPE, oldCType, cType));
	}
	...
	public void setItemType(QName newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.TARGET_USERS_TYPE__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.TARGET_USERS_TYPE__IFC_ACTOR_SELECT:
				return ((InternalEList<?>)getIfcActorSelect()).basicRemove(otherEnd, msgs);
			case FinalPackage.TARGET_USERS_TYPE__IFC_ORGANIZATION:
				return ((InternalEList<?>)getIfcOrganization()).basicRemove(otherEnd, msgs);
			case FinalPackage.TARGET_USERS_TYPE__IFC_PERSON:
				return ((InternalEList<?>)getIfcPerson()).basicRemove(otherEnd, msgs);
			case FinalPackage.TARGET_USERS_TYPE__IFC_PERSON_AND_ORGANIZATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FinalPackage.TARGET_USERS_TYPE__ARRAY_SIZE:
				return getArraySize();
			case FinalPackage.TARGET_USERS_TYPE__CTYPE:
				return getCType();
			case FinalPackage.TARGET_USERS_TYPE__ITEM_TYPE:
				return getItemType();
		}
