...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Referenced Document Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReferencedDocumentTypeImpl#getIfcDocumentReference <em>Ifc Document Reference</em>}</li>
 *   <li>{@link org.tech.iai.ifc.xml.ifc._2x3.final_.impl.ReferencedDocumentTypeImpl#getIfcDocumentInformation <em>Ifc Document Information</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReferencedDocumentTypeImpl extends EObjectImpl implements ReferencedDocumentType {
	/**
	...
	protected EClass eStaticClass() {
		return FinalPackage.eINSTANCE.getReferencedDocumentType();
	}
	...
	public NotificationChain basicSetIfcDocumentReference(IfcDocumentReference newIfcDocumentReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_REFERENCE, oldIfcDocumentReference, newIfcDocumentReference);
	...
	public void setIfcDocumentReference(IfcDocumentReference newIfcDocumentReference) {
		if (newIfcDocumentReference != ifcDocumentReference) {
			...
			if (ifcDocumentReference != null)
				msgs = ((InternalEObject)ifcDocumentReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_REFERENCE, null, msgs);
			if (newIfcDocumentReference != null)
				msgs = ((InternalEObject)newIfcDocumentReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_REFERENCE, null, msgs);
			msgs = basicSetIfcDocumentReference(newIfcDocumentReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_REFERENCE, newIfcDocumentReference, newIfcDocumentReference));
	}
	...
	public NotificationChain basicSetIfcDocumentInformation(IfcDocumentInformation newIfcDocumentInformation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_INFORMATION, oldIfcDocumentInformation, newIfcDocumentInformation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfcDocumentInformation(IfcDocumentInformation newIfcDocumentInformation) {
		if (newIfcDocumentInformation != ifcDocumentInformation) {
			...
			if (ifcDocumentInformation != null)
				msgs = ((InternalEObject)ifcDocumentInformation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_INFORMATION, null, msgs);
			if (newIfcDocumentInformation != null)
				msgs = ((InternalEObject)newIfcDocumentInformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_INFORMATION, null, msgs);
			msgs = basicSetIfcDocumentInformation(newIfcDocumentInformation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_INFORMATION, newIfcDocumentInformation, newIfcDocumentInformation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_REFERENCE:
				return basicSetIfcDocumentReference(null, msgs);
			case FinalPackage.REFERENCED_DOCUMENT_TYPE__IFC_DOCUMENT_INFORMATION:
