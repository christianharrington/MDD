 ...
 * <ul>
 *   <li>{@link log.impl.LogActionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link log.impl.LogActionImpl#getExecutor <em>Executor</em>}</li>
 *   <li>{@link log.impl.LogActionImpl#getAccessMethod <em>Access Method</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
