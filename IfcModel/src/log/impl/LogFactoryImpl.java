...
public class LogFactoryImpl extends EFactoryImpl implements LogFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case LogPackage.LOG_ACTION: return createLogAction();
			case LogPackage.SERVER_LOG: return createServerLog();
			case LogPackage.NEW_USER_ADDED: return createNewUserAdded();
			case LogPackage.NEW_PROJECT_ADDED: return createNewProjectAdded();
			case LogPackage.REVISION_BRANCHED: return createRevisionBranched();
			case LogPackage.NEW_REVISION_ADDED: return createNewRevisionAdded();
			case LogPackage.NEW_CHECKOUT_ADDED: return createNewCheckoutAdded();
			case LogPackage.SETTINGS_SAVED: return createSettingsSaved();
			case LogPackage.USER_ADDED_TO_PROJECT: return createUserAddedToProject();
			case LogPackage.NEW_OBJECT_IDM_UPLOADED: return createNewObjectIDMUploaded();
			case LogPackage.DOWNLOAD: return createDownload();
			case LogPackage.USER_REMOVED_FROM_PROJECT: return createUserRemovedFromProject();
			case LogPackage.PROJECT_DELETED: return createProjectDeleted();
			case LogPackage.USER_DELETED: return createUserDeleted();
			case LogPackage.PASSWORD_RESET: return createPasswordReset();
			case LogPackage.DATABASE_CREATED: return createDatabaseCreated();
			case LogPackage.SERVER_STARTED: return createServerStarted();
			case LogPackage.PROJECT_UPDATED: return createProjectUpdated();
			case LogPackage.USER_UNDELETED: return createUserUndeleted();
			case LogPackage.PROJECT_UNDELETED: return createProjectUndeleted();
			case LogPackage.REVISION_UPDATED: return createRevisionUpdated();
			case LogPackage.GEO_TAG_UPDATED: return createGeoTagUpdated();
			case LogPackage.PASSWORD_CHANGED: return createPasswordChanged();
			case LogPackage.USER_CHANGED: return createUserChanged();
			case LogPackage.EXTENDED_DATA_ADDED_TO_REVISION: return createExtendedDataAddedToRevision();
			case LogPackage.EXTENDED_DATA_ADDED_TO_PROJECT: return createExtendedDataAddedToProject();
			case LogPackage.EXTERNAL_SERVICE_CALLED: return createExternalServiceCalled();
			default:
