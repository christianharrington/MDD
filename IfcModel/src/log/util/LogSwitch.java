	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case LogPackage.REVISION_BRANCHED: {
				...
				if (result == null) result = caseLogAction(revisionBranched);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LogPackage.NEW_OBJECT_IDM_UPLOADED: {
				...
				if (result == null) result = caseLogAction(newObjectIDMUploaded);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LogPackage.EXTENDED_DATA_ADDED_TO_REVISION: {
				...
				if (result == null) result = caseLogAction(extendedDataAddedToRevision);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LogPackage.EXTENDED_DATA_ADDED_TO_PROJECT: {
				...
				if (result == null) result = caseLogAction(extendedDataAddedToProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LogPackage.EXTERNAL_SERVICE_CALLED: {
				...
				if (result == null) result = caseLogAction(externalServiceCalled);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
