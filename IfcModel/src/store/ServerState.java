...
public enum ServerState implements Enumerator {
	...
	public static ServerState get(int value) {
		switch (value) {
			...
			case NOT_SETUP_VALUE: return NOT_SETUP;
			case MIGRATION_REQUIRED_VALUE: return MIGRATION_REQUIRED;
			case MIGRATION_IMPOSSIBLE_VALUE: return MIGRATION_IMPOSSIBLE;
