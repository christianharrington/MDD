...
public class PrimitiveDefinitionImpl extends TypeDefinitionImpl implements PrimitiveDefinition {
	 ...
	 * @ordered
	 */
	protected static final PrimitiveEnum TYPE_EDEFAULT = PrimitiveEnum.LONG;
	 ...
	 * @ordered
	 */
	protected PrimitiveEnum type = TYPE_EDEFAULT;
	...
	public void setType(PrimitiveEnum newType) {
		PrimitiveEnum oldType = type;
		type = newType == null ? TYPE_EDEFAULT : newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StorePackage.PRIMITIVE_DEFINITION__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StorePackage.PRIMITIVE_DEFINITION__TYPE:
				return getType();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StorePackage.PRIMITIVE_DEFINITION__TYPE:
				setType((PrimitiveEnum)newValue);
				return;
		}
