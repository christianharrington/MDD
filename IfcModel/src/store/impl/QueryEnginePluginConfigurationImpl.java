...
public class QueryEnginePluginConfigurationImpl extends PluginConfigurationImpl implements QueryEnginePluginConfiguration {
		...
		if (userSettings != null && userSettings.eIsProxy()) {
			...
			if (userSettings != oldUserSettings) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StorePackage.QUERY_ENGINE_PLUGIN_CONFIGURATION__USER_SETTINGS, oldUserSettings, userSettings));
			}
		}
		return userSettings;
	}
	...
	public NotificationChain basicSetUserSettings(UserSettings newUserSettings, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StorePackage.QUERY_ENGINE_PLUGIN_CONFIGURATION__USER_SETTINGS, oldUserSettings, newUserSettings);
	...
	public void setUserSettings(UserSettings newUserSettings) {
		if (newUserSettings != userSettings) {
			...
			if (userSettings != null)
				msgs = ((InternalEObject)userSettings).eInverseRemove(this, StorePackage.USER_SETTINGS__QUERYENGINES, UserSettings.class, msgs);
			if (newUserSettings != null)
				msgs = ((InternalEObject)newUserSettings).eInverseAdd(this, StorePackage.USER_SETTINGS__QUERYENGINES, UserSettings.class, msgs);
			msgs = basicSetUserSettings(newUserSettings, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StorePackage.QUERY_ENGINE_PLUGIN_CONFIGURATION__USER_SETTINGS, newUserSettings, newUserSettings));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StorePackage.QUERY_ENGINE_PLUGIN_CONFIGURATION__USER_SETTINGS:
				if (userSettings != null)
					msgs = ((InternalEObject)userSettings).eInverseRemove(this, StorePackage.USER_SETTINGS__QUERYENGINES, UserSettings.class, msgs);
