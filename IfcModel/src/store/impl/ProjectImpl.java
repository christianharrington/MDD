...
public class ProjectImpl extends EObjectImpl implements Project {
	...
	public EList<ExtendedData> getExtendedData() {
		if (extendedData == null) {
			extendedData = new EObjectWithInverseResolvingEList<ExtendedData>(ExtendedData.class, this, StorePackage.PROJECT__EXTENDED_DATA, StorePackage.EXTENDED_DATA__PROJECT);
		}
		return extendedData;
	}
	...
	public EList<Service> getServices() {
		if (services == null) {
			services = new EObjectWithInverseResolvingEList<Service>(Service.class, this, StorePackage.PROJECT__SERVICES, StorePackage.SERVICE__PROJECT);
		}
		return services;
	}
	...
	public EList<LogAction> getLogs() {
		if (logs == null) {
			logs = new EObjectResolvingEList<LogAction>(LogAction.class, this, StorePackage.PROJECT__LOGS);
		}
		return logs;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StorePackage.PROJECT__SERVICES:
				return getServices();
			case StorePackage.PROJECT__LOGS:
				return getLogs();
		}
