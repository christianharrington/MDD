...
public class SimpleDataValueImpl extends DataValueImpl implements SimpleDataValue {
	...
	public void setStringValue(String newStringValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StorePackage.SIMPLE_DATA_VALUE__STRING_VALUE, oldStringValue, stringValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StorePackage.SIMPLE_DATA_VALUE__STRING_VALUE:
