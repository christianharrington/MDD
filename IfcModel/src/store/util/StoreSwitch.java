	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StorePackage.SERIALIZER_PLUGIN_CONFIGURATION: {
				...
				if (result == null) result = casePluginConfiguration(serializerPluginConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.OBJECT_IDM_PLUGIN_CONFIGURATION: {
				...
				if (result == null) result = casePluginConfiguration(objectIDMPluginConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.IFC_ENGINE_PLUGIN_CONFIGURATION: {
				...
				if (result == null) result = casePluginConfiguration(ifcEnginePluginConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.DESERIALIZER_PLUGIN_CONFIGURATION: {
				...
				if (result == null) result = casePluginConfiguration(deserializerPluginConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StorePackage.SERIALIZER_PLUGIN_DESCRIPTOR: {
				...
				if (result == null) result = casePluginDescriptor(serializerPluginDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.DESERIALIZER_PLUGIN_DESCRIPTOR: {
				...
				if (result == null) result = casePluginDescriptor(deserializerPluginDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StorePackage.LONG_CHECKIN_ACTION: {
				...
				if (result == null) result = caseLongAction(longCheckinAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StorePackage.IFC_ENGINE_PLUGIN_DESCRIPTOR: {
				...
				if (result == null) result = casePluginDescriptor(ifcEnginePluginDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StorePackage.QUERY_ENGINE_PLUGIN_DESCRIPTOR: {
				...
				if (result == null) result = casePluginDescriptor(queryEnginePluginDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.QUERY_ENGINE_PLUGIN_CONFIGURATION: {
				...
				if (result == null) result = casePluginConfiguration(queryEnginePluginConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.MODEL_MERGER_PLUGIN_DESCRIPTOR: {
				...
				if (result == null) result = casePluginDescriptor(modelMergerPluginDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.MODEL_MERGER_PLUGIN_CONFIGURATION: {
				...
				if (result == null) result = casePluginConfiguration(modelMergerPluginConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.MODEL_COMPARE_PLUGIN_DESCRIPTOR: {
				...
				if (result == null) result = casePluginDescriptor(modelComparePluginDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.MODEL_COMPARE_PLUGIN_CONFIGURATION: {
				...
				if (result == null) result = casePluginConfiguration(modelComparePluginConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StorePackage.SERVICE_PLUGIN_DESCRIPTOR: {
				...
				if (result == null) result = casePluginDescriptor(servicePluginDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.INTERNAL_SERVICE_PLUGIN_CONFIGURATION: {
				...
				if (result == null) result = casePluginConfiguration(internalServicePluginConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StorePackage.OBJECT_DEFINITION: {
				...
				if (result == null) result = caseTypeDefinition(objectDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StorePackage.PRIMITIVE_DEFINITION: {
				...
				if (result == null) result = caseTypeDefinition(primitiveDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StorePackage.LONG_TYPE: {
				...
				if (result == null) result = casePrimitiveType(longType);
			...
			case StorePackage.PERCENTAGE_CHANGE: {
				...
				if (result == null) result = caseExternalServiceUpdate(percentageChange);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
