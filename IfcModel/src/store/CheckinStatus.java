 ...
 * <!-- end-user-doc -->
 * @see store.StorePackage#getCheckinStatus()
 * @model
 * @generated
 */
public enum CheckinStatus implements Enumerator {
	 ...
	 * @generated
	 */
	private static final CheckinStatus[] VALUES_ARRAY =
		new CheckinStatus[] {
			CH_NONE,
			CH_STARTED,
			CH_FINISHED,
	...
	public static CheckinStatus get(int value) {
		switch (value) {
			case CH_NONE_VALUE: return CH_NONE;
			case CH_STARTED_VALUE: return CH_STARTED;
			case CH_FINISHED_VALUE: return CH_FINISHED;
			case CH_ERROR_VALUE: return CH_ERROR;
		}
		return null;
	}
