...
import ifc2x3tc1.IfcBoilerType;
import ifc2x3tc1.IfcBoilerTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcBoilerTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcBoilerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcBoilerType {
	 ...
	 * @ordered
	 */
	protected static final IfcBoilerTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcBoilerTypeEnum.NULL;
	...
	public void setPredefinedType(IfcBoilerTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_BOILER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
