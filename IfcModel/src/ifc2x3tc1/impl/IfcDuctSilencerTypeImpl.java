...
import ifc2x3tc1.IfcDuctSilencerType;
import ifc2x3tc1.IfcDuctSilencerTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcDuctSilencerTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcDuctSilencerTypeImpl extends IfcFlowTreatmentDeviceTypeImpl implements IfcDuctSilencerType {
	 ...
	 * @ordered
	 */
	protected static final IfcDuctSilencerTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcDuctSilencerTypeEnum.NULL;
	...
	public void setPredefinedType(IfcDuctSilencerTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_DUCT_SILENCER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
