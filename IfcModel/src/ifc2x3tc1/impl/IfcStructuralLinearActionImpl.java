...
import ifc2x3tc1.IfcStructuralLinearAction;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcStructuralLinearActionImpl#getProjectedOrTrue <em>Projected Or True</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcStructuralLinearActionImpl extends IfcStructuralActionImpl implements IfcStructuralLinearAction {
	...
	public void setProjectedOrTrue(IfcProjectedOrTrueLengthEnum newProjectedOrTrue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_STRUCTURAL_LINEAR_ACTION__PROJECTED_OR_TRUE, oldProjectedOrTrue, projectedOrTrue));
	}
