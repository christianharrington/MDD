 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcDoorImpl#getOverallHeight <em>Overall Height</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcDoorImpl#getOverallHeightAsString <em>Overall Height As String</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcDoorImpl#getOverallWidth <em>Overall Width</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcDoorImpl#getOverallWidthAsString <em>Overall Width As String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcDoorImpl extends IfcBuildingElementImpl implements IfcDoor {
	...
	public void setOverallHeight(double newOverallHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_DOOR__OVERALL_HEIGHT, oldOverallHeight, overallHeight, !oldOverallHeightESet));
	}
	...
	public void unsetOverallHeight() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_DOOR__OVERALL_HEIGHT, oldOverallHeight, OVERALL_HEIGHT_EDEFAULT, oldOverallHeightESet));
	}
	...
	public void setOverallHeightAsString(String newOverallHeightAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_DOOR__OVERALL_HEIGHT_AS_STRING, oldOverallHeightAsString, overallHeightAsString, !oldOverallHeightAsStringESet));
	}
	...
	public void unsetOverallHeightAsString() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_DOOR__OVERALL_HEIGHT_AS_STRING, oldOverallHeightAsString, OVERALL_HEIGHT_AS_STRING_EDEFAULT, oldOverallHeightAsStringESet));
	}
	...
	public void setOverallWidth(double newOverallWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_DOOR__OVERALL_WIDTH, oldOverallWidth, overallWidth, !oldOverallWidthESet));
	}
	...
	public void unsetOverallWidth() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_DOOR__OVERALL_WIDTH, oldOverallWidth, OVERALL_WIDTH_EDEFAULT, oldOverallWidthESet));
	}
	...
	public void setOverallWidthAsString(String newOverallWidthAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_DOOR__OVERALL_WIDTH_AS_STRING, oldOverallWidthAsString, overallWidthAsString, !oldOverallWidthAsStringESet));
	}
	...
	public void unsetOverallWidthAsString() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_DOOR__OVERALL_WIDTH_AS_STRING, oldOverallWidthAsString, OVERALL_WIDTH_AS_STRING_EDEFAULT, oldOverallWidthAsStringESet));
	}
