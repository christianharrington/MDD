...
import ifc2x3tc1.IfcHeatExchangerType;
import ifc2x3tc1.IfcHeatExchangerTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcHeatExchangerTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcHeatExchangerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcHeatExchangerType {
	 ...
	 * @ordered
	 */
	protected static final IfcHeatExchangerTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcHeatExchangerTypeEnum.NULL;
	...
	public void setPredefinedType(IfcHeatExchangerTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_HEAT_EXCHANGER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
