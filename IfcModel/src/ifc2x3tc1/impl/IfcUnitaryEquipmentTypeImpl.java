...
import ifc2x3tc1.IfcUnitaryEquipmentType;
import ifc2x3tc1.IfcUnitaryEquipmentTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcUnitaryEquipmentTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcUnitaryEquipmentTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcUnitaryEquipmentType {
	 ...
	 * @ordered
	 */
	protected static final IfcUnitaryEquipmentTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcUnitaryEquipmentTypeEnum.NULL;
	...
	public void setPredefinedType(IfcUnitaryEquipmentTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_UNITARY_EQUIPMENT_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
