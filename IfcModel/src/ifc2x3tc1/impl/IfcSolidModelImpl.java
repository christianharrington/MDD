...
import ifc2x3tc1.IfcSolidModel;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcSolidModelImpl#getDim <em>Dim</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSolidModelImpl extends IfcGeometricRepresentationItemImpl implements IfcSolidModel {
	...
	public void setDim(int newDim) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SOLID_MODEL__DIM, oldDim, dim, !oldDimESet));
	}
	...
	public void unsetDim() {
		...
		dimESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_SOLID_MODEL__DIM, oldDim, DIM_EDEFAULT, oldDimESet));
	}
