...
import ifc2x3tc1.IfcAirTerminalType;
import ifc2x3tc1.IfcAirTerminalTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcAirTerminalTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcAirTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcAirTerminalType {
	 ...
	 * @ordered
	 */
	protected static final IfcAirTerminalTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcAirTerminalTypeEnum.NULL;
	...
	public void setPredefinedType(IfcAirTerminalTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_AIR_TERMINAL_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
