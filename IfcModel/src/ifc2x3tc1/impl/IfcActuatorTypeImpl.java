...
import ifc2x3tc1.IfcActuatorType;
import ifc2x3tc1.IfcActuatorTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcActuatorTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcActuatorTypeImpl extends IfcDistributionControlElementTypeImpl implements IfcActuatorType {
	 ...
	 * @ordered
	 */
	protected static final IfcActuatorTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcActuatorTypeEnum.NULL;
	 ...
	 * @ordered
	 */
	protected IfcActuatorTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	public void setPredefinedType(IfcActuatorTypeEnum newPredefinedType) {
		IfcActuatorTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ACTUATOR_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_ACTUATOR_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcActuatorTypeEnum)newValue);
				return;
		}
