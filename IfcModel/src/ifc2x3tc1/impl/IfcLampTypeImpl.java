...
import ifc2x3tc1.IfcLampType;
import ifc2x3tc1.IfcLampTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcLampTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcLampTypeImpl extends IfcFlowTerminalTypeImpl implements IfcLampType {
	 ...
	 * @ordered
	 */
	protected static final IfcLampTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcLampTypeEnum.NULL;
	 ...
	 * @ordered
	 */
	protected IfcLampTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	public void setPredefinedType(IfcLampTypeEnum newPredefinedType) {
		IfcLampTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_LAMP_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_LAMP_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcLampTypeEnum)newValue);
				return;
		}
