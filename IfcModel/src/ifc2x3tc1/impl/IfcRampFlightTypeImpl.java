...
import ifc2x3tc1.IfcRampFlightType;
import ifc2x3tc1.IfcRampFlightTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcRampFlightTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcRampFlightTypeImpl extends IfcBuildingElementTypeImpl implements IfcRampFlightType {
	 ...
	 * @ordered
	 */
	protected static final IfcRampFlightTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcRampFlightTypeEnum.NULL;
	...
	public void setPredefinedType(IfcRampFlightTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_RAMP_FLIGHT_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
