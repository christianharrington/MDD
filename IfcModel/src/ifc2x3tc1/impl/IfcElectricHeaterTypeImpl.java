...
import ifc2x3tc1.IfcElectricHeaterType;
import ifc2x3tc1.IfcElectricHeaterTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcElectricHeaterTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcElectricHeaterTypeImpl extends IfcFlowTerminalTypeImpl implements IfcElectricHeaterType {
	 ...
	 * @ordered
	 */
	protected static final IfcElectricHeaterTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcElectricHeaterTypeEnum.NULL;
	...
	public void setPredefinedType(IfcElectricHeaterTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ELECTRIC_HEATER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
