...
import ifc2x3tc1.IfcLogicalOperatorEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcConstraintAggregationRelationshipImpl#getName <em>Name</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcConstraintAggregationRelationshipImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcConstraintAggregationRelationshipImpl#getRelatingConstraint <em>Relating Constraint</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcConstraintAggregationRelationshipImpl#getRelatedConstraints <em>Related Constraints</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcConstraintAggregationRelationshipImpl#getLogicalAggregator <em>Logical Aggregator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcConstraintAggregationRelationshipImpl extends EObjectImpl implements IfcConstraintAggregationRelationship {
	/**
	 ...
	 * @ordered
	 */
	protected static final IfcLogicalOperatorEnum LOGICAL_AGGREGATOR_EDEFAULT = IfcLogicalOperatorEnum.NULL;
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__NAME, oldName, name, !oldNameESet));
	}
	...
	public void unsetName() {
		...
		nameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__NAME, oldName, NAME_EDEFAULT, oldNameESet));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__DESCRIPTION, oldDescription, description, !oldDescriptionESet));
	}
	...
	public void unsetDescription() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__DESCRIPTION, oldDescription, DESCRIPTION_EDEFAULT, oldDescriptionESet));
	}
	...
	public IfcConstraint getRelatingConstraint() {
		if (relatingConstraint != null && relatingConstraint.eIsProxy()) {
			...
			if (relatingConstraint != oldRelatingConstraint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__RELATING_CONSTRAINT, oldRelatingConstraint, relatingConstraint));
			}
		}
	...
	public NotificationChain basicSetRelatingConstraint(IfcConstraint newRelatingConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__RELATING_CONSTRAINT, oldRelatingConstraint, newRelatingConstraint);
	...
	public void setRelatingConstraint(IfcConstraint newRelatingConstraint) {
		if (newRelatingConstraint != relatingConstraint) {
			...
			if (relatingConstraint != null)
				msgs = ((InternalEObject)relatingConstraint).eInverseRemove(this, Ifc2x3tc1Package.IFC_CONSTRAINT__AGGREGATES, IfcConstraint.class, msgs);
			if (newRelatingConstraint != null)
				msgs = ((InternalEObject)newRelatingConstraint).eInverseAdd(this, Ifc2x3tc1Package.IFC_CONSTRAINT__AGGREGATES, IfcConstraint.class, msgs);
			msgs = basicSetRelatingConstraint(newRelatingConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__RELATING_CONSTRAINT, newRelatingConstraint, newRelatingConstraint));
	}
	...
	public EList<IfcConstraint> getRelatedConstraints() {
		if (relatedConstraints == null) {
			relatedConstraints = new EObjectWithInverseResolvingEList.ManyInverse<IfcConstraint>(IfcConstraint.class, this, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__RELATED_CONSTRAINTS, Ifc2x3tc1Package.IFC_CONSTRAINT__IS_AGGREGATED_IN);
		}
	...
	public void setLogicalAggregator(IfcLogicalOperatorEnum newLogicalAggregator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__LOGICAL_AGGREGATOR, oldLogicalAggregator, logicalAggregator));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__RELATING_CONSTRAINT:
				if (relatingConstraint != null)
					msgs = ((InternalEObject)relatingConstraint).eInverseRemove(this, Ifc2x3tc1Package.IFC_CONSTRAINT__AGGREGATES, IfcConstraint.class, msgs);
				return basicSetRelatingConstraint((IfcConstraint)otherEnd, msgs);
			case Ifc2x3tc1Package.IFC_CONSTRAINT_AGGREGATION_RELATIONSHIP__RELATED_CONSTRAINTS:
