...
import ifc2x3tc1.IfcElectricGeneratorType;
import ifc2x3tc1.IfcElectricGeneratorTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcElectricGeneratorTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcElectricGeneratorTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcElectricGeneratorType {
	 ...
	 * @ordered
	 */
	protected static final IfcElectricGeneratorTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcElectricGeneratorTypeEnum.NULL;
	...
	public void setPredefinedType(IfcElectricGeneratorTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ELECTRIC_GENERATOR_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
