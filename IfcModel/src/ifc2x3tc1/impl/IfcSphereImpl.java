 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcSphereImpl#getRadius <em>Radius</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcSphereImpl#getRadiusAsString <em>Radius As String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSphereImpl extends IfcCsgPrimitive3DImpl implements IfcSphere {
	...
	public void setRadius(double newRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SPHERE__RADIUS, oldRadius, radius));
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SPHERE__RADIUS_AS_STRING, oldRadiusAsString, radiusAsString));
	}
