...
import ifc2x3tc1.IfcMassFlowRateMeasure;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcMassFlowRateMeasureImpl#getWrappedValue <em>Wrapped Value</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcMassFlowRateMeasureImpl#getWrappedValueAsString <em>Wrapped Value As String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcMassFlowRateMeasureImpl extends WrappedValueImpl implements IfcMassFlowRateMeasure {
	...
	public void setWrappedValue(double newWrappedValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_MASS_FLOW_RATE_MEASURE__WRAPPED_VALUE, oldWrappedValue, wrappedValue, !oldWrappedValueESet));
	}
	...
	public void unsetWrappedValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_MASS_FLOW_RATE_MEASURE__WRAPPED_VALUE, oldWrappedValue, WRAPPED_VALUE_EDEFAULT, oldWrappedValueESet));
	}
	...
	public void setWrappedValueAsString(String newWrappedValueAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_MASS_FLOW_RATE_MEASURE__WRAPPED_VALUE_AS_STRING, oldWrappedValueAsString, wrappedValueAsString, !oldWrappedValueAsStringESet));
	}
	...
	public void unsetWrappedValueAsString() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_MASS_FLOW_RATE_MEASURE__WRAPPED_VALUE_AS_STRING, oldWrappedValueAsString, WRAPPED_VALUE_AS_STRING_EDEFAULT, oldWrappedValueAsStringESet));
	}
