...
import ifc2x3tc1.IfcStructuralPlanarActionVarying;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcStructuralPlanarActionVaryingImpl#getVaryingAppliedLoadLocation <em>Varying Applied Load Location</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcStructuralPlanarActionVaryingImpl#getSubsequentAppliedLoads <em>Subsequent Applied Loads</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcStructuralPlanarActionVaryingImpl extends IfcStructuralPlanarActionImpl implements IfcStructuralPlanarActionVarying {
		...
		if (varyingAppliedLoadLocation != null && varyingAppliedLoadLocation.eIsProxy()) {
			...
			if (varyingAppliedLoadLocation != oldVaryingAppliedLoadLocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ifc2x3tc1Package.IFC_STRUCTURAL_PLANAR_ACTION_VARYING__VARYING_APPLIED_LOAD_LOCATION, oldVaryingAppliedLoadLocation, varyingAppliedLoadLocation));
			}
		}
	...
	public void setVaryingAppliedLoadLocation(IfcShapeAspect newVaryingAppliedLoadLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_STRUCTURAL_PLANAR_ACTION_VARYING__VARYING_APPLIED_LOAD_LOCATION, oldVaryingAppliedLoadLocation, varyingAppliedLoadLocation));
	}
	...
	public EList<IfcStructuralLoad> getSubsequentAppliedLoads() {
		if (subsequentAppliedLoads == null) {
			subsequentAppliedLoads = new EObjectResolvingEList<IfcStructuralLoad>(IfcStructuralLoad.class, this, Ifc2x3tc1Package.IFC_STRUCTURAL_PLANAR_ACTION_VARYING__SUBSEQUENT_APPLIED_LOADS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_STRUCTURAL_PLANAR_ACTION_VARYING__VARYING_APPLIED_LOAD_LOCATION:
				if (resolve) return getVaryingAppliedLoadLocation();
				return basicGetVaryingAppliedLoadLocation();
			case Ifc2x3tc1Package.IFC_STRUCTURAL_PLANAR_ACTION_VARYING__SUBSEQUENT_APPLIED_LOADS:
