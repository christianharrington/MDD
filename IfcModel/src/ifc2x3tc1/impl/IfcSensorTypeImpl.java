...
import ifc2x3tc1.IfcSensorType;
import ifc2x3tc1.IfcSensorTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcSensorTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSensorTypeImpl extends IfcDistributionControlElementTypeImpl implements IfcSensorType {
	 ...
	 * @ordered
	 */
	protected static final IfcSensorTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcSensorTypeEnum.NULL;
	 ...
	 * @ordered
	 */
	protected IfcSensorTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	public void setPredefinedType(IfcSensorTypeEnum newPredefinedType) {
		IfcSensorTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SENSOR_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_SENSOR_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcSensorTypeEnum)newValue);
				return;
		}
