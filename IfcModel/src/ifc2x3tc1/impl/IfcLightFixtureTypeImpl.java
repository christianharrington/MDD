...
import ifc2x3tc1.IfcLightFixtureType;
import ifc2x3tc1.IfcLightFixtureTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcLightFixtureTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcLightFixtureTypeImpl extends IfcFlowTerminalTypeImpl implements IfcLightFixtureType {
	 ...
	 * @ordered
	 */
	protected static final IfcLightFixtureTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcLightFixtureTypeEnum.NULL;
	...
	public void setPredefinedType(IfcLightFixtureTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_LIGHT_FIXTURE_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
