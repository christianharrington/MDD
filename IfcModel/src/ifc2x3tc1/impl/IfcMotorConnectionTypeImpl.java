...
import ifc2x3tc1.IfcMotorConnectionType;
import ifc2x3tc1.IfcMotorConnectionTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcMotorConnectionTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcMotorConnectionTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcMotorConnectionType {
	 ...
	 * @ordered
	 */
	protected static final IfcMotorConnectionTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcMotorConnectionTypeEnum.NULL;
	 ...
	 * @ordered
	 */
	protected IfcMotorConnectionTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	public void setPredefinedType(IfcMotorConnectionTypeEnum newPredefinedType) {
		IfcMotorConnectionTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_MOTOR_CONNECTION_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_MOTOR_CONNECTION_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcMotorConnectionTypeEnum)newValue);
				return;
		}
