...
import ifc2x3tc1.IfcElementarySurface;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcElementarySurfaceImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcElementarySurfaceImpl#getDim <em>Dim</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcElementarySurfaceImpl extends IfcSurfaceImpl implements IfcElementarySurface {
		...
		if (position != null && position.eIsProxy()) {
			...
			if (position != oldPosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ifc2x3tc1Package.IFC_ELEMENTARY_SURFACE__POSITION, oldPosition, position));
			}
		}
		return position;
	}
	...
	public void setPosition(IfcAxis2Placement3D newPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ELEMENTARY_SURFACE__POSITION, oldPosition, position));
	}
	...
	public void setDim(int newDim) {
		...
		dimESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ELEMENTARY_SURFACE__DIM, oldDim, dim, !oldDimESet));
	}
	...
	public void unsetDim() {
		...
		dimESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_ELEMENTARY_SURFACE__DIM, oldDim, DIM_EDEFAULT, oldDimESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_ELEMENTARY_SURFACE__POSITION:
