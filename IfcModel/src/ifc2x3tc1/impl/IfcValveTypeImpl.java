...
import ifc2x3tc1.IfcValveType;
import ifc2x3tc1.IfcValveTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcValveTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcValveTypeImpl extends IfcFlowControllerTypeImpl implements IfcValveType {
	 ...
	 * @ordered
	 */
	protected static final IfcValveTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcValveTypeEnum.NULL;
	...
	public void setPredefinedType(IfcValveTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_VALVE_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
