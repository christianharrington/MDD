...
import ifc2x3tc1.IfcStairFlightType;
import ifc2x3tc1.IfcStairFlightTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcStairFlightTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcStairFlightTypeImpl extends IfcBuildingElementTypeImpl implements IfcStairFlightType {
	 ...
	 * @ordered
	 */
	protected static final IfcStairFlightTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcStairFlightTypeEnum.NULL;
	...
	public void setPredefinedType(IfcStairFlightTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_STAIR_FLIGHT_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
