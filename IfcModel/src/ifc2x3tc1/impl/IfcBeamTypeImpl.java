...
import ifc2x3tc1.IfcBeamType;
import ifc2x3tc1.IfcBeamTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcBeamTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcBeamTypeImpl extends IfcBuildingElementTypeImpl implements IfcBeamType {
	 ...
	 * @ordered
	 */
	protected static final IfcBeamTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcBeamTypeEnum.NULL;
	...
	public void setPredefinedType(IfcBeamTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_BEAM_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
