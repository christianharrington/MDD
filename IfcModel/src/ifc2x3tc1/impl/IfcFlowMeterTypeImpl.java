...
import ifc2x3tc1.IfcFlowMeterType;
import ifc2x3tc1.IfcFlowMeterTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcFlowMeterTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcFlowMeterTypeImpl extends IfcFlowControllerTypeImpl implements IfcFlowMeterType {
	 ...
	 * @ordered
	 */
	protected static final IfcFlowMeterTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcFlowMeterTypeEnum.NULL;
	...
	public void setPredefinedType(IfcFlowMeterTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_FLOW_METER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
