...
import ifc2x3tc1.IfcSurfaceOfLinearExtrusion;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcSurfaceOfLinearExtrusionImpl#getExtrudedDirection <em>Extruded Direction</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcSurfaceOfLinearExtrusionImpl#getDepth <em>Depth</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcSurfaceOfLinearExtrusionImpl#getDepthAsString <em>Depth As String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSurfaceOfLinearExtrusionImpl extends IfcSweptSurfaceImpl implements IfcSurfaceOfLinearExtrusion {
		...
		if (extrudedDirection != null && extrudedDirection.eIsProxy()) {
			...
			if (extrudedDirection != oldExtrudedDirection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ifc2x3tc1Package.IFC_SURFACE_OF_LINEAR_EXTRUSION__EXTRUDED_DIRECTION, oldExtrudedDirection, extrudedDirection));
			}
		}
	...
	public void setExtrudedDirection(IfcDirection newExtrudedDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SURFACE_OF_LINEAR_EXTRUSION__EXTRUDED_DIRECTION, oldExtrudedDirection, extrudedDirection));
	}
	...
	public void setDepth(double newDepth) {
		...
		depth = newDepth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SURFACE_OF_LINEAR_EXTRUSION__DEPTH, oldDepth, depth));
	}
	...
	public void setDepthAsString(String newDepthAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SURFACE_OF_LINEAR_EXTRUSION__DEPTH_AS_STRING, oldDepthAsString, depthAsString));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_SURFACE_OF_LINEAR_EXTRUSION__EXTRUDED_DIRECTION:
