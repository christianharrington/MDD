...
import ifc2x3tc1.IfcDuctSegmentType;
import ifc2x3tc1.IfcDuctSegmentTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcDuctSegmentTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcDuctSegmentTypeImpl extends IfcFlowSegmentTypeImpl implements IfcDuctSegmentType {
	 ...
	 * @ordered
	 */
	protected static final IfcDuctSegmentTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcDuctSegmentTypeEnum.NULL;
	 ...
	 * @ordered
	 */
	protected IfcDuctSegmentTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	public void setPredefinedType(IfcDuctSegmentTypeEnum newPredefinedType) {
		IfcDuctSegmentTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_DUCT_SEGMENT_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_DUCT_SEGMENT_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcDuctSegmentTypeEnum)newValue);
				return;
		}
