...
import ifc2x3tc1.IfcPlateType;
import ifc2x3tc1.IfcPlateTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcPlateTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcPlateTypeImpl extends IfcBuildingElementTypeImpl implements IfcPlateType {
	 ...
	 * @ordered
	 */
	protected static final IfcPlateTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcPlateTypeEnum.NULL;
	...
	public void setPredefinedType(IfcPlateTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PLATE_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
