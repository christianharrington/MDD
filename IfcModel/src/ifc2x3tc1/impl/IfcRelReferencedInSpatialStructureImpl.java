 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcRelReferencedInSpatialStructureImpl#getRelatedElements <em>Related Elements</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcRelReferencedInSpatialStructureImpl#getRelatingStructure <em>Relating Structure</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcRelReferencedInSpatialStructureImpl extends IfcRelConnectsImpl implements IfcRelReferencedInSpatialStructure {
	...
	public EList<IfcProduct> getRelatedElements() {
		if (relatedElements == null) {
			relatedElements = new EObjectResolvingEList<IfcProduct>(IfcProduct.class, this, Ifc2x3tc1Package.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATED_ELEMENTS);
		}
		...
		if (relatingStructure != null && relatingStructure.eIsProxy()) {
			...
			if (relatingStructure != oldRelatingStructure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ifc2x3tc1Package.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATING_STRUCTURE, oldRelatingStructure, relatingStructure));
			}
		}
	...
	public NotificationChain basicSetRelatingStructure(IfcSpatialStructureElement newRelatingStructure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATING_STRUCTURE, oldRelatingStructure, newRelatingStructure);
	...
	public void setRelatingStructure(IfcSpatialStructureElement newRelatingStructure) {
		if (newRelatingStructure != relatingStructure) {
			...
			if (relatingStructure != null)
				msgs = ((InternalEObject)relatingStructure).eInverseRemove(this, Ifc2x3tc1Package.IFC_SPATIAL_STRUCTURE_ELEMENT__REFERENCES_ELEMENTS, IfcSpatialStructureElement.class, msgs);
			if (newRelatingStructure != null)
				msgs = ((InternalEObject)newRelatingStructure).eInverseAdd(this, Ifc2x3tc1Package.IFC_SPATIAL_STRUCTURE_ELEMENT__REFERENCES_ELEMENTS, IfcSpatialStructureElement.class, msgs);
			msgs = basicSetRelatingStructure(newRelatingStructure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATING_STRUCTURE, newRelatingStructure, newRelatingStructure));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATING_STRUCTURE:
				if (relatingStructure != null)
					msgs = ((InternalEObject)relatingStructure).eInverseRemove(this, Ifc2x3tc1Package.IFC_SPATIAL_STRUCTURE_ELEMENT__REFERENCES_ELEMENTS, IfcSpatialStructureElement.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATED_ELEMENTS:
