...
import ifc2x3tc1.IfcDuctFittingType;
import ifc2x3tc1.IfcDuctFittingTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcDuctFittingTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcDuctFittingTypeImpl extends IfcFlowFittingTypeImpl implements IfcDuctFittingType {
	 ...
	 * @ordered
	 */
	protected static final IfcDuctFittingTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcDuctFittingTypeEnum.NULL;
	...
	public void setPredefinedType(IfcDuctFittingTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_DUCT_FITTING_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
