...
import ifc2x3tc1.IfcSpaceHeaterType;
import ifc2x3tc1.IfcSpaceHeaterTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcSpaceHeaterTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSpaceHeaterTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcSpaceHeaterType {
	 ...
	 * @ordered
	 */
	protected static final IfcSpaceHeaterTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcSpaceHeaterTypeEnum.NULL;
	...
	public void setPredefinedType(IfcSpaceHeaterTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SPACE_HEATER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
