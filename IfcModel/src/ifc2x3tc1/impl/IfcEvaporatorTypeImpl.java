...
import ifc2x3tc1.IfcEvaporatorType;
import ifc2x3tc1.IfcEvaporatorTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcEvaporatorTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcEvaporatorTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcEvaporatorType {
	 ...
	 * @ordered
	 */
	protected static final IfcEvaporatorTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcEvaporatorTypeEnum.NULL;
	...
	public void setPredefinedType(IfcEvaporatorTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_EVAPORATOR_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
