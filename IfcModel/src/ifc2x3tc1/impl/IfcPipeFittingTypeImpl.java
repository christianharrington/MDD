...
import ifc2x3tc1.IfcPipeFittingType;
import ifc2x3tc1.IfcPipeFittingTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcPipeFittingTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcPipeFittingTypeImpl extends IfcFlowFittingTypeImpl implements IfcPipeFittingType {
	 ...
	 * @ordered
	 */
	protected static final IfcPipeFittingTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcPipeFittingTypeEnum.NULL;
	...
	public void setPredefinedType(IfcPipeFittingTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PIPE_FITTING_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
