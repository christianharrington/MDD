...
import ifc2x3tc1.IfcFanType;
import ifc2x3tc1.IfcFanTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcFanTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcFanTypeImpl extends IfcFlowMovingDeviceTypeImpl implements IfcFanType {
	 ...
	 * @ordered
	 */
	protected static final IfcFanTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcFanTypeEnum.NULL;
	...
	public void setPredefinedType(IfcFanTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_FAN_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
