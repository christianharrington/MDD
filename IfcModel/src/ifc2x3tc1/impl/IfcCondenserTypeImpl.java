...
import ifc2x3tc1.IfcCondenserType;
import ifc2x3tc1.IfcCondenserTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcCondenserTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcCondenserTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCondenserType {
	 ...
	 * @ordered
	 */
	protected static final IfcCondenserTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcCondenserTypeEnum.NULL;
	...
	public void setPredefinedType(IfcCondenserTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CONDENSER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
