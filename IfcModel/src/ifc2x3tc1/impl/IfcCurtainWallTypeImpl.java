...
import ifc2x3tc1.IfcCurtainWallType;
import ifc2x3tc1.IfcCurtainWallTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcCurtainWallTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcCurtainWallTypeImpl extends IfcBuildingElementTypeImpl implements IfcCurtainWallType {
	 ...
	 * @ordered
	 */
	protected static final IfcCurtainWallTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcCurtainWallTypeEnum.NULL;
	...
	public void setPredefinedType(IfcCurtainWallTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CURTAIN_WALL_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
