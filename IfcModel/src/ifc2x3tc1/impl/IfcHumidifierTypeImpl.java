...
import ifc2x3tc1.IfcHumidifierType;
import ifc2x3tc1.IfcHumidifierTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcHumidifierTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcHumidifierTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcHumidifierType {
	 ...
	 * @ordered
	 */
	protected static final IfcHumidifierTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcHumidifierTypeEnum.NULL;
	...
	public void setPredefinedType(IfcHumidifierTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_HUMIDIFIER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
