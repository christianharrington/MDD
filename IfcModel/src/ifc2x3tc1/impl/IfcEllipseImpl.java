 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcEllipseImpl#getSemiAxis1 <em>Semi Axis1</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcEllipseImpl#getSemiAxis1AsString <em>Semi Axis1 As String</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcEllipseImpl#getSemiAxis2 <em>Semi Axis2</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcEllipseImpl#getSemiAxis2AsString <em>Semi Axis2 As String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcEllipseImpl extends IfcConicImpl implements IfcEllipse {
	...
	public void setSemiAxis1(double newSemiAxis1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ELLIPSE__SEMI_AXIS1, oldSemiAxis1, semiAxis1));
	}
	...
	public void setSemiAxis1AsString(String newSemiAxis1AsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ELLIPSE__SEMI_AXIS1_AS_STRING, oldSemiAxis1AsString, semiAxis1AsString));
	}
	...
	public void setSemiAxis2(double newSemiAxis2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ELLIPSE__SEMI_AXIS2, oldSemiAxis2, semiAxis2));
	}
	...
	public void setSemiAxis2AsString(String newSemiAxis2AsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_ELLIPSE__SEMI_AXIS2_AS_STRING, oldSemiAxis2AsString, semiAxis2AsString));
	}
