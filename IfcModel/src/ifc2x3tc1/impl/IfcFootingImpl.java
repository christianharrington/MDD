...
import ifc2x3tc1.IfcFooting;
import ifc2x3tc1.IfcFootingTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcFootingImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcFootingImpl extends IfcBuildingElementImpl implements IfcFooting {
	 ...
	 * @ordered
	 */
	protected static final IfcFootingTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcFootingTypeEnum.NULL;
	...
	public void setPredefinedType(IfcFootingTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_FOOTING__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
