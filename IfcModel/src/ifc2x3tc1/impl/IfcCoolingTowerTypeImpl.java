...
import ifc2x3tc1.IfcCoolingTowerType;
import ifc2x3tc1.IfcCoolingTowerTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcCoolingTowerTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcCoolingTowerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCoolingTowerType {
	 ...
	 * @ordered
	 */
	protected static final IfcCoolingTowerTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcCoolingTowerTypeEnum.NULL;
	...
	public void setPredefinedType(IfcCoolingTowerTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_COOLING_TOWER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
