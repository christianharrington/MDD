...
import ifc2x3tc1.IfcSpaceType;
import ifc2x3tc1.IfcSpaceTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcSpaceTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSpaceTypeImpl extends IfcSpatialStructureElementTypeImpl implements IfcSpaceType {
	 ...
	 * @ordered
	 */
	protected static final IfcSpaceTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcSpaceTypeEnum.NULL;
	 ...
	 * @ordered
	 */
	protected IfcSpaceTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	public void setPredefinedType(IfcSpaceTypeEnum newPredefinedType) {
		IfcSpaceTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SPACE_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_SPACE_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcSpaceTypeEnum)newValue);
				return;
		}
