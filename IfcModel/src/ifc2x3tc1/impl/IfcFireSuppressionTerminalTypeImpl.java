...
import ifc2x3tc1.IfcFireSuppressionTerminalType;
import ifc2x3tc1.IfcFireSuppressionTerminalTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcFireSuppressionTerminalTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcFireSuppressionTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcFireSuppressionTerminalType {
	 ...
	 * @ordered
	 */
	protected static final IfcFireSuppressionTerminalTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcFireSuppressionTerminalTypeEnum.NULL;
	 ...
	 * @ordered
	 */
	protected IfcFireSuppressionTerminalTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	public void setPredefinedType(IfcFireSuppressionTerminalTypeEnum newPredefinedType) {
		IfcFireSuppressionTerminalTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_FIRE_SUPPRESSION_TERMINAL_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_FIRE_SUPPRESSION_TERMINAL_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcFireSuppressionTerminalTypeEnum)newValue);
				return;
		}
