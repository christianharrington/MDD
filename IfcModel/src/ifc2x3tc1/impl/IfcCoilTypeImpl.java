...
import ifc2x3tc1.IfcCoilType;
import ifc2x3tc1.IfcCoilTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcCoilTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcCoilTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCoilType {
	 ...
	 * @ordered
	 */
	protected static final IfcCoilTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcCoilTypeEnum.NULL;
	 ...
	 * @ordered
	 */
	protected IfcCoilTypeEnum predefinedType = PREDEFINED_TYPE_EDEFAULT;
	...
	public void setPredefinedType(IfcCoilTypeEnum newPredefinedType) {
		IfcCoilTypeEnum oldPredefinedType = predefinedType;
		predefinedType = newPredefinedType == null ? PREDEFINED_TYPE_EDEFAULT : newPredefinedType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_COIL_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_COIL_TYPE__PREDEFINED_TYPE:
				setPredefinedType((IfcCoilTypeEnum)newValue);
				return;
		}
