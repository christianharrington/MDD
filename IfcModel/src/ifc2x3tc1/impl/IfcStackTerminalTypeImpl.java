...
import ifc2x3tc1.IfcStackTerminalType;
import ifc2x3tc1.IfcStackTerminalTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcStackTerminalTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcStackTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcStackTerminalType {
	 ...
	 * @ordered
	 */
	protected static final IfcStackTerminalTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcStackTerminalTypeEnum.NULL;
	...
	public void setPredefinedType(IfcStackTerminalTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_STACK_TERMINAL_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
