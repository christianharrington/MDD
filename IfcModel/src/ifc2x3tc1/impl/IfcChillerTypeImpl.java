...
import ifc2x3tc1.IfcChillerType;
import ifc2x3tc1.IfcChillerTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcChillerTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcChillerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcChillerType {
	 ...
	 * @ordered
	 */
	protected static final IfcChillerTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcChillerTypeEnum.NULL;
	...
	public void setPredefinedType(IfcChillerTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CHILLER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
