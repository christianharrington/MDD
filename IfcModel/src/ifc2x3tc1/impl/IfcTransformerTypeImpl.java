...
import ifc2x3tc1.IfcTransformerType;
import ifc2x3tc1.IfcTransformerTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcTransformerTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcTransformerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcTransformerType {
	 ...
	 * @ordered
	 */
	protected static final IfcTransformerTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcTransformerTypeEnum.NULL;
	...
	public void setPredefinedType(IfcTransformerTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_TRANSFORMER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
