...
import ifc2x3tc1.IfcOccupant;
import ifc2x3tc1.IfcOccupantTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcOccupantImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcOccupantImpl extends IfcActorImpl implements IfcOccupant {
	 ...
	 * @ordered
	 */
	protected static final IfcOccupantTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcOccupantTypeEnum.NULL;
	...
	public void setPredefinedType(IfcOccupantTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_OCCUPANT__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
