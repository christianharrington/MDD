...
import ifc2x3tc1.IfcPermeableCoveringOperationEnum;
import ifc2x3tc1.IfcPermeableCoveringProperties;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcPermeableCoveringPropertiesImpl#getOperationType <em>Operation Type</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcPermeableCoveringPropertiesImpl#getPanelPosition <em>Panel Position</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcPermeableCoveringPropertiesImpl#getFrameDepth <em>Frame Depth</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcPermeableCoveringPropertiesImpl#getFrameDepthAsString <em>Frame Depth As String</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcPermeableCoveringPropertiesImpl#getFrameThickness <em>Frame Thickness</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcPermeableCoveringPropertiesImpl#getFrameThicknessAsString <em>Frame Thickness As String</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcPermeableCoveringPropertiesImpl#getShapeAspectStyle <em>Shape Aspect Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcPermeableCoveringPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcPermeableCoveringProperties {
	 ...
	 * @ordered
	 */
	protected static final IfcPermeableCoveringOperationEnum OPERATION_TYPE_EDEFAULT = IfcPermeableCoveringOperationEnum.NULL;
	...
	public void setOperationType(IfcPermeableCoveringOperationEnum newOperationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE, oldOperationType, operationType));
	}
	...
	public void setPanelPosition(IfcWindowPanelPositionEnum newPanelPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__PANEL_POSITION, oldPanelPosition, panelPosition));
	}
	...
	public void setFrameDepth(double newFrameDepth) {
		...
		frameDepthESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH, oldFrameDepth, frameDepth, !oldFrameDepthESet));
	}
	...
	public void unsetFrameDepth() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH, oldFrameDepth, FRAME_DEPTH_EDEFAULT, oldFrameDepthESet));
	}
	...
	public void setFrameDepthAsString(String newFrameDepthAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING, oldFrameDepthAsString, frameDepthAsString, !oldFrameDepthAsStringESet));
	}
	...
	public void unsetFrameDepthAsString() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING, oldFrameDepthAsString, FRAME_DEPTH_AS_STRING_EDEFAULT, oldFrameDepthAsStringESet));
	}
	...
	public void setFrameThickness(double newFrameThickness) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS, oldFrameThickness, frameThickness, !oldFrameThicknessESet));
	}
	...
	public void unsetFrameThickness() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS, oldFrameThickness, FRAME_THICKNESS_EDEFAULT, oldFrameThicknessESet));
	}
	...
	public void setFrameThicknessAsString(String newFrameThicknessAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING, oldFrameThicknessAsString, frameThicknessAsString, !oldFrameThicknessAsStringESet));
	}
	...
	public void unsetFrameThicknessAsString() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING, oldFrameThicknessAsString, FRAME_THICKNESS_AS_STRING_EDEFAULT, oldFrameThicknessAsStringESet));
	}
	...
	public IfcShapeAspect getShapeAspectStyle() {
		if (shapeAspectStyle != null && shapeAspectStyle.eIsProxy()) {
			...
			if (shapeAspectStyle != oldShapeAspectStyle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE, oldShapeAspectStyle, shapeAspectStyle));
			}
		}
	...
	public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE, oldShapeAspectStyle, shapeAspectStyle, !oldShapeAspectStyleESet));
	}
	...
	public void unsetShapeAspectStyle() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE, oldShapeAspectStyle, null, oldShapeAspectStyleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Ifc2x3tc1Package.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE:
