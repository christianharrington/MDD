...
import ifc2x3tc1.IfcOutletType;
import ifc2x3tc1.IfcOutletTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcOutletTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcOutletTypeImpl extends IfcFlowTerminalTypeImpl implements IfcOutletType {
	 ...
	 * @ordered
	 */
	protected static final IfcOutletTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcOutletTypeEnum.NULL;
	...
	public void setPredefinedType(IfcOutletTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_OUTLET_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
