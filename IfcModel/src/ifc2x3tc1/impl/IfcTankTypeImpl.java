...
import ifc2x3tc1.IfcTankType;
import ifc2x3tc1.IfcTankTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcTankTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcTankTypeImpl extends IfcFlowStorageDeviceTypeImpl implements IfcTankType {
	 ...
	 * @ordered
	 */
	protected static final IfcTankTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcTankTypeEnum.NULL;
	...
	public void setPredefinedType(IfcTankTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_TANK_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
