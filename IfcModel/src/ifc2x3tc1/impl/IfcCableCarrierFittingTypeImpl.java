...
import ifc2x3tc1.IfcCableCarrierFittingType;
import ifc2x3tc1.IfcCableCarrierFittingTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcCableCarrierFittingTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcCableCarrierFittingTypeImpl extends IfcFlowFittingTypeImpl implements IfcCableCarrierFittingType {
	 ...
	 * @ordered
	 */
	protected static final IfcCableCarrierFittingTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcCableCarrierFittingTypeEnum.NULL;
	...
	public void setPredefinedType(IfcCableCarrierFittingTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_CABLE_CARRIER_FITTING_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
