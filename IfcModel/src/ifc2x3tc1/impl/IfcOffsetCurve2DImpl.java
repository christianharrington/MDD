...
import ifc2x3tc1.IfcOffsetCurve2D;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcOffsetCurve2DImpl#getBasisCurve <em>Basis Curve</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcOffsetCurve2DImpl#getDistance <em>Distance</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcOffsetCurve2DImpl#getDistanceAsString <em>Distance As String</em>}</li>
 *   <li>{@link ifc2x3tc1.impl.IfcOffsetCurve2DImpl#isSelfIntersect <em>Self Intersect</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcOffsetCurve2DImpl extends IfcCurveImpl implements IfcOffsetCurve2D {
		...
		if (basisCurve != null && basisCurve.eIsProxy()) {
			...
			if (basisCurve != oldBasisCurve) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ifc2x3tc1Package.IFC_OFFSET_CURVE2_D__BASIS_CURVE, oldBasisCurve, basisCurve));
			}
		}
		return basisCurve;
	}
	...
	public void setBasisCurve(IfcCurve newBasisCurve) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_OFFSET_CURVE2_D__BASIS_CURVE, oldBasisCurve, basisCurve));
	}
	...
	public void setDistance(double newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_OFFSET_CURVE2_D__DISTANCE, oldDistance, distance));
	}
	...
	public void setDistanceAsString(String newDistanceAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_OFFSET_CURVE2_D__DISTANCE_AS_STRING, oldDistanceAsString, distanceAsString));
	}
	...
	public void setSelfIntersect(boolean newSelfIntersect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_OFFSET_CURVE2_D__SELF_INTERSECT, oldSelfIntersect, selfIntersect));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ifc2x3tc1Package.IFC_OFFSET_CURVE2_D__BASIS_CURVE:
