...
import ifc2x3tc1.IfcSwitchingDeviceType;
import ifc2x3tc1.IfcSwitchingDeviceTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcSwitchingDeviceTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSwitchingDeviceTypeImpl extends IfcFlowControllerTypeImpl implements IfcSwitchingDeviceType {
	 ...
	 * @ordered
	 */
	protected static final IfcSwitchingDeviceTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcSwitchingDeviceTypeEnum.NULL;
	...
	public void setPredefinedType(IfcSwitchingDeviceTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_SWITCHING_DEVICE_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
