...
import ifc2x3tc1.IfcEvaporativeCoolerType;
import ifc2x3tc1.IfcEvaporativeCoolerTypeEnum;
 ...
 * <ul>
 *   <li>{@link ifc2x3tc1.impl.IfcEvaporativeCoolerTypeImpl#getPredefinedType <em>Predefined Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcEvaporativeCoolerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcEvaporativeCoolerType {
	 ...
	 * @ordered
	 */
	protected static final IfcEvaporativeCoolerTypeEnum PREDEFINED_TYPE_EDEFAULT = IfcEvaporativeCoolerTypeEnum.NULL;
	...
	public void setPredefinedType(IfcEvaporativeCoolerTypeEnum newPredefinedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ifc2x3tc1Package.IFC_EVAPORATIVE_COOLER_TYPE__PREDEFINED_TYPE, oldPredefinedType, predefinedType));
	}
