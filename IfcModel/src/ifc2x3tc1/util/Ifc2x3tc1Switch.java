	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Ifc2x3tc1Package.IFC_BOOLEAN: {
				...
				if (result == null) result = caseIfcSimpleValue(ifcBoolean);
			...
			case Ifc2x3tc1Package.IFC_COMPLEX_NUMBER: {
				...
				if (result == null) result = caseWrappedValue(ifcComplexNumber);
				if (result == null) result = caseIfcMeasureValue(ifcComplexNumber);
				if (result == null) result = caseIfcValue(ifcComplexNumber);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3tc1Package.IFC_COMPOUND_PLANE_ANGLE_MEASURE: {
				...
				if (result == null) result = caseWrappedValue(ifcCompoundPlaneAngleMeasure);
				if (result == null) result = caseIfcDerivedMeasureValue(ifcCompoundPlaneAngleMeasure);
				if (result == null) result = caseIfcValue(ifcCompoundPlaneAngleMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3tc1Package.IFC_NULL_STYLE: {
				...
				if (result == null) result = caseWrappedValue(ifcNullStyle);
				if (result == null) result = caseIfcPresentationStyleSelect(ifcNullStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
