...
(
    ...
    { 
        $current = $this_WallRelation_3.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_FlowSegment_4.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_LocalPlacement_5.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_Axis2Placement3D_6.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleWallRelation returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getWallRelationRule()); }
	 iv_ruleWallRelation=ruleWallRelation 
	 { $current=$iv_ruleWallRelation.current; } 
	 EOF 
;

// Rule WallRelation
ruleWallRelation returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='WallRelation' 
    {
